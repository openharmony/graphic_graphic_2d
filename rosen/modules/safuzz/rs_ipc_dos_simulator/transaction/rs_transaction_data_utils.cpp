...
const std::unordered_map<std::string, std::function<bool(std::unique_ptr<RSTransactionData>&)>> \
    ...
    DECLARE_ADD_RANDOM(RSNodeCommand, RSColorPickerDestroyInRender),
    ...
    DECLARE_ADD_RANDOM(RSAnimationCommand, RSAnimationRebuildCurve),
    DECLARE_ADD_RANDOM(RSAnimationCommand, RSAnimationRebuildSpring),
    DECLARE_ADD_RANDOM(RSAnimationCommand, RSAnimationRebuildKeyframe),
    DECLARE_ADD_RANDOM(RSAnimationCommand, RSAnimationRebuildPath),
    DECLARE_ADD_RANDOM(RSAnimationCommand, RSAnimationRebuildInterpolatingSpring),
    DECLARE_ADD_RANDOM(RSAnimationCommand, RSAnimationDestroyInRender),
