...
const std::unordered_map<std::string, RSIRenderServiceConnectionInterfaceCode> INTERFACE_NAME_TO_CODE_MAPPING = {
    ...
    DECLARE_INTERFACE_CODE_NAME(CLEAR_SURFACE_WATERMARK),
    DECLARE_INTERFACE_CODE_NAME(CLEAR_SURFACE_WATERMARK_FOR_NODES),
    DECLARE_INTERFACE_CODE_NAME(SET_SURFACE_WATERMARK),
    ...
    DECLARE_INTERFACE_CODE_NAME(SET_SCREEN_FRAME_GRAVITY),
    ...
    DECLARE_INTERFACE_CODE_NAME(CLEAR_UIFIRST_CACHE),
    ...
    DECLARE_INTERFACE_CODE_NAME(TAKE_UI_CAPTURE_IN_RANGE),
    DECLARE_INTERFACE_CODE_NAME(TAKE_SURFACE_CAPTURE_SOLO),
    DECLARE_INTERFACE_CODE_NAME(TAKE_SELF_SURFACE_CAPTURE),
    DECLARE_INTERFACE_CODE_NAME(TAKE_SURFACE_CAPTURE_WITH_ALL_WINDOWS),
    DECLARE_INTERFACE_CODE_NAME(FREEZE_SCREEN),
    DECLARE_INTERFACE_CODE_NAME(SET_BRIGHTNESS_INFO_CHANGE_CALLBACK),
    DECLARE_INTERFACE_CODE_NAME(GET_BRIGHTNESS_INFO),
    ...
    DECLARE_INTERFACE_CODE_NAME(SET_LAYER_TOP_FOR_HARDWARE_COMPOSER),
#if defined(ROSEN_OHOS) && defined(RS_ENABLE_VK)
    DECLARE_INTERFACE_CODE_NAME(REGISTER_CANVAS_CALLBACK),
    DECLARE_INTERFACE_CODE_NAME(SUBMIT_CANVAS_PRE_ALLOCATED_BUFFER),
#endif
    DECLARE_INTERFACE_CODE_NAME(SET_LOGICAL_CAMERA_ROTATION_CORRECTION),
};
