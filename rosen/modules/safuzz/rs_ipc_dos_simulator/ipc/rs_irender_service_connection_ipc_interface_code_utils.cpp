...
#define DECLARE_RENDER_INTERFACE_CODE_NAME(renderCode) \
    {#renderCode, RSIClientToRenderConnectionInterfaceCode::renderCode}
const std::unordered_map<std::string, RSIClientToServiceConnectionInterfaceCode> INTERFACE_NAME_TO_CODE_MAPPING = {
    ...
    DECLARE_INTERFACE_CODE_NAME(GET_PANEL_POWER_STATUS),
    DECLARE_INTERFACE_CODE_NAME(CREATE_VIRTUAL_SCREEN),
    DECLARE_INTERFACE_CODE_NAME(SET_VIRTUAL_SCREEN_AUTO_ROTATION),
    DECLARE_INTERFACE_CODE_NAME(SET_ROG_SCREEN_RESOLUTION),
    DECLARE_INTERFACE_CODE_NAME(GET_ROG_SCREEN_RESOLUTION),
    ...
    DECLARE_INTERFACE_CODE_NAME(ADD_VIRTUAL_SCREEN_WHITELIST),
    DECLARE_INTERFACE_CODE_NAME(REMOVE_VIRTUAL_SCREEN_WHITELIST),
    ...
    DECLARE_INTERFACE_CODE_NAME(SET_SCREEN_SWITCHING_NOTIFY_CALLBACK),
    DECLARE_INTERFACE_CODE_NAME(SET_ACTIVE_SCREEN_ID_CHANGED_CALLBACK),
    ...
    DECLARE_INTERFACE_CODE_NAME(GET_REFRESH_INFO_BY_PID_AND_UNIQUEID),
    ...
    DECLARE_INTERFACE_CODE_NAME(SET_DUAL_SCREEN_STATE),
    DECLARE_INTERFACE_CODE_NAME(SET_AS_MAIN_SCREEN),
    DECLARE_INTERFACE_CODE_NAME(SET_SCREEN_POWER_STATUS),
    DECLARE_INTERFACE_CODE_NAME(SET_SCREEN_BACK_LIGHT),
    DECLARE_INTERFACE_CODE_NAME(SET_SCREEN_OFFSET),
    DECLARE_INTERFACE_CODE_NAME(SET_ROG_SCREEN_RESOLUTION),
    ...
    DECLARE_INTERFACE_CODE_NAME(ON_FIRST_FRAME_COMMIT),
    ...
    DECLARE_INTERFACE_CODE_NAME(SET_HDR_FORCE_HWC_ENABLED),
    ...
    DECLARE_INTERFACE_CODE_NAME(UNREGISTER_SELF_DRAWING_NODE_RECT_CHANGE_CALLBACK),
    DECLARE_INTERFACE_CODE_NAME(AVCODEC_VIDEO_START),
    DECLARE_INTERFACE_CODE_NAME(AVCODEC_VIDEO_STOP),
    DECLARE_INTERFACE_CODE_NAME(AVCODEC_VIDEO_GET),
    DECLARE_INTERFACE_CODE_NAME(AVCODEC_VIDEO_GET_RECENT),
#ifdef RS_ENABLE_OVERLAY_DISPLAY
    DECLARE_INTERFACE_CODE_NAME(SET_OVERLAY_DISPLAY_MODE),
#endif
    DECLARE_INTERFACE_CODE_NAME(SET_VIDEO_RATE_INFO),
    ...
    DECLARE_INTERFACE_CODE_NAME(NOTIFY_WINDOW_MODE_TYPE_EVENT),
    DECLARE_INTERFACE_CODE_NAME(NOTIFY_WINDOW_EXPECTED_BY_WINDOW_ID),
    DECLARE_INTERFACE_CODE_NAME(NOTIFY_WINDOW_EXPECTED_BY_VSYNC_NAME),
    DECLARE_INTERFACE_CODE_NAME(NOTIFY_APP_STRATEGY_CONFIG_CHANGE_EVENT),
    ...
    DECLARE_INTERFACE_CODE_NAME(NOTIFY_SOFT_VSYNC_RATE_DISCOUNT_EVENT),
    ...
    DECLARE_INTERFACE_CODE_NAME(SET_BRIGHTNESS_INFO_CHANGE_CALLBACK),
    DECLARE_INTERFACE_CODE_NAME(REGISTER_SHARED_TYPEFACE),
    // DECLARE_INTERFACE_CODE_NAME(GET_HIGH_CONTRAST_TEXT_STATE),
    DECLARE_INTERFACE_CODE_NAME(SET_COLOR_FOLLOW),
    DECLARE_INTERFACE_CODE_NAME(SET_GPU_CRC_DIRTY_ENABLED_PIDLIST),
    DECLARE_INTERFACE_CODE_NAME(SET_VIRTUAL_SCREEN_TYPE_BLACKLIST),
    DECLARE_INTERFACE_CODE_NAME(ADD_VIRTUAL_SCREEN_SURFACE),
    DECLARE_INTERFACE_CODE_NAME(REMOVE_VIRTUAL_SCREEN_SURFACE),
    DECLARE_INTERFACE_CODE_NAME(SET_BEHIND_WINDOW_FILTER_ENABLED),
    DECLARE_INTERFACE_CODE_NAME(GET_BEHIND_WINDOW_FILTER_ENABLED),
    DECLARE_INTERFACE_CODE_NAME(GET_PID_GPU_MEMORY_IN_MB),
    DECLARE_INTERFACE_CODE_NAME(SET_OPTIMIZE_CANVAS_DIRTY_ENABLED_PIDLIST),
};

const std::unordered_map<std::string, RSIClientToRenderConnectionInterfaceCode>
    INTERFACE_RENDER_NAME_TO_CODE_MAPPING = {
    DECLARE_RENDER_INTERFACE_CODE_NAME(COMMIT_TRANSACTION),
    DECLARE_RENDER_INTERFACE_CODE_NAME(CREATE_NODE),
    DECLARE_RENDER_INTERFACE_CODE_NAME(CREATE_NODE_AND_SURFACE),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_FOCUS_APP_INFO),
    DECLARE_RENDER_INTERFACE_CODE_NAME(TAKE_SURFACE_CAPTURE),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_WINDOW_FREEZE_IMMEDIATELY),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_POINTER_POSITION),
    DECLARE_RENDER_INTERFACE_CODE_NAME(REGISTER_APPLICATION_AGENT),
    DECLARE_RENDER_INTERFACE_CODE_NAME(UNREGISTER_APPLICATION_AGENT),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_BUFFER_AVAILABLE_LISTENER),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_BUFFER_CLEAR_LISTENER),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_SYSTEM_ANIMATED_SCENES),
    DECLARE_RENDER_INTERFACE_CODE_NAME(DROP_FRAME_BY_PID),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_ANCO_FORCE_DO_DIRECT),
    DECLARE_RENDER_INTERFACE_CODE_NAME(CREATE_DISPLAY_NODE),
    DECLARE_RENDER_INTERFACE_CODE_NAME(REGISTER_SURFACE_BUFFER_CALLBACK),
    DECLARE_RENDER_INTERFACE_CODE_NAME(UNREGISTER_SURFACE_BUFFER_CALLBACK),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_HIDE_PRIVACY_CONTENT),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_WINDOW_CONTAINER),
    DECLARE_RENDER_INTERFACE_CODE_NAME(TAKE_SELF_SURFACE_CAPTURE),
    DECLARE_RENDER_INTERFACE_CODE_NAME(TAKE_SURFACE_CAPTURE_SOLO),
    DECLARE_RENDER_INTERFACE_CODE_NAME(TAKE_UI_CAPTURE_IN_RANGE),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_LAYER_TOP_FOR_HARDWARE_COMPOSER),
    DECLARE_RENDER_INTERFACE_CODE_NAME(TAKE_SURFACE_CAPTURE_WITH_ALL_WINDOWS),
    DECLARE_RENDER_INTERFACE_CODE_NAME(FREEZE_SCREEN),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_GLOBAL_DARK_COLOR_MODE),
    DECLARE_RENDER_INTERFACE_CODE_NAME(GET_BITMAP),
    DECLARE_RENDER_INTERFACE_CODE_NAME(GET_PIXELMAP),
    DECLARE_RENDER_INTERFACE_CODE_NAME(GET_SCREEN_HDR_STATUS),
    DECLARE_RENDER_INTERFACE_CODE_NAME(GET_BRIGHTNESS_INFO),
#if defined(ROSEN_OHOS) && defined(RS_ENABLE_VK)
    DECLARE_RENDER_INTERFACE_CODE_NAME(REGISTER_CANVAS_CALLBACK),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SUBMIT_CANVAS_PRE_ALLOCATED_BUFFER),
#endif
    DECLARE_RENDER_INTERFACE_CODE_NAME(REGISTER_TRANSACTION_DATA_CALLBACK),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_SURFACE_WATERMARK),
    DECLARE_RENDER_INTERFACE_CODE_NAME(CLEAR_SURFACE_WATERMARK_FOR_NODES),
    DECLARE_RENDER_INTERFACE_CODE_NAME(CLEAR_SURFACE_WATERMARK),
    DECLARE_RENDER_INTERFACE_CODE_NAME(EXECUTE_SYNCHRONOUS_TASK),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_HARDWARE_ENABLED),
    DECLARE_RENDER_INTERFACE_CODE_NAME(GET_HIGH_CONTRAST_TEXT_STATE),
    DECLARE_RENDER_INTERFACE_CODE_NAME(CLEAR_UIFIRST_CACHE),
    DECLARE_RENDER_INTERFACE_CODE_NAME(REGISTER_OCCLUSION_CHANGE_CALLBACK),
    DECLARE_RENDER_INTERFACE_CODE_NAME(REGISTER_SURFACE_OCCLUSION_CHANGE_CALLBACK),
    DECLARE_RENDER_INTERFACE_CODE_NAME(UNREGISTER_SURFACE_OCCLUSION_CHANGE_CALLBACK),
    DECLARE_RENDER_INTERFACE_CODE_NAME(REGISTER_FRAME_STABILITY_DETECTION),
    DECLARE_RENDER_INTERFACE_CODE_NAME(UNREGISTER_FRAME_STABILITY_DETECTION),
    DECLARE_RENDER_INTERFACE_CODE_NAME(START_FRAME_STABILITY_COLLECTION),
    DECLARE_RENDER_INTERFACE_CODE_NAME(GET_FRAME_STABILITY_RESULT),
    DECLARE_RENDER_INTERFACE_CODE_NAME(SET_LOGICAL_CAMERA_ROTATION_CORRECTION),
#ifdef RS_MODIFIERS_DRAW_ENABLE
    DECLARE_RENDER_INTERFACE_CODE_NAME(CREATE_CANVAS_DRAWING_NODE_SURFACE),
    DECLARE_RENDER_INTERFACE_CODE_NAME(RELEASE_CANVAS_DRAWING_NODE_SURFACE),
#endif
}
...
int RSIRenderServiceConnectionInterfaceCodeUtils::GetCodeFromName(const std::string& interfaceName)
{
    ...
    auto itRender = INTERFACE_RENDER_NAME_TO_CODE_MAPPING.find(interfaceName);
    if (it == INTERFACE_NAME_TO_CODE_MAPPING.end() && itRender == INTERFACE_RENDER_NAME_TO_CODE_MAPPING.end()) {
        SAFUZZ_LOGE("RSIRenderServiceConnectionInterfaceCodeUtils::GetCodeFromName interfaceName %s not found",
            interfaceName.c_str());
        return -1;
    }
    return it == INTERFACE_NAME_TO_CODE_MAPPING.end() ? static_cast<int>(it->second):
        static_cast<int>(itRender->second);
}
