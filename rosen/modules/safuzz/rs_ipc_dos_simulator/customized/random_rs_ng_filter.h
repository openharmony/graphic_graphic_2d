...
#ifndef SAFUZZ_RANDOM_RS_NG_FILTER_H
#define SAFUZZ_RANDOM_RS_NG_FILTER_H

#include "effect/rs_render_filter_base.h"

namespace OHOS {
namespace Rosen {
class RandomRSNGFilterPtr {
public:
    static std::shared_ptr<RSNGRenderFilterBase> GetRandomValue();
...
#endif // SAFUZZ_RANDOM_RS_NG_FILTER_H
