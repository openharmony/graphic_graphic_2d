...
public:
    ...
    ADD_RANDOM_COMMAND_WITH_PARAM_2(RSMarkNodeSingleFrameComposer, Uint64, Bool);
    ...
    ADD_RANDOM_COMMAND_WITH_PARAM_4(RSColorPickerDestroyInRender, Uint64, Pid, Uint64, Uint8);
};
} // namespace Rosen
} // namespace OHOS
