...
void RSOverlayNGShaderDrawable::OnDraw(Drawing::Canvas* canvas, const Drawing::Rect* rect) const
{
    ...
    if (effectData != nullptr) {
        ...
        if (paintFilterCanvas->GetEffectIntersectWithDRM()) {
            RS_TRACE_NAME("RSOverlayNGShaderDrawable::OnDraw DrawColorUsingSDFWithDRM");
        ...
        RS_TRACE_NAME_FMT("RSOverlayNGShaderDrawable::OnDraw image[%d], fractOut[%f], cacheRectF[%s]",
