...
bool RSBufferReclaim::DoBufferReclaim(sptr<SurfaceBuffer> buffer)
{
    ...
    RS_LOGI("DoBufferReclaim: bufferReclaimNumsSet_=%{public}lu", bufferReclaimNumsSet_.size());
...
bool RSBufferReclaim::DoBufferResume(sptr<SurfaceBuffer> buffer)
{
    ...
    RS_LOGI("DoBufferResume: bufferReclaimNumsSet_=%{public}lu", bufferReclaimNumsSet_.size());
    bool ret = false;
...
bool RSBufferReclaim::CheckBufferReclaim()
{
    ...
    RS_LOGI("CheckBufferReclaim: bufferReclaimNumsSet_=%{public}lu", bufferReclaimNumsSet_.size());
...
void RSBufferReclaim::RemoveBufferReclaim(uint64_t bufferId)
{
    ...
    RS_LOGI("RemoveBufferReclaim: bufferReclaimNumsSet_=%{public}lu", bufferReclaimNumsSet_.size());
}
