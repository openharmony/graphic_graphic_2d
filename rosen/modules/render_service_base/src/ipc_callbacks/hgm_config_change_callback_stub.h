...
#ifndef ROSEN_RENDER_SERVICE_BASE_HGM_CONFIG_CHANGE_CALLBACK_STUB_H
#define ROSEN_RENDER_SERVICE_BASE_HGM_CONFIG_CHANGE_CALLBACK_STUB_H
...
namespace OHOS {
namespace Rosen {
class RSB_EXPORT RSHgmConfigChangeCallbackStub : public IRemoteStub<RSIHgmConfigChangeCallback> {
public:
