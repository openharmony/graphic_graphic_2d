...
void RSRenderPipelineClient::CommitTransaction(std::unique_ptr<RSTransactionData>& transactionData)
{
    ...
    if (clientToRenderConnection != nullptr) {
        ...
        RS_LOGE_LIMIT(__func__, __line__,
            "RSRenderPipelineClient::CommitTransaction failed, clientToRenderConnection is nullptr");
    }
}
...
void RSRenderPipelineClient::ExecuteSynchronousTask(const std::shared_ptr<RSSyncTask>& task)
{
    ...
    if (clientToRenderConnection != nullptr) {
        ...
        RS_LOGE_LIMIT(__func__, __line__,
            "RSRenderPipelineClient::ExecuteSynchronousTask failed, clientToRenderConnection is nullptr");
    }
}
...
void RSRenderPipelineClient::RegisterApplicationAgent(uint32_t pid, sptr<IApplicationAgent> app)
{
    ...
    if (clientToRenderConnection != nullptr) {
        ...
        RS_LOGE_LIMIT(__func__, __line__,
            "RSRenderPipelineClient::RegisterApplicationAgent failed, clientToRenderConnection is nullptr");
    }
}
...
bool RSRenderPipelineClient::CreateDisplayNode(const RSDisplayNodeConfig& displayNodeConfig, NodeId nodeId)
{
    auto clientToRenderConnection = RSRenderServiceConnectHub::GetClientToRenderConnection(tokenMaskId_);
    if (clientToRenderConnection == nullptr) {
        ROSEN_LOGE("RSRenderPipelineClient::CreateNode clientToRenderConnection nullptr");
        return false;
    }
    bool success;
    ...
    bool unobscured)
{
    auto clientToRenderConnection = RSRenderServiceConnectHub::GetClientToRenderConnection(tokenMaskId_);
    if (clientToRenderConnection == nullptr) {
        ROSEN_LOGE("RSRenderPipelineClient::CreateNodeAndSurface clientToRenderConnection nullptr");
        return nullptr;
    }
...
bool RSRenderPipelineClient::RegisterBufferClearListener(NodeId id, const BufferClearCallback& callback)
{
    auto clientToRenderConnection = RSRenderServiceConnectHub::GetClientToRenderConnection(tokenMaskId_);
    if (clientToRenderConnection == nullptr) {
        ROSEN_LOGE("RSRenderPipelineClient::RegisterBufferClearListener clientToRenderConnection is nullptr!");
        return false;
    }
...
uint32_t RSRenderPipelineClient::SetHidePrivacyContent(NodeId id, bool needHidePrivacyContent)
{
    ...
    ROSEN_LOGE("RSRenderPipelineClient::SetHidePrivacyContent clientToRenderConnection is nullptr!");
    ...
    const Drawing::Rect* rect, std::shared_ptr<Drawing::DrawCmdList> drawCmdList)
{
    auto clientToRenderConnection = RSRenderServiceConnectHub::GetClientToRenderConnection(tokenMaskId_);
    if (clientToRenderConnection == nullptr) {
        ROSEN_LOGE("RSRenderPipelineClient::GetPixelmap: clientToRenderConnection is nullptr");
        return false;
    }
    bool success;
...
bool RSRenderPipelineClient::SetGlobalDarkColorMode(bool isDark)
{
    auto clientToRenderConnection = RSRenderServiceConnectHub::GetClientToRenderConnection(tokenMaskId_);
    if (clientToRenderConnection == nullptr) {
        ROSEN_LOGE("RSRenderPipelineClient::SetGlobalDarkColorMode: clientToRenderConnection is nullptr");
        return false;
    }
    ...
    float positionZ, float positionW)
{
    auto clientToRenderConnection = RSRenderServiceConnectHub::GetClientToRenderConnection(tokenMaskId_);
    if (clientToRenderConnection == nullptr) {
        RS_LOGE("RSRenderPipelineClient::SetHwcNodeBounds clientToRenderConnection is null!");
        return false;
    }
...
bool RSRenderPipelineClient::SetAncoForceDoDirect(bool direct)
{
    ...
    ROSEN_LOGE("RSRenderPipelineClient::SetAncoForceDoDirect clientToRenderConnection is null");
    return false;
}
...
void RSRenderPipelineClient::RegisterCanvasCallback(sptr<RSICanvasSurfaceBufferCallback> callback)
{
    auto clientToRenderConnection = RSRenderServiceConnectHub::GetClientToRenderConnection(tokenMaskId_);
    if (clientToRenderConnection == nullptr) {
        ROSEN_LOGE("RSRenderPipelineClient::RegisterCanvasCallback clientToRenderConnection is nullptr!");
        return;
    }
    ...
    NodeId nodeId, sptr<SurfaceBuffer> buffer, uint32_t resetSurfaceIndex)
{
    auto clientToRenderConnection = RSRenderServiceConnectHub::GetClientToRenderConnection(tokenMaskId_);
    if (clientToRenderConnection == nullptr) {
        ROSEN_LOGE("RSRenderPipelineClient::SubmitCanvasPreAllocatedBuffer clientToRenderConnection is nullptr!");
        return RENDER_SERVICE_NULL;
    }
...
int32_t RSRenderPipelineClient::SetLogicalCameraRotationCorrection(ScreenId id, ScreenRotation logicalCorrection)
{
    auto clientToRenderConnection = RSRenderServiceConnectHub::GetClientToRenderConnection(tokenMaskId_);
    if (clientToRenderConnection == nullptr) {
        ROSEN_LOGE("RSRenderPipelineClient::SetLogicalCameraRotationCorrection clientToRenderConnection is nullptr!");
        return RENDER_SERVICE_NULL;
    }
...
int32_t RSRenderPipelineClient::GetMaxGpuBufferSize(uint32_t& maxWidth, uint32_t& maxHeight)
{
    auto clientToRenderConnection = RSRenderServiceConnectHub::GetClientToRenderConnection(tokenMaskId_);
    if (clientToRenderConnection == nullptr) {
        ROSEN_LOGE("RSRenderPipelineClient::GetMaxGpuBufferSize clientToRenderConnection is nullptr!");
        return RENDER_SERVICE_NULL;
    }
