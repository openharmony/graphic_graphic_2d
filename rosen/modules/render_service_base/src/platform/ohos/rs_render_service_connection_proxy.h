...
public:
    ...
    void SetWindowExpectedRefreshRate(std::unordered_map<uint64_t, EventInfo>& eventInfos) override;

    void SetWindowExpectedRefreshRate(std::unordered_map<std::string, EventInfo>& eventInfos) override;
