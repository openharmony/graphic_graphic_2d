...
static const std::unordered_map<RSModifierType, RSPropertyDrawableSlot> g_propertyToDrawableLut = {
    ...
    { RSModifierType::SCALE_Z, RSPropertyDrawableSlot::BOUNDS_MATRIX },
    ...
    { RSModifierType::BG_BRIGHTNESS_RATES, RSPropertyDrawableSlot::BACKGROUND_COLOR },
    { RSModifierType::BG_BRIGHTNESS_SATURATION, RSPropertyDrawableSlot::BACKGROUND_COLOR },
    { RSModifierType::BG_BRIGHTNESS_POSCOEFF, RSPropertyDrawableSlot::BACKGROUND_COLOR },
    { RSModifierType::BG_BRIGHTNESS_NEGCOEFF, RSPropertyDrawableSlot::BACKGROUND_COLOR },
    { RSModifierType::BG_BRIGHTNESS_FRACTION, RSPropertyDrawableSlot::BACKGROUND_COLOR },
    ...
    { RSModifierType::DISTORTION_K, RSPropertyDrawableSlot::FOREGROUND_FILTER },
    ...
    { RSModifierType::FG_BRIGHTNESS_RATES, RSPropertyDrawableSlot::BLEND_MODE },
    { RSModifierType::FG_BRIGHTNESS_SATURATION, RSPropertyDrawableSlot::BLEND_MODE },
    { RSModifierType::FG_BRIGHTNESS_POSCOEFF, RSPropertyDrawableSlot::BLEND_MODE },
    { RSModifierType::FG_BRIGHTNESS_NEGCOEFF, RSPropertyDrawableSlot::BLEND_MODE },
    { RSModifierType::FG_BRIGHTNESS_FRACTION, RSPropertyDrawableSlot::BLEND_MODE },
    ...
    { RSModifierType::BG_BLUR_DISABLE_SYSTEM_ADAPTATION, RSPropertyDrawableSlot::BACKGROUND_FILTER },
    ...
    { RSModifierType::HDR_BRIGHTNESS_FACTOR, RSPropertyDrawableSlot::INVALID },
    ...
    { RSModifierType::HDR_BRIGHTNESS, RSPropertyDrawableSlot::INVALID },
