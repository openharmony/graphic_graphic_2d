...
const RSCoverageNGShaderRenderModifier::LegacyPropertyApplierMap
    RSCoverageNGShaderRenderModifier::LegacyPropertyApplierMap_ = {
        ...
        { RSPropertyType::COVERAGE_NG_SHADER,
            RSRenderModifier::PropertyApplyHelper<std::shared_ptr<RSNGRenderShaderBase>,
                &RSProperties::SetCoverageNGShader> },
};

void RSCoverageNGShaderRenderModifier::ResetProperties(RSProperties& properties)
{
