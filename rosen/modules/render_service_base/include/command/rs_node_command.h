...
enum RSNodeCommandType : uint16_t {
    ...
    UPDATE_MODIFIER_PATH_PTR = 0x0110,
    UPDATE_MODIFIER_DYNAMIC_BRIGHTNESS = 0x0111,
    UPDATE_MODIFIER_GRADIENT_BLUR_PTR = 0x0112,
    UPDATE_MODIFIER_EMITTER_UPDATER_PTR = 0x0113,
    UPDATE_MODIFIER_NOISE_FIELD_PTR = 0x0114,
    UPDATE_MODIFIER_SHADER_PTR = 0x0115,
    UPDATE_MODIFIER_VECTOR2F = 0x0116,
    UPDATE_MODIFIER_VECTOR4_BORDER_STYLE = 0x0117,
    UPDATE_MODIFIER_VECTOR4_COLOR = 0x0118,
    UPDATE_MODIFIER_VECTOR4F = 0x0119,
    UPDATE_MODIFIER_RRECT = 0x0120,
    UPDATE_MODIFIER_DRAW_CMD_LIST = 0x0121,
    UPDATE_MODIFIER_DRAWING_MATRIX = 0x0122,
