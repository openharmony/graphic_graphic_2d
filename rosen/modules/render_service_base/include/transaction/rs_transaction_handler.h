...
public:
    ...
    void MoveCommandByNodeIdExcludeTreeCommands(std::shared_ptr<RSTransactionHandler> transactionHandler, NodeId nodeId);
...
private:
    ...
    void MoveCommonCommandByNodeIdExcludeTreeCommands(std::shared_ptr<RSTransactionHandler> transactionHandler, NodeId nodeId);
    ...
    void MoveRemoteCommandByNodeIdExcludeTreeCommands(std::shared_ptr<RSTransactionHandler> transactionHandler, NodeId nodeId);
