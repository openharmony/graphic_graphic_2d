...
#ifndef RENDER_SERVICE_CLIENT_CORE_RENDER_RS_HIGH_PERFORMANCE_VISUAL_ENGINE_H
#define RENDER_SERVICE_CLIENT_CORE_RENDER_RS_HIGH_PERFORMANCE_VISUAL_ENGINE_H
...
#endif // RENDER_SERVICE_CLIENT_CORE_RENDER_RS_HIGH_PERFORMANCE_VISUAL_ENGINE_H