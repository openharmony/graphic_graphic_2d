...
public:
    ...
    RSAlwaysSnapshotShaderFilter operator=(const RSAlwaysSnapshotShaderFilter&) = delete;
    ~RSAlwaysSnapshotShaderFilter() override;
...
#endif // RENDER_SERVICE_BASE_CORE_RENDER_RS_ALWAYS_SNAPSHOT_SHADER_FILTER_H