...
struct EdgeLightShaderFilterParams {
    ...
    float edgeSoftThreshold{ 0.0f };
    uint32_t bloomLevel{ 0 };
...
private:
    RSColor detectColor_;
    RSColor color_;
    float edgeThreshold_{ 0.0f };
    float edgeIntensity_{ 0.0f };
    float edgeSoftThreshold_{ 0.0f };
    uint32_t bloomLevel_{ 0 };
    bool useRawColor_{ false };
    bool gradient_{ false };
    float alphaProgress_{ 0.0f };
