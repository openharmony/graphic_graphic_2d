...
#ifndef RENDER_SERVICE_BASE_MODIFIER_NG_RS_FOREGROUND_RENDER_MODIFIER_H
#define RENDER_SERVICE_BASE_MODIFIER_NG_RS_FOREGROUND_RENDER_MODIFIER_H

#include "modifier_ng/rs_render_modifier_ng.h"

namespace OHOS::Rosen::ModifierNG {
class RSB_EXPORT RSCompositingFilterRenderModifier : public RSFilterRenderModifier {
public:
    RSCompositingFilterRenderModifier() = default;
    ~RSCompositingFilterRenderModifier() override = default;
...
private:
    ...
    bool IsLinearGradientBlurValid();
    ...
    void GenerateLinearGradientBlurFilter(const RSModifierContext& context);
...
#endif // RENDER_SERVICE_BASE_MODIFIER_NG_RS_FOREGROUND_RENDER_MODIFIER_H
