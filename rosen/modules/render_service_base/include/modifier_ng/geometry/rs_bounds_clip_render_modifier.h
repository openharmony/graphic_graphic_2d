...
#ifndef RENDER_SERVICE_BASE_MODIFIER_NG_GEOMETRY_RS_BOUNDS_CLIP_RENDER_MODIFIER_H
#define RENDER_SERVICE_BASE_MODIFIER_NG_GEOMETRY_RS_BOUNDS_CLIP_RENDER_MODIFIER_H

#include "modifier_ng/rs_render_modifier_ng.h"

namespace OHOS::Rosen::ModifierNG {
class RSB_EXPORT RSBoundsClipRenderModifier : public RSDisplayListRenderModifier {
public:
