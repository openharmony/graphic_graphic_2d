...
#ifndef RENDER_SERVICE_BASE_MODIFIER_NG_FOREGROUND_RS_FOREGROUND_COLOR_RENDER_MODIFIER_H
#define RENDER_SERVICE_BASE_MODIFIER_NG_FOREGROUND_RS_FOREGROUND_COLOR_RENDER_MODIFIER_H

#include "modifier_ng/rs_render_modifier_ng.h"

namespace OHOS::Rosen::ModifierNG {
class RSB_EXPORT RSForegroundColorRenderModifier : public RSDisplayListRenderModifier {
public:
