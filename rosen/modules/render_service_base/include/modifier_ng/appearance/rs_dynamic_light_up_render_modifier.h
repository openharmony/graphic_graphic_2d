...
#ifndef RENDER_SERVICE_BASE_MODIFIER_NG_APPEARANCE_RS_DYNAMIC_LIGHT_UP_RENDER_MODIFIER_H
#define RENDER_SERVICE_BASE_MODIFIER_NG_APPEARANCE_RS_DYNAMIC_LIGHT_UP_RENDER_MODIFIER_H
...
public:
    ...
    static inline constexpr auto Type = RSModifierType::DYNAMIC_LIGHT_UP;
...
#endif // RENDER_SERVICE_BASE_MODIFIER_NG_APPEARANCE_RS_DYNAMIC_LIGHT_UP_RENDER_MODIFIER_H
