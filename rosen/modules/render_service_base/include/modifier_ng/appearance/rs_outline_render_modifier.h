...
#ifndef RENDER_SERVICE_BASE_MODIFIER_NG_APPEARANCE_RS_OUTLINE_RENDER_MODIFIER_H
#define RENDER_SERVICE_BASE_MODIFIER_NG_APPEARANCE_RS_OUTLINE_RENDER_MODIFIER_H

#include "modifier_ng/rs_render_modifier_ng.h"

namespace OHOS::Rosen::ModifierNG {
class RSB_EXPORT RSOutlineRenderModifier : public RSDisplayListRenderModifier {
public:
    RSOutlineRenderModifier() = default;
