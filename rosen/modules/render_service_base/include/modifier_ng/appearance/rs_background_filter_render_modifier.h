...
#ifndef RENDER_SERVICE_BASE_MODIFIER_NG_APPEARANCE_RS_BACKGROUND_FILTER_RENDER_MODIFIER_H
#define RENDER_SERVICE_BASE_MODIFIER_NG_APPEARANCE_RS_BACKGROUND_FILTER_RENDER_MODIFIER_H
