...
#ifndef RENDER_SERVICE_BASE_MODIFIER_NG_APPEARANCE_RS_USE_EFFECT_RENDER_MODIFIER_H
#define RENDER_SERVICE_BASE_MODIFIER_NG_APPEARANCE_RS_USE_EFFECT_RENDER_MODIFIER_H
