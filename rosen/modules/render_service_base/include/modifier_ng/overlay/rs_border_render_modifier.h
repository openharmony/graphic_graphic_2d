...
#ifndef RENDER_SERVICE_BASE_MODIFIER_NG_OVERLAY_RS_BORDER_RENDER_MODIFIER_H
#define RENDER_SERVICE_BASE_MODIFIER_NG_OVERLAY_RS_BORDER_RENDER_MODIFIER_H
...
private:
    ...
    // Utilities
    static RRect GetRRectForDrawingBorder(RSModifierContext& context, const RSBorder& border, const bool& isOutline);

    static RRect GetInnerRRectForDrawingBorder(
        RSModifierContext& context, const RSBorder& border, const bool& isOutline);

    static RRect GetInnerRRect(RSModifierContext& context, const RSBorder& border);
};
} // namespace OHOS::Rosen::ModifierNG
#endif // RENDER_SERVICE_BASE_MODIFIER_NG_OVERLAY_RS_BORDER_RENDER_MODIFIER_H
