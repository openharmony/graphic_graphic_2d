...
#ifndef RENDER_SERVICE_BASE_PLATFORM_OHOS_TRANSACTION_RS_IRENDER_SERVICE_CONNECTION_IPC_INTERFACE_CODE_H
#define RENDER_SERVICE_BASE_PLATFORM_OHOS_TRANSACTION_RS_IRENDER_SERVICE_CONNECTION_IPC_INTERFACE_CODE_H
