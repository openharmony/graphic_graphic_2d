...
#ifndef RENDER_SERVICE_BASE_PLATFORM_OHOS_TRANSACTION_RS_ICLIENT_TO_SERVICE_CONNECTION_IPC_INTERFACE_CODE_H
#define RENDER_SERVICE_BASE_PLATFORM_OHOS_TRANSACTION_RS_ICLIENT_TO_SERVICE_CONNECTION_IPC_INTERFACE_CODE_H
...
//its code to IsReplyNotClonable() in rs_client_to_service_connection_proxy.cpp; otherwise
...
enum class RSIClientToServiceConnectionInterfaceCode : CodeUnderlyingType {
    ...
    CREATE_CONNECTION = 0x000043,
    SET_DUAL_SCREEN_STATE = 0x000043,
    AVCODEC_VIDEO_GET = 0x000044,
    AVCODEC_VIDEO_GET_RECENT = 0x000045,
    SET_AS_MAIN_SCREEN = 0x000046,
    GET_MAIN_SCREEN = 0x000047,
    SET_HDR_FORCE_HWC_ENABLED = 0x000048,
    GET_BACKGROUND_REBUILD_ENABLED = 0x000050,
    ...
    ADD_VIRTUAL_SCREEN_WHITELIST = 0x00200E,
    REMOVE_VIRTUAL_SCREEN_WHITELIST = 0x00200F,
    ADD_VIRTUAL_SCREEN_SURFACE = 0x002010,
    REMOVE_VIRTUAL_SCREEN_SURFACE = 0x002011,
    ...
    SET_ACTIVE_SCREEN_ID_CHANGED_CALLBACK = 0x005012,
    GET_REFRESH_INFO_BY_PID_AND_UNIQUEID = 0x005013,
    SET_THERMAL_FRAME_RATE_LIMIT = 0x005014,
    ...
    GET_PANEL_POWER_STATUS = 0x00600A,
    ...
    SET_SCREEN_OFFSET = 0x007007,
    SET_SCREEN_FRAME_GRAVITY = 0x007008,
    ...
    SET_BRIGHTNESS_INFO_CHANGE_CALLBACK = 0x00800F,
