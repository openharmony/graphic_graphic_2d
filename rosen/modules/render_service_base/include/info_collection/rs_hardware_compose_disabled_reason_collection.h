...
enum HwcDisabledReasons {
    ...
    DISABLED_BY_HWC_NODE_BELOW_SELF_IN_APP = 13,
    DISABLED_BY_UIFIRST = 14,
    DISABLED_BY_DRAWING_CACHE = 15,
    DISABLED_BY_ABOVED_BOUND_NE_DST_RECT = 16,
    DISABLED_BY_TRANSPARENT_NODE = 17,
    DISABLED_BY_CROSS_NODE = 18,
    DISABLED_BY_SCREEN_NODE_ROTATION = 19,
    DISABLED_BY_ANCO_HAS_GPU = 20,
    DISABLED_BY_TOP_LAYERS = 21,
    DISABLED_BY_IS_CLONE_NODE = 22,
    DISABLED_BY_POINT_WINDOW = 23,
