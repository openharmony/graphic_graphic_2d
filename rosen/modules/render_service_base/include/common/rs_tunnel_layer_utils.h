...
// Threshold set to 5 as a balanced approach: ensures sufficient stability
// before activation while avoiding excessive delay in tunnel startup.
inline constexpr uint32_t TUNNEL_STABLE_THRESHOLD = 5;
