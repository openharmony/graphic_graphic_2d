...
#ifndef RS_OPINC_ROOT_CACHE_H
#define RS_OPINC_ROOT_CACHE_H
...
namespace OHOS {
namespace Rosen {
class RSB_EXPORT RSOpincRootCache {
public:
    RSOpincRootCache() = default;
    RSOpincRootCache(const RSOpincRootCache&) = delete;
    RSOpincRootCache(RSOpincRootCache&&) = delete;
    RSOpincRootCache& operator=(const RSOpincRootCache&) = delete;
    RSOpincRootCache& operator=(RSOpincRootCache&&) = delete;

    ~RSOpincRootCache() = default;

    // mark stable node
    void OpincQuickMarkStableNode(bool& unchangeMarkInApp, bool& unchangeMarkEnable, bool isSelfDirty);
    bool IsOpincUnchangeState() const;
