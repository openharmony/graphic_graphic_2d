...
enum class RSModifierType : int16_t {
    ...
    TRANSLATE = 15,
    TRANSLATE_Z = 16,
    SUBLAYER_TRANSFORM = 17,
    CORNER_RADIUS = 18,
    ALPHA = 19,
    ALPHA_OFFSCREEN = 20,
    FOREGROUND_COLOR = 21,
    BACKGROUND_COLOR = 22,
    BACKGROUND_SHADER = 23,
    BACKGROUND_SHADER_PROGRESS = 24,
    BG_IMAGE = 25,
    BG_IMAGE_INNER_RECT = 26,
    BG_IMAGE_WIDTH = 27,
    BG_IMAGE_HEIGHT = 28,
    BG_IMAGE_POSITION_X = 29,
    BG_IMAGE_POSITION_Y = 30,
    SURFACE_BG_COLOR = 31,
    BORDER_COLOR = 32,
    BORDER_WIDTH = 33,
    BORDER_STYLE = 34,
    BORDER_DASH_WIDTH = 35,
    BORDER_DASH_GAP = 36,
    FILTER = 37,
    BACKGROUND_FILTER = 38,
    LINEAR_GRADIENT_BLUR_PARA = 39,
    DYNAMIC_LIGHT_UP_RATE = 40,
    DYNAMIC_LIGHT_UP_DEGREE = 41,
    FG_BRIGHTNESS_RATES = 42,
    FG_BRIGHTNESS_SATURATION = 43,
    FG_BRIGHTNESS_POSCOEFF = 44,
    FG_BRIGHTNESS_NEGCOEFF = 45,
    FG_BRIGHTNESS_FRACTION = 46,
    BG_BRIGHTNESS_RATES = 47,
    BG_BRIGHTNESS_SATURATION = 48,
    BG_BRIGHTNESS_POSCOEFF = 49,
    BG_BRIGHTNESS_NEGCOEFF = 50,
    BG_BRIGHTNESS_FRACTION = 51,
    FRAME_GRAVITY = 52,
    CLIP_RRECT = 53,
    CLIP_BOUNDS = 54,
    CLIP_TO_BOUNDS = 55,
    ...
    SHADOW_PATH = 64,
    SHADOW_MASK = 65,
    SHADOW_COLOR_STRATEGY = 66,
    MASK = 67,
    SPHERIZE = 68,
    LIGHT_UP_EFFECT = 69,
    PIXEL_STRETCH = 70,
    PIXEL_STRETCH_PERCENT = 71,
    PIXEL_STRETCH_TILE_MODE = 72,
    USE_EFFECT = 73,
    USE_EFFECT_TYPE = 74,
    COLOR_BLEND_MODE = 75,
    COLOR_BLEND_APPLY_TYPE = 76,
    SANDBOX = 77,
    GRAY_SCALE = 78,
    BRIGHTNESS = 79,
    CONTRAST = 80,
    ...
    AIINVERT = 84,
    SYSTEMBAREFFECT = 85,
    WATER_RIPPLE_PROGRESS = 86,
    WATER_RIPPLE_PARAMS = 87,
    HUE_ROTATE = 88,
    COLOR_BLEND = 89,
    PARTICLE = 90,
    SHADOW_IS_FILLED = 91,
    ...
    LIGHT_COLOR = 100,
    LIGHT_POSITION = 101,
    ILLUMINATED_BORDER_WIDTH = 102,
    ILLUMINATED_TYPE = 103,
    BLOOM = 104,
    FOREGROUND_EFFECT_RADIUS = 105,
    USE_SHADOW_BATCHING = 106,
    MOTION_BLUR_PARA = 107,
    PARTICLE_EMITTER_UPDATER = 108,
    PARTICLE_NOISE_FIELD = 109,
    FLY_OUT_DEGREE = 110,
    FLY_OUT_PARAMS = 111,
    DISTORTION_K = 112,
    DYNAMIC_DIM_DEGREE = 113,
    MAGNIFIER_PARA = 114,
    BACKGROUND_BLUR_RADIUS = 115,
    BACKGROUND_BLUR_SATURATION = 116,
    BACKGROUND_BLUR_BRIGHTNESS = 117,
    BACKGROUND_BLUR_MASK_COLOR = 118,
    BACKGROUND_BLUR_COLOR_MODE = 119,
    BACKGROUND_BLUR_RADIUS_X = 120,
    BACKGROUND_BLUR_RADIUS_Y = 121,
    FOREGROUND_BLUR_RADIUS = 122,
    FOREGROUND_BLUR_SATURATION = 123,
    FOREGROUND_BLUR_BRIGHTNESS = 124,
    FOREGROUND_BLUR_MASK_COLOR = 125,
    FOREGROUND_BLUR_COLOR_MODE = 126,
    FOREGROUND_BLUR_RADIUS_X = 127,
    FOREGROUND_BLUR_RADIUS_Y = 128,
    ATTRACTION_FRACTION = 129,
    ATTRACTION_DSTPOINT = 130,
    CUSTOM = 131,
    EXTENDED = 132,
    TRANSITION = 133,
    BACKGROUND_STYLE = 134,
    CONTENT_STYLE = 135,
    FOREGROUND_STYLE = 136,
    OVERLAY_STYLE = 137,
    NODE_MODIFIER = 138,
    ENV_FOREGROUND_COLOR = 139,
    ENV_FOREGROUND_COLOR_STRATEGY = 140,
    GEOMETRYTRANS = 141,
    CUSTOM_CLIP_TO_FRAME = 142,
    HDR_BRIGHTNESS = 143,
    BEHIND_WINDOW_FILTER_ENABLED = 144,
    BEHIND_WINDOW_FILTER_RADIUS = 145,
    BEHIND_WINDOW_FILTER_SATURATION = 146,
    BEHIND_WINDOW_FILTER_BRIGHTNESS = 147,
    BEHIND_WINDOW_FILTER_MASK_COLOR = 148,
    CHILDREN = 149, // PLACEHOLDER, no such modifier, but we need a dirty flag
    MAX_RS_MODIFIER_TYPE = 150,
};
