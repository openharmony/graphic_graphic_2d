...
/**
 * @tc.name: GetMemoryGraphicsTest
 * @tc.desc: GetMemoryGraphicsTest
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderServiceClientProxyTest, GetMemoryGraphicsTest, TestSize.Level1)
{
    auto rsClient = RSRenderServiceClient::CreateRenderServiceClient();
    rsClient->GetMemoryGraphics();
