 ...
 * @tc.desc: Verify RebuildPropertyValue with null originValue
 * @tc.type:FUNC
 */
HWTEST_F(RSRenderPathAnimationTest, RebuildPropertyValue001, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RSRenderPathAnimationTest RebuildPropertyValue001 start";
...
HWTEST_F(RSRenderPathAnimationTest, RebuildPropertyValue003, TestSize.Level1)
{
    ...
    renderPathAnimation->valueEstimator_ = nullptr;
    renderPathAnimation->RebuildPropertyValue(0.5f);
    GTEST_LOG_(INFO) << "RSRenderPathAnimationTest RebuildPropertyValue003 end";
}

/**
 * @tc.name: RebuildPropertyValue004
 * @tc.desc: Verify RebuildPropertyValue with non-VECTOR4F property type
 * @tc.type:FUNC
 */
HWTEST_F(RSRenderPathAnimationTest, RebuildPropertyValue004, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RSRenderPathAnimationTest RebuildPropertyValue004 start";
    auto property = std::make_shared<RSRenderAnimatableProperty<float>>(0.0f);
    auto property1 = std::make_shared<RSRenderAnimatableProperty<float>>(0.0f);
    auto property2 = std::make_shared<RSRenderAnimatableProperty<float>>(1.0f);
    auto animationPath = RSPath::CreateRSPath(ANIMATION_PATH);
