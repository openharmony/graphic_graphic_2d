 ...
 * @return If successful, return a pointer to <b>OH_Drawing_Typeface</b> object. else, return nullptr.
 * @since 12
 * @version 1.0
 */
 ...
 * @param OH_Drawing_FontStyleSet Indicates the pointer to an <b>OH_Drawing_FontStyleSet</b> object.
 * @param index Indicates the index of the typeface in this fontStyleSet.
 * @param fontStyleStruct Indicates font style returned to the caller.
 * @param styleName Indicates the style name returned to the caller.
 * @since 12
 * @version 1.0
 */
