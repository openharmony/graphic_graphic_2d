...
/**
 * @brief Checks if <b>OH_Drawing_Path</b> represents a empty.
 *
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param path Indicates the pointer to an <b>OH_Drawing_Path</b> object.
 ...
 *
 * @param path Indicates the pointer to an <b>OH_Drawing_Path</b> object.
 * @param isInverse Indicates if the fill type is one of the INVERSE variants.
 * @return Returns the error code.
 *         Returns {@link OH_DRAWING_SUCCESS} if the operation is successful.
...
/**
 * @brief Toggles the INVERSE state of the fill type.
 *
 * @param path Indicates the pointer to an <b>OH_Drawing_Path</b> object.
 * @return Returns the error code.
 *         Returns {@link OH_DRAWING_SUCCESS} if the operation is successful.
