...
void OH_Drawing_TypographyPaintOnPath(
    OH_Drawing_Typography*, OH_Drawing_Canvas*, OH_Drawing_Path*, double /* hOffset */, double /* vOffset */);
 ...
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param OH_Drawing_TextStyle Indicates the pointer to an <b>OH_Drawing_TextStyle</b> object.
 * @return Returns the pointer to vector of <b>OH_Drawing_TextShadow</b> objects.
 * @since 12
 * @version 1.0
 */
 ...
 * @version 1.0
 */
void OH_Drawing_TextStyleAddShadow(OH_Drawing_TextStyle*, OH_Drawing_TextShadow*);

/**
 * @brief Clears elements in vector of TextShadow in TextStyle.
 *
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param OH_Drawing_TextStyle Indicates the pointer to an <b>OH_Drawing_TextStyle</b> object.
 * @since 12
 ...
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param OH_Drawing_TypographyStyle Indicates the pointer to an <b>OH_Drawing_TypographyStyle</b> object.
 * @param int Indicates the font weight of text typography to set.
 ...
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param OH_Drawing_TypographyStyle Indicates the pointer to an <b>OH_Drawing_TypographyStyle</b> object.
 * @param int Indicates the font style of line style for text typography to set.
 ...
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param OH_Drawing_TypographyStyle Indicates the pointer to an <b>OH_Drawing_TypographyStyle</b> object.
 * @return Returns IsEllipsized of text.
 * @since 12
 * @version 1.0
 */
 ...
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param OH_Drawing_TypographyCreate Indicates the pointer to an <b>OH_Drawing_TypographyCreate</b> object.
 * @param symbol Indicates the symbol to add.
 * @since 12
 * @version 1.0
 */
 ...
 *
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param style Indicates the pointer to an <b>OH_Drawing_TypographyStyle</b>
 * object.
 * @return Returns the pointer to the copied <b>OH_Drawing_TypographyStyle</b>
 * object.
 * @since 20
 * @version 1.0
 */
 ...
 *
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param shadow Indicates the pointer to an <b>OH_Drawing_TextShadow</b>
 * object.
 * @return Returns the pointer to the copied <b>OH_Drawing_TextShadow</b>
 * object.
 * @since 20
 * @version 1.0
 */
