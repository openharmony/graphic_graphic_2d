...
public:
    ...
    void InitWithColorMatrix(const ColorMatrix& m, Clamp clamp = Clamp::YES_ENUM) override;
    void InitWithColorFloat(const float f[20], Clamp clamp = Clamp::YES_ENUM) override;
    ...
    void InitWithCompose(const float f1[MATRIX_SIZE], const float f2[MATRIX_SIZE], Clamp clamp = Clamp::YES_ENUM) override;
