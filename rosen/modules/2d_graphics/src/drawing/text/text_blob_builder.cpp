...
namespace Rosen {
namespace Drawing {
TextBlobBuilder::TextBlobBuilder() : textBlobBuilderImpl_(ImplFactory::CreateTextBlobBuilderImpl()) {}
...
const TextBlobBuilder::RunBuffer& TextBlobBuilder::AllocRunPos(const Font& font, int count,
                                                               const Rect* bounds)
{
