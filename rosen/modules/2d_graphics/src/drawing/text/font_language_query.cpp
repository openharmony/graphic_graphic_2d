...
static const std::unordered_map<UnicodeRangeId, UnicodeRangeInfo> unicodeRangeBitConfig = {
    ...
    {UnicodeRangeId::UR_BASIC_LATIN, {{{0x0041, 0x005A}, {0x0061, 0x007A}},
        {"la", "en", "fr", "de", "es", "pt", "it", "tr", "nl", "sv", "da", "no", "fi", "id"}}},
    {UnicodeRangeId::UR_LATIN_EXTENDED_A, {{{0x0100, 0x017F}},
        {"cs", "pl", "ro", "hu", "sk", "hr", "sl", "lt", "lv", "et", "tr", "az"}}},
    ...
    {UnicodeRangeId::UR_COPTIC, {{{0x2C80, 0x2CFF}},
        {"cop"}}},
    {UnicodeRangeId::UR_CYRILLIC, {{{0x0400, 0x04FF}, {0x0500, 0x052F}, {0x2DE0, 0x2DFF}, {0xA640, 0xA69F}},
        {"ru", "uk", "be", "bg", "sr", "mk", "cu"}}},
    ...
    {UnicodeRangeId::UR_VAI, {{{0xA500, 0xA63F}},
        {"vai"}}},
    {UnicodeRangeId::UR_ARABIC, {{{0x0600, 0x06FF}, {0x0750, 0x077F}, {0x0870, 0x089F}, {0x08A0, 0x08FF}},
        {"ar", "fa", "ur", "ps", "ku", "sd", "ug", "kk-arab"}}},
    {UnicodeRangeId::UR_NKO, {{{0x07C0, 0x07FF}},
        {"mnk-Nko", "nqo-Nko", "bm-Nko", "dyu-Nko"}}},
    {UnicodeRangeId::UR_SAMARITAN, {{{0x0800, 0x083F}},
        {"smp-Samr", "sam-Samr"}}},
    {UnicodeRangeId::UR_MANDAIC, {{{0x0840, 0x085F}},
        {"mid-Mand"}}},
    {UnicodeRangeId::UR_DEVANAGARI, {{{0x0900, 0x097F}},
        {"hi-Deva", "mr-Deva", "raj-Deva", "kokne-Deva", "bho-Deva", "mai-Deva", "sd-Deva", "sa-Deva", "brx-Deva"}}},
    ...
    {UnicodeRangeId::UR_TIBETAN, {{{0x0F00, 0x0FFF}},
        {"bo-Tibt", "dz-Tibt", "sip-Tibt"}}},
    {UnicodeRangeId::UR_SYRIAC, {{{0x0700, 0x074F}, {0x0860, 0x086F}},
        {"syr"}}},
    {UnicodeRangeId::UR_THAANA, {{{0x0780, 0x07BF}},
        {"dv-Thaa"}}},
    {UnicodeRangeId::UR_SINHALA, {{{0x0D80, 0x0DFF}},
        {"si-Sinh", "pi-Sinh", "pa-Sinh"}}},
    {UnicodeRangeId::UR_MYANMAR, {{{0x1000, 0x109F}},
        {"my-Mymr", "mnw-Mymr", "omx-Mymr", "pll-Mymr", "pce-Mymr", "rbb-Mymr", "kbr-Mymr"}}},
    {UnicodeRangeId::UR_ETHIOPIC, {{{0x1200, 0x137F}},
        {"gez-Ethi", "ti-Ethi", "am-Ethi", "tig-Ethi", "har-Ethi"}}},
    {UnicodeRangeId::UR_ETHIOPIC_SUPPLEMENT, {{{0x1380, 0x139F}},
        {"sgw-Ethi"}}},
    {UnicodeRangeId::UR_ETHIOPIC_EXTENDED, {{{0x2D80, 0x2DDF}},
        {"byn-Ethi", "sgw-Ethi"}}},
    {UnicodeRangeId::UR_CHEROKEE, {{{0x13A0, 0x13FF}},
        {"chr-Cher"}}},
    {UnicodeRangeId::UR_UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS, {{{0x1400, 0x167F}},
        {"iu-Cans", "cr-Cans", "oj-Cans"}}},
    {UnicodeRangeId::UR_OGHAM, {{{0x1680, 0x169F}},
        {"pgl-Ogam", "sga-Ogam", "xpi-Ogam"}}},
    {UnicodeRangeId::UR_RUNIC, {{{0x16A0, 0x16FF}},
        {"non-Runr", "gem-Runr", "ang-Runr", "goh-Runr"}}},
    {UnicodeRangeId::UR_KHMER, {{{0x1780, 0x17FF}, {0x19E0, 0x19FF}},
        {"km-Khmr"}}},
    {UnicodeRangeId::UR_MONGOLIAN, {{{0x1800, 0x18AF}},
        {"mn-Mong"}}},
    {UnicodeRangeId::UR_YI_SYLLABLES, {{{0xA000, 0xA48F}, {0xA490, 0xA4CF}},
        {"ii-Yiii"}}},
    {UnicodeRangeId::UR_TAGALOG, {{{0x1700, 0x171F}},
        {"tl-Tglg", "tgl-Tglg"}}},
    {UnicodeRangeId::UR_HANUNOO, {{{0x1720, 0x173F}},
        {"hnn-Hano"}}},
    {UnicodeRangeId::UR_BUHID, {{{0x1740, 0x175F}},
        {"bku-Buhd"}}},
    {UnicodeRangeId::UR_TABGANWA, {{{0x1760, 0x177F}},
        {"tbw-Tagb"}}},
    {UnicodeRangeId::UR_OLD_ITALIC, {{{0x10300, 0x1032F}},
        {"la-Ital", "ett-Ital", "osc-Ital", "xum-Ital", "xfa-Ital", "nrp-Ital", "stc-Ital", "xrr-Ital", "xlp-Ital",
         "xve-Ital"}}},
    ...
    {UnicodeRangeId::UR_BUGINESE, {{{0x1A00, 0x1A1F}},
        {"bug-Bugi", "mak-Bugi", "mdr-Bugi"}}},
    {UnicodeRangeId::UR_GLAGOLITIC, {{{0x2C00, 0x2C5F}},
        {"cu-Glag", "chu-Glag"}}},
    {UnicodeRangeId::UR_TIFINAGH, {{{0x2D30, 0x2D7F}},
        {"ber-Tfng", "zgh-Tfng", "kab-Tfng", "tmh-Tfng", "tzm-Tfng", "shi-Tfng", "rif-Tfng"}}},
    ...
    {UnicodeRangeId::UR_KHAROSHTHI, {{{0x10A00, 0x10A5F}},
        {"pra-Khar", "sa-Khar", "pgd-khar"}}},
    {UnicodeRangeId::UR_CUNEIFORM, {{{0x12000, 0x123FF}},
        {"sux-Xsux", "akk-Xsux", "hit-Xsux", "xlu-Xsux", "plq-Xsux", "elx-Xsux", "xhu-Xsux", "xur-Xsux"}}},
    ...
    {UnicodeRangeId::UR_CHAM, {{{0xAA00, 0xAA5F}},
        {"cja-Cham", "cjm-Cham"}}},
    {UnicodeRangeId::UR_CARIAN, {{{0x102A0, 0x102DF}},
        {"xcr-Cari"}}},
    {UnicodeRangeId::UR_LYCIAN, {{{0x10280, 0x1029F}},
        {"xlc-Lyci"}}},
    {UnicodeRangeId::UR_LYDIAN, {{{0x10920, 0x1093F}},
        {"xld-Lydi"}}}
};
