...
public:
    /**
     * @brief Shader described by shading language requires an entry point that looks like:
    ...
    /**
     * @brief Blend shader described by shading language requires an entry point that looks like:
