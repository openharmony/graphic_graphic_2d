...
constexpr int SLEEP_TIME_TWO_SEC = 2;
constexpr int SLEEP_TIME_FOUR_SEC = 4;
...
int main()
{
    ...
    cout << "usedma is " << captureConfig.useDma << endl;
    RSInterfaces::GetInstance().TakeSurfaceCaptureForUIWithConfig(rootNode, myOffscreenRenderCallback, captureConfig);
    sleep(SLEEP_TIME_TWO_SEC);
    ...
    cout << "isSync is " << captureConfig.isSync << endl;
    RSInterfaces::GetInstance().TakeSurfaceCaptureForUIWithConfig(rootNode, myOffscreenRenderCallback, captureConfig);
    sleep(SLEEP_TIME_TWO_SEC);
