 ...
 */
#ifndef UIEFFECT_USE_EFFECT_MASK_PARA_H
#define UIEFFECT_USE_EFFECT_MASK_PARA_H
...
namespace OHOS {
namespace Rosen {
class RSC_EXPORT UseEffectMaskPara : public MaskPara {
public:
    UseEffectMaskPara()
    {
        type_ = MaskPara::Type::USE_EFFECT_MASK;
    }
    ~UseEffectMaskPara() override = default;
 
    UseEffectMaskPara(const UseEffectMaskPara& other);
