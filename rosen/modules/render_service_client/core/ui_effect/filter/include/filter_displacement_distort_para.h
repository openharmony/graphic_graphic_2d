 ...
 */
#ifndef UIEFFECT_FILTER_DISPLACEMENT_DISTORT_PARA_H
#define UIEFFECT_FILTER_DISPLACEMENT_DISTORT_PARA_H
...
private:
    ...
    Vector2f factor_ { 0.0f, 0.0f };
};
} // namespace Rosen
} // namespace OHOS
#endif // UIEFFECT_FILTER_DISPLACEMENT_DISTORT_PARA_H
