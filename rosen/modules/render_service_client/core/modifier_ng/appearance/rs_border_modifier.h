...
#ifndef RENDER_SERVICE_CLIENT_CORE_MODIFIER_NG_APPEARANCE_RS_BORDER_MODIFIER_H
#define RENDER_SERVICE_CLIENT_CORE_MODIFIER_NG_APPEARANCE_RS_BORDER_MODIFIER_H
...
public:
    ...
    static inline constexpr auto Type = RSModifierType::BORDER;
