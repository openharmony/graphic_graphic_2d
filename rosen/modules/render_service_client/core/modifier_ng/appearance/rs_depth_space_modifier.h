...
#ifndef RENDER_SERVICE_CLIENT_CORE_MODIFIER_NG_APPEARANCE_RS_SPATIAL_SPACE_MODIFIER_H
#define RENDER_SERVICE_CLIENT_CORE_MODIFIER_NG_APPEARANCE_RS_SPATIAL_SPACE_MODIFIER_H
...
public:
    ...
    void SetDepthSpaceType(DepthSapceType type);
...
#endif // RENDER_SERVICE_CLIENT_CORE_MODIFIER_NG_APPEARANCE_RS_SPATIAL_SPACE_MODIFIER_H