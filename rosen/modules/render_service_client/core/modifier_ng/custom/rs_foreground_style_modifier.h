...
#ifndef RENDER_SERVICE_CLIENT_CORE_MODIFIER_NG_CUSTOM_RS_FOREGROUND_STYLE_MODIFIER_H
#define RENDER_SERVICE_CLIENT_CORE_MODIFIER_NG_CUSTOM_RS_FOREGROUND_STYLE_MODIFIER_H
 ...
 *
 * @brief Draws the custom foreground content.
 *
 ...
 */
class RSC_EXPORT RSForegroundStyleModifier : public RSCustomModifier {
public:
