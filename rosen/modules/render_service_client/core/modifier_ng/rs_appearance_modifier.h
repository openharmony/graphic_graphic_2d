...
#ifndef RENDER_SERVICE_CLIENT_CORE_MODIFIER_NG_RS_APPEARANCE_MODIFIER_H
#define RENDER_SERVICE_CLIENT_CORE_MODIFIER_NG_RS_APPEARANCE_MODIFIER_H
...
class RSC_EXPORT RSTransitionStyleModifier : public RSExtendedModifier {
public:
...
class RSC_EXPORT RSOutlineModifier : public RSModifier {
public:
    RSOutlineModifier() = default;
    ~RSOutlineModifier() override = default;

    static inline constexpr auto Type = ModifierNG::RSModifierType::OUTLINE;
    ModifierNG::RSModifierType GetType() const override
    {
        return Type;
    };
    ...
    void SetOutlineStyle(const Vector4<uint32_t>& style);
    ...
    const Vector4<uint32_t> GetOutlineStyle() const;
...
#endif // RENDER_SERVICE_CLIENT_CORE_MODIFIER_NG_RS_APPEARANCE_MODIFIER_H
