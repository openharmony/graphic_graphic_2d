...
{
    SetProperty<RSClipRectModifier, RSAnimatableProperty<Vector4f>>(RSModifierType::CLIP_RECT, clipRect);
    SetProperty<RSClipRadiusModifier, RSAnimatableProperty<Vector4f>>(RSModifierType::CLIP_RADIUS, clipRadius);
}
