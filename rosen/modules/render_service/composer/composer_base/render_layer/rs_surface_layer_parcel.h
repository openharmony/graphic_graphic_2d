...
#ifndef RENDER_SERVICE_COMPOSER_BASE_RENDER_LAYER_RS_SURFACE_LAYER_PARCEL_H
#define RENDER_SERVICE_COMPOSER_BASE_RENDER_LAYER_RS_SURFACE_LAYER_PARCEL_H
...
#endif // RENDER_SERVICE_COMPOSER_BASE_RENDER_LAYER_RS_SURFACE_LAYER_PARCEL_H
