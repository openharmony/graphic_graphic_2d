...
public:
    ...
    */
    ...
    static void DrawCached(DrawableV2::RSSurfaceRenderNodeDrawable* surfaceDrawable,
        RSPaintFilterCanvas& canvas, RSSurfaceRenderParams& surfaceParams, std::shared_ptr<Drawing::Image> cacheImage)
private:
    bool HasCache() const;
    std::shared_ptr<Drawing::Image> RSDrawWindowCache::CacheWindowContent(DrawableV2::RSSurfaceRenderNodeDrawable* surfaceDrawable,
        RSPaintFilterCanvas& canvas, const Drawing::Rect& bounds)
