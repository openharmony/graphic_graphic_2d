...
public:
    ...
    void DumpEventQueue();
    void ClearRedrawGPUCompositionCache(const std::set<int32_t>& bufferIds);
private:
    ...
    bool IsDelayRequired(OHOS::Rosen::HgmCore& hgmCore, RefreshRateParam param, bool hasGameScene);
