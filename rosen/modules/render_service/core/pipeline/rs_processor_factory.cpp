...
std::shared_ptr<RSProcessor> RSProcessorFactory::CreateProcessor(CompositeType type, ScreenId screenId)
{
    switch (type) {
        ...
        case CompositeType::HARDWARE_COMPOSITE:
            return std::make_shared<RSPhysicalScreenProcessor>(screenId);
#ifdef RS_ENABLE_GPU
