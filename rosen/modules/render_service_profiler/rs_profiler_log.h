...
#define HRPIDN(format, ...) (void)"LCOV_EXCL_BR_LINE"; ((CONDITION(DEBUG_NODE)) ? RS_LOGI("[HRP] " format, ##__VA_ARGS__) : (void)0)
#define HRPIDM(format, ...) (void)"LCOV_EXCL_BR_LINE"; ((CONDITION(DEBUG_MODIFIER)) ? RS_LOGI("[HRP] " format, ##__VA_ARGS__) : (void)0)
// NOLINTEND
