...
class VSync90To30Test : public testing::Test {
public:
...
int32_t VSync90To30Test::JudgeRefreshRate(int64_t period)
{
    if (period <= 0) {
        return 0;
    }
...
HWTEST_F(VSync90To30Test, ChangeRefreshRateTest, Function | MediumTest | Level2)
{
    if (pipe(pipeFd) < 0) {
        exit(1);
    }
