...
class VSync60To90Test : public testing::Test {
public:
...
int32_t VSync60To90Test::JudgeRefreshRate(int64_t period)
{
    if (period <= 0) {
        return 0;
    }
...
HWTEST_F(VSync60To90Test, ChangeRefreshRateTest, Function | MediumTest | Level2)
{
    if (pipe(pipeFd) < 0) {
        exit(1);
    }
