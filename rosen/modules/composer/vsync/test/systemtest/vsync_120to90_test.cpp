...
class VSync120To90Test : public testing::Test {
public:
...
int32_t VSync120To90Test::JudgeRefreshRate(int64_t period)
{
    if (period <= 0) {
        return 0;
    }
...
void VSync120To90Test::Process1()
{
#ifdef SUPPORT_ACCESS_TOKEN
    InitNativeTokenInfo();
...
void VSync120To90Test::Process2()
{
    close(pipeFd[0]);
    close(pipe1Fd[1]);
    char buf[10];
...
HWTEST_F(VSync120To90Test, ChangeRefreshRateTest, Function | MediumTest | Level2)
{
    if (pipe(pipeFd) < 0) {
        exit(1);
    }
