...
constexpr std::string HGM_CONFIG_TYPE_THERMAL_SUFFIX = "_THERMAL";
constexpr std::string HGM_CONFIG_TYPE_DRAGSLIDE_SUFFIX = "_DRAGSLIDE";
constexpr std::string HGM_CONFIG_TYPE_THROWSLIDE_SUFFIX = "_THROWSLIDE";
// {Suffix, {Priority, State}}
constexpr std::unordered_map<std::string, std::pair<int32_t, bool>> HGM_CONFIG_SCREENEXT_STRATEGY_MAP = {
