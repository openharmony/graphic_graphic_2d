...
constexpr uint32_t DRAG_FRAME_RATE_TYPE = REFRESH_DRAG_FRAME_RATE_TYPE | 
    SWIPER_DRAG_FRAME_RATE_TYPE | SCROLLABLE_DRAG_FRAME_RATE_TYPE | 
    SCROLLBAR_DRAG_FRAME_RATE_TYPE | SPLIT_DRAG_FRAME_RATE_TYPE | 
