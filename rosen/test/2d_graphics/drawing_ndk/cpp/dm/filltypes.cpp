...
void FillType::showPath(OH_Drawing_Canvas *canvas, int x, int y, OH_Drawing_PathFillType ft, float scale,
...
void FillType::showFour(OH_Drawing_Canvas *canvas, float scale, OH_Drawing_Brush *brush) {
    ...
    showPath(canvas, 00, 200, OH_Drawing_PathFillType::PATH_FILL_TYPE_INVERSE_WINDING, scale, brush);
