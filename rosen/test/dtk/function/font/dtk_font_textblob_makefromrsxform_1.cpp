...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 1)
{
    ...
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 1, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 2)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 1, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 3)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 1, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 4)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 1, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 5)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 2, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 6)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 2, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 7)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 2, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 8)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 2, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 9)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 3, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 10)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 3, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 11)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 3, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 12)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 3, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 13)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 4, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 14)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 4, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 15)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 4, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 16)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 4, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 17)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 1, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 18)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 1, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 19)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 1, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 20)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 1, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 21)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 2, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 22)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 2, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 23)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 2, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 24)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 2, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 25)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 3, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 26)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 3, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 27)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 3, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 28)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 3, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 29)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 4, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 30)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 4, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 31)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 4, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 32)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size()+1, 4, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 33)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 1, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 34)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 1, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 35)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 1, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 36)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 1, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 37)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 2, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 38)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 2, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 39)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 2, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 40)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 2, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 41)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 3, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 42)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 3, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 43)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 3, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 44)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 3, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 45)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 4, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 46)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 4, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 47)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 4, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 48)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        0, 4, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 49)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 1, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 50)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 1, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 51)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 1, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 52)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 1, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 53)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 2, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 54)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 2, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 55)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 2, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 56)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 2, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 57)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 3, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 58)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 3, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 59)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 3, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 60)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 3, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 61)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 4, Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 62)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 4, Drawing::TextEncoding::UTF16, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 63)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 4, Drawing::TextEncoding::UTF32, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 64)
{
    std::string textInfo = "鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙鸿蒙";
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        -5, 4, Drawing::TextEncoding::GLYPH_ID, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 65)
{
    ...
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 1,
        Drawing::TextEncoding::UTF8, textInfo.c_str());
}
...
DEF_DTK(textblob_makefromrsxform_1, TestLevel::L1, 66)
{
    ...
    DrawTexts(playbackCanvas_, "HarmonyOS Sans SC", textInfo,
        textInfo.size(), 1,
        Drawing::TextEncoding::UTF16, textInfo.c_str());
}
