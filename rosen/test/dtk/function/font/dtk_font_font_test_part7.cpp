...
// 对应用例 font_font_3378
DEF_DTK(font_font_7, TestLevel::L2, 378)
{
    // 创建typeface
...
// 对应用例 font_font_3379
DEF_DTK(font_font_7, TestLevel::L2, 379)
{
    // 创建typeface
...
// 对应用例 font_font_3380
DEF_DTK(font_font_7, TestLevel::L2, 380)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3381
DEF_DTK(font_font_7, TestLevel::L2, 381)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3382
DEF_DTK(font_font_7, TestLevel::L2, 382)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3383
DEF_DTK(font_font_7, TestLevel::L2, 383)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3384
DEF_DTK(font_font_7, TestLevel::L2, 384)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3385
DEF_DTK(font_font_7, TestLevel::L2, 385)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3386
DEF_DTK(font_font_7, TestLevel::L2, 386)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3387
DEF_DTK(font_font_7, TestLevel::L2, 387)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3388
DEF_DTK(font_font_7, TestLevel::L2, 388)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3389
DEF_DTK(font_font_7, TestLevel::L2, 389)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3390
DEF_DTK(font_font_7, TestLevel::L2, 390)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3391
DEF_DTK(font_font_7, TestLevel::L2, 391)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3392
DEF_DTK(font_font_7, TestLevel::L2, 392)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3393
DEF_DTK(font_font_7, TestLevel::L2, 393)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3394
DEF_DTK(font_font_7, TestLevel::L2, 394)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3395
DEF_DTK(font_font_7, TestLevel::L2, 395)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3396
DEF_DTK(font_font_7, TestLevel::L2, 396)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3397
DEF_DTK(font_font_7, TestLevel::L2, 397)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3398
DEF_DTK(font_font_7, TestLevel::L2, 398)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3399
DEF_DTK(font_font_7, TestLevel::L2, 399)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3400
DEF_DTK(font_font_7, TestLevel::L2, 400)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3401
DEF_DTK(font_font_7, TestLevel::L2, 401)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3402
DEF_DTK(font_font_7, TestLevel::L2, 402)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3403
DEF_DTK(font_font_7, TestLevel::L2, 403)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3404
DEF_DTK(font_font_7, TestLevel::L2, 404)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3405
DEF_DTK(font_font_7, TestLevel::L2, 405)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3406
DEF_DTK(font_font_7, TestLevel::L2, 406)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3407
DEF_DTK(font_font_7, TestLevel::L2, 407)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDynamicFontMgr());
    std::string familyName = "HMOS Color Emoji";
