...
// 用例 Font_Scene_Effect_0036
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 36)
{
    // 1.创建typeface
...
// 用例 Font_Scene_Effect_0037
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 37)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0038
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 38)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0039
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 39)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0040
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 40)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0041
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 41)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0042
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 42)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0043
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 43)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0044
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 44)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0045
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 45)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0046
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 46)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0047
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 47)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0048
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 48)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
    ...
    //6. 得到需要绘制的所有返回值text,全部适应固定的textBlob构造方式打印
    std::vector<std::string> texts = {text2, text4};
...
// 用例 Font_Scene_Effect_0049
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 49)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0050
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 50)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0051
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 51)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0052
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 52)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0053
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 53)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0054
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 54)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
// 用例 Font_Scene_Effect_0055
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 55)
{
    // 1.创建typeface
...
// 用例 Font_Scene_Effect_0056
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 56)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0057
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 57)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0058
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 58)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0059
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 59)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0060
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 60)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0061
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 61)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0062
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 62)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0063
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 63)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0064
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 64)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0065
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 65)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0066
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 66)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0067
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 67)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0068
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 68)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
...
// 用例 Font_Scene_Effect_0069
DEF_DTK(Font_Scene_Effect_2, TestLevel::L2, 69)
{
    // 1.创建typeface
    std::string name = "HarmonyOS-Sans";
    auto typeface = Drawing::Typeface::MakeFromName(name.c_str(), Drawing::FontStyle());
