...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 36)
{
    // 1.创建typeface
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 37)
{
    // 1.创建typeface
    char data1[10] = {0};
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 38)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 39)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 40)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 41)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 42)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 43)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 44)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 45)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 46)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 47)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 48)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 49)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 50)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 51)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
...
DEF_DTK(Font_Scene_Effect_3, TestLevel::L2, 52)
{
    // 1.创建typeface
    char data1[10] = {0};
    auto stream = std::make_unique<Drawing::MemoryStream>(data1, 10);
