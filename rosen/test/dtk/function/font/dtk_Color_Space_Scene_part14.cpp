...
// 用例 ColorSpace_Scene_0226
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 226)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    ...
    // 2.ColorSpace构造接口
    auto colorspace = Drawing::ColorSpace::CreateRGB(CMSTransferFuncType::LINEAR, CMSMatrixType::REC2020);
...
// 用例 ColorSpace_Scene_0227
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 227)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
...
// 用例 ColorSpace_Scene_0228
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 228)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(false); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0229
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 229)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(false); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0230
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 230)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(true); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0231
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 231)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(true); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
    ...
    // 3.组合ColorSpace操作接口
    auto colorspace2 = Drawing::ColorSpace::CreateRGB(CMSTransferFuncType::LINEAR, CMSMatrixType::REC2020);
...
// 用例 ColorSpace_Scene_0232
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 232)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(true); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0233
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 233)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(true); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0234
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 234)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(true); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0235
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 235)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(false); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0236
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 236)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(true); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0237
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 237)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(false); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0238
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 238)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(true); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0239
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 239)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(false); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0240
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 240)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(false); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0241
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 241)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(true); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
...
// 用例 ColorSpace_Scene_0242
DEF_DTK(ColorSpace_Scene_14, TestLevel::L2, 242)
{
    // 1.创建笔刷，设置笔刷是否为抗锯齿效果
    Drawing::Brush brush;
    brush.SetAntiAlias(true); // 设置笔刷抗锯齿，true为AA（抗锯齿），false为非AA（不抗锯齿）
