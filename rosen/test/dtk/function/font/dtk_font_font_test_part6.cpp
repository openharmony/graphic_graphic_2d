...
// 对应用例 font_font_3351
DEF_DTK(font_font_6, TestLevel::L2, 351)
{
    // 创建typeface
...
// 对应用例 font_font_3352
DEF_DTK(font_font_6, TestLevel::L2, 352)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3353
DEF_DTK(font_font_6, TestLevel::L2, 353)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3354
DEF_DTK(font_font_6, TestLevel::L2, 354)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3355
DEF_DTK(font_font_6, TestLevel::L2, 355)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3356
DEF_DTK(font_font_6, TestLevel::L2, 356)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3357
DEF_DTK(font_font_6, TestLevel::L2, 357)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3358
DEF_DTK(font_font_6, TestLevel::L2, 358)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3359
DEF_DTK(font_font_6, TestLevel::L2, 359)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3360
DEF_DTK(font_font_6, TestLevel::L2, 360)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3361
DEF_DTK(font_font_6, TestLevel::L2, 361)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3362
DEF_DTK(font_font_6, TestLevel::L2, 362)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3363
DEF_DTK(font_font_6, TestLevel::L2, 363)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3364
DEF_DTK(font_font_6, TestLevel::L2, 364)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3365
DEF_DTK(font_font_6, TestLevel::L2, 365)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3366
DEF_DTK(font_font_6, TestLevel::L2, 366)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3367
DEF_DTK(font_font_6, TestLevel::L2, 367)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3368
DEF_DTK(font_font_6, TestLevel::L2, 368)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3369
DEF_DTK(font_font_6, TestLevel::L2, 369)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3370
DEF_DTK(font_font_6, TestLevel::L2, 370)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3371
DEF_DTK(font_font_6, TestLevel::L2, 371)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3372
DEF_DTK(font_font_6, TestLevel::L2, 372)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3373
DEF_DTK(font_font_6, TestLevel::L2, 373)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3374
DEF_DTK(font_font_6, TestLevel::L2, 374)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3375
DEF_DTK(font_font_6, TestLevel::L2, 375)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3376
DEF_DTK(font_font_6, TestLevel::L2, 376)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
...
// 对应用例 font_font_3377
DEF_DTK(font_font_6, TestLevel::L2, 377)
{
    // 创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    std::string familyName = "HMOS Color Emoji";
