...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 89)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    const uint8_t emptyFontData[10] = { 0 };
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 90)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    const uint8_t emptyFontData[10] = { 0 };
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 91)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 92)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 93)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 94)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 95)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 96)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 97)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 98)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 99)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 100)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 101)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 102)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
...
DEF_DTK(Font_Scene_Effect_6, TestLevel::L2, 103)
{
    // 1.创建typeface
    std::shared_ptr<Drawing::FontMgr> fontMgr(Drawing::FontMgr::CreateDefaultFontMgr());
    int familyCount = fontMgr->CountFamilies();
