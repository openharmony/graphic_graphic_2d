...
class RSProfilerCaptureDataUnitTest : public testing::Test {
public:
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, TimeTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, StringPropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, FloatPropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, DoublePropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, Int8PropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, Uint8PropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, Int16PropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, Uint16PropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, Int32PropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, Uint32PropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, Int64PropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, Uint64PropertyTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerCaptureDataUnitTest, SerializationTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
