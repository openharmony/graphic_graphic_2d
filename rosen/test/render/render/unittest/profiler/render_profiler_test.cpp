...
class RenderCustomRenderModifier : public RSRenderModifier {
public:
    RenderCustomRenderModifier() = default;
    ~RenderCustomRenderModifier() override = default;
...
class RSB_EXPORT RenderCanvasDrawingRenderNode : public RSCanvasDrawingRenderNode {
public:
    RenderCanvasDrawingRenderNode(NodeId id, const std::weak_ptr<RSContext>& context, bool isTextureExportNode)
        : RSCanvasDrawingRenderNode(id, context, isTextureExportNode)
    {}
    ~RenderCanvasDrawingRenderNode() override = default;
...
class RenderProfilerTest : public testing::Test {
public:
...
/*
 * @tc.name: MarshalSelfDrawingBuffersTest01
 * @tc.desc: Test MarshalSelfDrawingBuffers method
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerTest, MarshalSelfDrawingBuffersTest01, Level1)
{
...
/*
 * @tc.name: UnmarshalSelfDrawingBuffersTest01
 * @tc.desc: Test UnmarshalSelfDrawingBuffersTest01 method
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerTest, UnmarshalSelfDrawingBuffersTest, Level1)
{
    auto context = std::make_shared<RSContext>();
    RSProfiler::context_ = context.get();
    RSSurfaceRenderNodeConfig config;
...
/*
 * @tc.name: InterfaceTest01
 * @tc.desc: RSProfiler Interface Test
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerTest, InterfaceTest01, TestSize.Level1)
{
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerTest, InfoTest01, TestSize.Level1)
{
    RSProfiler::testing_ = true;
    std::vector<std::string> cmds { "info", "freq", "fixenv", "params", "rscon_print", "rstree_contains",
        "rstree_pid" };
    EXPECT_NO_THROW({
...
/*
 * @tc.name: RSTreeTest01
 * @tc.desc: RSProfiler RSTree Test
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerTest, RSTreeTest01, TestSize.Level1)
{
    RSProfiler::testing_ = true;
...
class RenderProfilerContextTest : public testing::Test {
...
RSRenderService* RenderProfilerContextTest::renderService;
...
/*
 * @tc.name: LogEventStart01
 * @tc.desc: Test LogEventStart
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerTest, LogEventStart01, TestSize.Level1)
{
    RSProfiler::testing_ = true;
...
/*
 * @tc.name: SecureScreen01
 * @tc.desc: Test SecureScreen
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerContextTest, SecureScreen01, TestSize.Level1)
{
    RSProfiler::testing_ = true;
...
/*
 * @tc.name: ClearBetaRecordFilesTest01
 * @tc.desc: Test ClearBetaRecordFiles
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerTest, ClearBetaRecordFilesTest01, TestSize.Level1)
{
...
/*
 * @tc.name: PlaybackDeltaTimeNanoTest01
 * @tc.desc: Test PlaybackDeltaTimeNano
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerTest, PlaybackDeltaTimeNanoTest01, TestSize.Level1)
{
...
/*
 * @tc.name: LogEventVSync01
 * @tc.desc: Test LogEventVSync
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerTest, LogEventVSync01, TestSize.Level1)
{
    RSProfiler::testing_ = true;
    sptr<RSRenderService> renderService = GetAndInitRenderService();
    RSProfiler::Init(renderService);
...
/*
 * @tc.name: UnmarshalNodeModifiersTest01
 * @tc.desc: Test UnmarshalNodeModifiers
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RenderProfilerTest, UnmarshalNodeModifiersTest01, TestSize.Level1)
{
    ...
    auto modifier = std::make_shared<ModifierNG::RenderCustomRenderModifier>();
    ...
    RenderCanvasDrawingRenderNode node(1, context, false);
...
/*
 * @tc.name: RSFileOffsetVersionTest01
 * @tc.desc: Test RSFileOffsetVersion
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RSProfilerFileTest, RSFileOffsetVersionTest01, TestSize.Level1)
{
...
/*
 * @tc.name: GetEOFTimeTest01
 * @tc.desc: Test GetEOFTime
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RSProfilerFileTest, GetEOFTimeTest01, TestSize.Level1)
{
...
/*
 * @tc.name: WriteTrace3DMetricsTest01
 * @tc.desc: Test WriteTrace3DMetrics
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RSProfilerFileTest, WriteTrace3DMetricsTest01, TestSize.Level1)
{
    std::string fileName = "rs_profiler_test.data";
    RSFile rsFile;
    rsFile.SetVersion(RSFILE_VERSION_RENDER_ANIMESTARTTIMES_ADDED);
...
/*
 * @tc.name: ReadAnimationStartTimeTest01
 * @tc.desc: Test ReadAnimationStartTime
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RSProfilerFileTest, ReadAnimationStartTimeTest01, TestSize.Level1)
{
    std::string fileName = "rs_profiler_test.data";
    RSFile rsFile;
    rsFile.SetVersion(RSFILE_VERSION_RENDER_ANIMESTARTTIMES_ADDED);
...
/*
 * @tc.name: ReadHeaderTest01
 * @tc.desc: Test ReadHeader
 * @tc.type: FUNC
 * @tc.require: 22738
 */
HWTEST_F(RSProfilerFileTest, ReadHeaderTest01, TestSize.Level1)
{
    std::string fileName = "rs_profiler_test.data";
    RSFile rsFile;
    rsFile.SetVersion(RSFILE_VERSION_RENDER_ANIMESTARTTIMES_ADDED);
