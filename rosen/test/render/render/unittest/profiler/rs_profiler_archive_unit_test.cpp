...
class RSProfilerArchiveUnitTest : public testing::Test {
public:
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeCharTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeFloatTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeDoubleTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeInt8Test, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeInt32Test, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeUInt8Test, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeUint32Test, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeSizeTTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeStringTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeVectorNonFlatTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RSProfilerArchiveUnitTest, SerializeVectorCustomSerializerTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
