...
namespace OHOS {
namespace Rosen {
class RSUnionRenderNodeUtilTest : public testing::Test {
public:
...
void RSUnionRenderNodeUtilTest::SetUpTestCase() {}
void RSUnionRenderNodeUtilTest::TearDownTestCase() {}
void RSUnionRenderNodeUtilTest::SetUp() {}
void RSUnionRenderNodeUtilTest::TearDown() {}
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, CreateSDFOpShapeWithBaseInitialization001, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, CreateSDFOpShapeWithBaseInitialization002, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, CreateSDFOpShapeWithBaseInitialization003, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, CreateSDFOpShapeWithBaseInitialization004, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GetOrCreateChildSDFShape001, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GetOrCreateChildSDFShape002, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    auto child = std::make_shared<RSRenderNode>(id + 1, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GetOrCreateChildSDFShape003, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    auto child = std::make_shared<RSRenderNode>(id + 1, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GetOrCreateChildSDFShape004, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    auto child = std::make_shared<RSRenderNode>(id + 1, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GetChildRelativeMatrixToUnionNode001, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    auto child = std::make_shared<RSRenderNode>(id + 1, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GetChildRelativeMatrixToUnionNode002, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    auto child = std::make_shared<RSRenderNode>(id + 1, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GetChildRelativeMatrixToUnionNode003, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    auto child = std::make_shared<RSRenderNode>(id + 1, context);
    unionNode->renderProperties_.boundsGeo_ = std::make_shared<RSObjAbsGeometry>();
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GetChildRelativeMatrixToUnionNode004, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    auto child = std::make_shared<RSRenderNode>(id + 1, context);
    unionNode->renderProperties_.boundsGeo_ = std::make_shared<RSObjAbsGeometry>();
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFNonLeaf001, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFNonLeaf002, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    unionNode->unionChildren_.emplace(id + 1);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFNonLeaf003, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    unionNode->unionChildren_.emplace(id + 1);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFNonLeaf004, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    unionNode->unionChildren_.emplace(id + 1);
    unionNode->unionChildren_.emplace(id + 2);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFLeaf001, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFLeaf002, TestSize.Level1)
{
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, context);
    EXPECT_EQ(unionNode->GetContext().lock(), nullptr);
    std::queue<std::shared_ptr<RSNGRenderShapeBase>> shapeQueue;
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFLeaf003, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFLeaf004, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFLeaf005, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFLeaf006, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFLeaf007, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFLeaf008, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFLeaf009, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, GenerateSDFLeaf010, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, ProcessSDFShape001, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, ProcessSDFShape002, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, ProcessSDFShape003, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, ProcessSDFShape004, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    EXPECT_NE(unionNode->GetContext().lock(), nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, QuickPrepare001, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, ResetUnionChildren, TestSize.Level1)
{
    auto sContext = std::make_shared<RSContext>();
    auto unionNode = std::make_shared<RSUnionRenderNode>(id, sContext);
    NodeId childId = 1;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, FindClosestUnionAncestor001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, FindClosestUnionAncestor002, TestSize.Level1)
{
    std::shared_ptr<RSRenderNode> node = std::make_shared<RSRenderNode>(0);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, ProcessUnionInfoAfterApplyModifiers001, TestSize.Level1)
{
    std::shared_ptr<RSRenderNode> node = std::make_shared<RSRenderNode>(0);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, ProcessUnionInfoOnTreeStateChanged003, TestSize.Level1)
{
    std::shared_ptr<RSRenderNode> node = std::make_shared<RSRenderNode>(0);
    std::shared_ptr<RSRenderNode> parent = std::make_shared<RSRenderNode>(1);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSUnionRenderNodeUtilTest, ProcessUnionInfoAfterApplyModifiers003, TestSize.Level1)
{
    std::shared_ptr<RSRenderNode> node = std::make_shared<RSRenderNode>(0);
    std::shared_ptr<RSRenderNode> parent = std::make_shared<RSRenderNode>(1);
    std::shared_ptr<RSUnionRenderNode> unionNode = std::make_shared<RSUnionRenderNode>(2);
