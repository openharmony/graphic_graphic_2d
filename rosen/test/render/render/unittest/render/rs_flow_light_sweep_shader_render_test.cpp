...
namespace OHOS {
namespace Rosen {
class RSFlowLightSweepShaderRenderTest : public testing::Test {
public:
...
void RSFlowLightSweepShaderRenderTest::SetUpTestCase() {}
void RSFlowLightSweepShaderRenderTest::TearDownTestCase() {}
void RSFlowLightSweepShaderRenderTest::SetUp() {}
void RSFlowLightSweepShaderRenderTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RSFlowLightSweepShaderRenderTest, MakeDrawingShaderTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSFlowLightSweepShaderRenderTest, GetDrawingShaderTest01, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSFlowLightSweepShaderRenderTest, MarshallingTest, TestSize.Level1)
{
    std::vector<std::pair<Drawing::Color, float>> para;
    para.push_back(std::pair(Drawing::Color::COLOR_RED, 0.0f));
    para.push_back(std::pair(Drawing::Color::COLOR_GREEN, 0.5f));
 ...
 * @tc.require:
 */
HWTEST_F(RSFlowLightSweepShaderRenderTest, UnmarshallingTest, TestSize.Level1)
{
    std::vector<std::pair<Drawing::Color, float>> para;
    para.push_back(std::pair(Drawing::Color::COLOR_RED, 0.0f));
    para.push_back(std::pair(Drawing::Color::COLOR_GREEN, 0.5f));
