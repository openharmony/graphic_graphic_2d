...
namespace OHOS {
namespace Rosen {
class RSPropertiesPainterUtilTest : public testing::Test {
public:
...
void RSPropertiesPainterUtilTest::SetUpTestCase() {}
void RSPropertiesPainterUtilTest::TearDownTestCase() {}
void RSPropertiesPainterUtilTest::SetUp() {}
void RSPropertiesPainterUtilTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, Rect2DrawingRect001, TestSize.Level1)
{
    RectF rect;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, RRect2DrawingRRect001, TestSize.Level1)
{
    RRect rrect;
 ...
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetGravityMatrix001, TestSize.Level1)
{
    RectF rect;
    float w = 0.1;
    float h = 0.1;
 ...
 * @tc.require: issueI9W24N
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetGravityMatrix002, TestSize.Level1)
{
    RectF rect;
    float w = 0.1;
    float h = 0.1;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetScalingModeMatrix001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, Clip001, TestSize.Level1)
{
 ...
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetShadowDirtyRect001, TestSize.Level1)
{
    RectI dirtyShadow;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetShadowDirtyRect002, TestSize.Level1)
{
    RectI dirtyShadow;
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetShadowDirtyRect003, TestSize.Level1)
{
    RectI dirtyShadow;
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetShadowDirtyRect004, TestSize.Level1)
{
    RectI dirtyShadow;
    RSProperties properties;
    properties.SetShadowRadius(10.f);
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetShadowDirtyRect005, TestSize.Level1)
{
    RectI dirtyShadow;
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetShadowDirtyRect006, TestSize.Level1)
{
    RectI dirtyShadow;
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawShadow001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawShadow002, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawShadow003, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawShadow004, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawShadow005, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawShadow006, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawShadow007, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
    RSProperties properties;
 ...
 * @tc.require: issueI9RBVH
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawShadow008, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
    RSProperties properties;
 ...
 * @tc.require: issueI9W24N
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetForegroundEffectDirtyRect001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetForegroundEffectDirtyRect002, TestSize.Level1)
{
    RectI dirtyForegroundEffect;
    RSProperties properties;
    RSPropertiesPainter::GetForegroundEffectDirtyRect(dirtyForegroundEffect, properties);
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawColorfulShadowInner001, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawShadowInner001, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, MakeGreyAdjustmentEffect001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawGreyAdjustment001, TestSize.Level1)
{
    Drawing::Canvas canvas;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawFilter001, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawFilter002, TestSize.Level1)
{
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
    std::shared_ptr<RSFilter> rsFilter = RSFilter::CreateBlurFilter(1.f, 1.f);
 ...
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawFilter004, TestSize.Level1)
{
    RSProperties properties;
 ...
 * @tc.require: issueI9RBVH
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetPixelStretchDirtyRect001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, CalcAverageColor001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, SetBgAntiAlias001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetBgAntiAlias001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetInnerRRectForDrawingBorder001, TestSize.Level1)
{
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetOutlineDirtyRect001, TestSize.Level1)
{
    RSProperties properties;
    RectI dirtyOutline;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, IsDangerousBlendMode001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawLinearGradientBlurFilter001, TestSize.Level1)
{
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawFrame001, TestSize.Level1)
{
    RSProperties properties;
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawBackground001, TestSize.Level1)
{
    RSProperties properties;
    Drawing::Canvas drawingCanvas;
    RSPaintFilterCanvas canvas(&drawingCanvas);
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawFrame002, TestSize.Level1)
{
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawBorder001, TestSize.Level1)
{
    RSProperties properties;
    Drawing::Canvas canvas;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawMask001, TestSize.Level1)
{
    RSProperties properties;
    int32_t w = 1;
    int32_t h = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawMask004, TestSize.Level1)
{
    RSProperties properties;
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawMask002, TestSize.Level1)
{
    RSProperties properties;
    auto mask = std::make_shared<RSMask>();
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertiesPainterUtilTest, DrawMask003, TestSize.Level1)
{
    RSProperties properties;
    auto mask = std::make_shared<RSMask>();
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSPropertiesPainterUtilTest, GetDistortionEffectDirtyRect, TestSize.Level1)
{
