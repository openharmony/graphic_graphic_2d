...
class RSColorPickerRenderTest : public testing::Test {
public:
...
void RSColorPickerRenderTest::SetUpTestCase() {}
void RSColorPickerRenderTest::TearDownTestCase() {}
void RSColorPickerRenderTest::SetUp()
{
    picker = std::make_shared<RSColorPicker>(pixmap);
}
void RSColorPickerRenderTest::TearDown()
{
    picker.reset();
}
 ...
 * @tc.require:
 */
HWTEST_F(RSColorPickerRenderTest, CreateColorPickerTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorPickerRenderTest, CreateColorPickerTest002, TestSize.Level1)
{
    uint32_t errorCode = 0;
 ...
 * @tc.require:
 */
HWTEST_F(RSColorPickerRenderTest, GetLargestProportionColorTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorPickerRenderTest, GetHighestSaturationColorTest, TestSize.Level1)
{
    Drawing::ColorQuad color;
    // for test
 ...
 * @tc.require:
 */
HWTEST_F(RSColorPickerRenderTest, GetAverageColorTest, TestSize.Level1)
{
    Drawing::ColorQuad color;
 ...
 * @tc.require:
 */
HWTEST_F(RSColorPickerRenderTest, IsBlackOrWhiteOrGrayColorTest, TestSize.Level1)
{
    // for test
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSColorPickerRenderTest, IsBlackOrWhiteOrGrayColorTest001, TestSize.Level1)
{
    // for test
 ...
 * @tc.require:
 */
HWTEST_F(RSColorPickerRenderTest, IsEqualsTest, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSColorPickerRenderTest, IsEqualsTest002, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorPickerRenderTest, RGB2HSVTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorPickerRenderTest, AdjustHSVToDefinedItervalTest, TestSize.Level1)
{
    HSV hsv;
    // for test
    hsv.h = 361;
 ...
 * @tc.require:
 */
HWTEST_F(RSColorPickerRenderTest, HSVtoRGBTest, TestSize.Level1)
{
    HSV hsv;
    hsv.h = -1;
    hsv.s = -1;
