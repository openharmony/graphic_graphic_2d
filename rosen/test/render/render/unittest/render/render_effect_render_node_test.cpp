...
class RenderEffectRenderNodeTest : public testing::Test {
public:
...
void RenderEffectRenderNodeTest::SetUpTestCase() {}
void RenderEffectRenderNodeTest::TearDownTestCase() {}
void RenderEffectRenderNodeTest::SetUp() {}
void RenderEffectRenderNodeTest::TearDown() {}
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, Process, TestSize.Level1)
{
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, Prepare, TestSize.Level1)
{
    std::shared_ptr<RSNodeVisitor> visitor = nullptr;
    NodeId nodeId = 0;
    std::weak_ptr<RSContext> context;
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, ProcessRenderBeforeChildren, TestSize.Level1)
{
    NodeId nodeId = 0;
    std::weak_ptr<RSContext> context;
    RSEffectRenderNode rsEffectRenderNode(nodeId, context);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, GetFilterRect, TestSize.Level1)
{
    NodeId nodeId = 0;
    std::weak_ptr<RSContext> context;
    RSEffectRenderNode rsEffectRenderNode(nodeId, context);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, SetEffectRegion, TestSize.Level1)
{
    NodeId nodeId = 0;
    std::weak_ptr<RSContext> context;
    RSEffectRenderNode rsEffectRenderNode(nodeId, context);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, UpdateFilterCacheWithSelfDirtyTest001, TestSize.Level1)
{
    NodeId nodeId = 0;
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, CheckBlurFilterCacheNeedForceClearOrSaveTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RenderEffectRenderNodeTest, UpdateFilterCacheWithSelfDirtyTest002, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, MarkFilterCacheFlagsWithForceClearFilterCache, TestSize.Level1)
{
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, MarkFilterCacheFlagsTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, MarkFilterHasEffectChildrenTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, MarkClearFilterCacheIfEffectChildrenChangedTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, OnFilterCacheStateChangedTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
    auto filterDrawable = std::make_shared<DrawableV2::RSMaterialFilterDrawable>();
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, UpdateFilterCacheWithBelowDirty, TestSize.Level1)
{
    NodeId nodeId = 0;
    std::weak_ptr<RSContext> context;
    RSEffectRenderNode rsEffectRenderNode(nodeId, context);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, SetEffectIntersectWithDRM001, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, QuickPrepareTest, TestSize.Level1)
{
    NodeId id = 1;
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, SetDarkColorMode001, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, SetEffectIntersectWithDRMTest001, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
    rsEffectRenderNode.SetEffectIntersectWithDRM(true);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, ForceClearForegroundFilterCacheWhenDirty, TestSize.Level1)
{
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, SetDarkColorModeTest001, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
    rsEffectRenderNode.SetDarkColorMode(true);
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, UpdateChildHasVisibleEffectWithoutEmptyRect001, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
    rsEffectRenderNode.stagingRenderParams_ = std::make_unique<RSEffectRenderParams>(rsEffectRenderNode.GetId());
 ...
 * @tc.require: 22738
 */
HWTEST_F(RenderEffectRenderNodeTest, MarkFilterDebugEnabled001, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode rsEffectRenderNode(nodeId);
