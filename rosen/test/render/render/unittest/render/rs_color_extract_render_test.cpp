...
class RSColorExtractRenderTest : public testing::Test {
public:
...
void RSColorExtractRenderTest::SetUpTestCase() {}
void RSColorExtractRenderTest::TearDownTestCase() {}
void RSColorExtractRenderTest::SetUp()
{
    extract = std::make_shared<RSColorExtract>(pixmap);
}
void RSColorExtractRenderTest::TearDown()
{
    extract.reset();
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSColorExtractRenderTest, testInterface, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, QuantizedRedTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, QuantizedGreenTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, QuantizedBlueTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, ModifyWordWidthTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, GetARGB32ColorRTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, GetARGB32ColorGTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, GetARGB32ColorBTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, QuantizeFromRGB888Test, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, ApproximateToRGB888Test, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, ApproximateToRGB888Test002, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, QuantizePixelsTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, SplitBoxesTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, cmpTest, TestSize.Level1)
{
    // for test
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, GenerateAverageColorsTest, TestSize.Level1)
{
    std::priority_queue<RSColorExtract::VBox, std::vector<RSColorExtract::VBox>, std::less<RSColorExtract::VBox>>
        colorVBoxPriorityQueue;
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, SetFeatureColorNumTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, Rgb2GrayTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, CalcGrayMsdTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, NormalizeRgbTest, TestSize.Level1)
{
    // for test
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, CalcRelativeLumTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, CalcContrastToWhiteTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSColorExtractRenderTest, GetNFeatureColorsTest, TestSize.Level1)
{
