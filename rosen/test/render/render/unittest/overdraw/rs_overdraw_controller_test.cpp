...
class RSOverdrawControllerUnitTest : public testing::Test {
public:
...
void RSOverdrawControllerUnitTest::SetUpTestCase() {}
void RSOverdrawControllerUnitTest::TearDownTestCase() {}
void RSOverdrawControllerUnitTest::SetUp() {}
void RSOverdrawControllerUnitTest::TearDown() {}
...
class RSDelegateUnitTest : public RSDelegate {
public:
    void Repaint()
    {
        return;
...
/**
 * @tc.name: TestSingleton
 * @tc.desc: Singleton Test
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSOverdrawControllerUnitTest, TestSingleton, Function | SmallTest | Level0)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSOverdrawControllerUnitTest, TestEnable, Function | SmallTest | Level0)
{
    PART("CaseDescription") {
        bool e = false;
...
/**
 * @tc.name: TestCreateListenerDisable
 * @tc.desc: CreateListenerDisable Test
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSOverdrawControllerUnitTest, TestCreateListenerDisable, Function | SmallTest | Level2)
{
...
/**
 * @tc.name: TestCreateListenerEnable
 * @tc.desc: CreateListenerEnable Test
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSOverdrawControllerUnitTest, TestCreateListenerEnable, Function | SmallTest | Level2)
{
    auto &controller = RSOverdrawController::GetInstance();
    PART("EnvConditions") {
...
/**
 * @tc.name: TestOnColorChange001
 * @tc.desc: OnColorChange Test
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSOverdrawControllerUnitTest, TestOnColorChange001, TestSize.Level1)
{
    auto& controller = RSOverdrawController::GetInstance();
    controller.SetEnable(false);
...
/**
 * @tc.name: TestSwitchFunction002
 * @tc.desc: SwitchFunctio Test
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSOverdrawControllerUnitTest, TestSwitchFunction002, TestSize.Level1)
{
    auto& controller = RSOverdrawController::GetInstance();
    controller.SetEnable(true);
    EXPECT_TRUE(controller.IsEnabled());

    std::shared_ptr<RSDelegateUnitTest> delegate = std::make_shared<RSDelegateUnitTest>();
