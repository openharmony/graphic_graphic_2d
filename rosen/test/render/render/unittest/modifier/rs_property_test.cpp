 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSPropertyTest, PropertyIPC001, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSPropertyTest, PropertyIPC002, TestSize.Level1)
{
    std::vector<std::shared_ptr<RSRenderPropertyBase>> props;
 ...
 */
HWTEST_F(RSPropertyTest, OnChange, TestSize.Level1)
{
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSPropertyTest, IsNearEqual, TestSize.Level1)
{
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSPropertyTest, OnChange001, TestSize.Level1)
{
    std::shared_ptr<RSRenderPropertyBase> base = std::make_shared<RSRenderPropertyBase>();
    Parcel parcel;
    std::vector<std::shared_ptr<RSRenderPropertyBase>> props;
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSPropertyTest, OnChange002, TestSize.Level1)
{
    std::shared_ptr<RSRenderPropertyBase> base = std::make_shared<RSRenderPropertyBase>();
    Parcel parcel;
    std::vector<std::shared_ptr<RSRenderPropertyBase>> props;
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSPropertyTest, PropertyOp002, TestSize.Level1)
{
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSPropertyTest, IsNearEqual001, TestSize.Level1)
{
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSPropertyTest, IsNearEqual002, TestSize.Level1)
{
    RSRenderAnimatableProperty<float> property1;
    Vector2f vector2f;
