...
class RSCallbackStubSurfaceBufferMock : public RSSurfaceBufferCallbackStub {
public:
    RSCallbackStubSurfaceBufferMock() = default;
    virtual ~RSCallbackStubSurfaceBufferMock() = default;
...
HWTEST_F(RSSurfaceBufferCallbackStubTest, OnRemoteRequest002, TestSize.Level1)
{
    ...
    auto rSCallbackStubSurfaceBufferMock = std::make_shared<RSCallbackStubSurfaceBufferMock>();
    ...
    int res = rSCallbackStubSurfaceBufferMock->OnRemoteRequest(code, data, reply, option);
...
HWTEST_F(RSSurfaceBufferCallbackStubTest, OnRemoteRequest001, TestSize.Level1)
{
    ...
    res = rSCallbackStubSurfaceBufferMock->OnRemoteRequest(code, data, reply, option);
    EXPECT_TRUE(res == ERR_INVALID_STATE);
}
} // namespace OHOS::Rosen
