...
class RSSurfaceCallbackProxyBufferTest : public testing::Test {
public:
...
void RSSurfaceCallbackProxyBufferTest::SetUpTestCase() {}
void RSSurfaceCallbackProxyBufferTest::TearDownTestCase() {}
void RSSurfaceCallbackProxyBufferTest::SetUp() {}
void RSSurfaceCallbackProxyBufferTest::TearDown() {}
 ...
 */
HWTEST_F(RSSurfaceCallbackProxyBufferTest, OnFinish002, TestSize.Level1)
{
 ...
 * @tc.require: issueIB2AHG
 */
HWTEST_F(RSSurfaceCallbackProxyBufferTest, OnFinish001, TestSize.Level1)
{
    sptr<MockIRemoteObject> remoteMocker = new MockIRemoteObject();
    ASSERT_TRUE(remoteMocker != nullptr);
    auto rsSurfaceBufferCallbackProxy = std::make_shared<RSSurfaceBufferCallbackProxy>(remoteMocker);
