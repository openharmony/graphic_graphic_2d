...
class RSSurfaceCallbackStubOcclusionChangeMock : public RSSurfaceOcclusionChangeCallbackStub {
public:
    RSSurfaceCallbackStubOcclusionChangeMock() = default;
    virtual ~RSSurfaceCallbackStubOcclusionChangeMock() = default;
...
private:
    static sptr<RSSurfaceCallbackStubOcclusionChangeMock> stub;
};

sptr<RSSurfaceCallbackStubOcclusionChangeMock> RSSurfaceOcclusionChangeCallbackStubTest::stub =
    new RSSurfaceCallbackStubOcclusionChangeMock();
