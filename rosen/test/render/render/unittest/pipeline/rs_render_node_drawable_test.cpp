 ...
 */
HWTEST(RSRenderNodeDrawableTest, OnGenerateTest, TestSize.Level1)
{
    NodeId id = 0;
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, GetDrawableByIdTest, TestSize.Level1)
{
    NodeId id = 1;
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, OnGenerateShadowDrawableTest, TestSize.Level1)
{
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, DumpDrawableTreeTest, TestSize.Level1)
{
    NodeId id = 3;
    int32_t depth = 3;
    std::string out;
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, GetRenderParamsAndGetUifirstRenderParamsTest, TestSize.Level1)
{
    NodeId id = 4;
    auto node = std::make_shared<RSRenderNode>(id);
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, DumpDrawableVecTest, TestSize.Level1)
{
    NodeId id = 5;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(node);
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, QuickRejectTest, TestSize.Level1)
{
    NodeId id = 6;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, HasFilterOrEffectTest, TestSize.Level1)
{
    NodeId id = 7;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, DrawRangeImplAndRelatedTest, TestSize.Level1)
{
    NodeId id = 8;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, DrawUifirstContentChildrenTest, TestSize.Level1)
{
    NodeId id = 9;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, DrawContentTest, TestSize.Level1)
{
    NodeId id = 10;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, DrawChildrenTest, TestSize.Level1)
{
    NodeId id = 11;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, DrawImplTest, TestSize.Level1)
{
    NodeId id = 12;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, InitRenderParamsTest, TestSize.Level1)
{
    NodeId id = 13;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter =
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, GetSkipIndexTest, TestSize.Level1)
{
    NodeId id = 14;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableTest, DrawBackgroundWithoutFilterAndEffectTest, TestSize.Level1)
{
    NodeId id = 15;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 */
HWTEST(RSRenderNodeDrawableTest, IsFilterCacheValidForOcclusionTest, TestSize.Level1)
{
    NodeId id = 18;
    auto node = std::make_shared<RSRenderNode>(id);
 ...
 * @tc.require: issueIALKED
 */
HWTEST(RSRenderNodeDrawableTest, GetFilterCachedRegionTest, TestSize.Level1)
{
    NodeId id = 19;
    auto node = std::make_shared<RSRenderNode>(id);
    std::shared_ptr<DrawableV2::RSRenderNodeDrawableAdapter> adapter =
