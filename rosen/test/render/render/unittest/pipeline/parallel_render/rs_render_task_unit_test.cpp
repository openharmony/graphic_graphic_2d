...
class RSRenderTaskUnitTest : public testing::Test {
public:
...
void RSRenderTaskUnitTest::SetUpTestCase() {}
void RSRenderTaskUnitTest::TearDownTestCase() {}
void RSRenderTaskUnitTest::SetUp()
{
...
void RSRenderTaskUnitTest::TearDown()
{
    renderTask_ = nullptr;
 ...
 */
HWTEST_F(RSRenderTaskUnitTest, IndexTest01, TestSize.Level1)
{
    uint64_t setIdx = 10;
 ...
 * @tc.require: issueI69JAV
 */
HWTEST_F(RSRenderTaskUnitTest, CreateRenderTaskTest01, TestSize.Level1)
{
 ...
 * @tc.require: issueI69JAV
 */
HWTEST_F(RSRenderTaskUnitTest, AddTaskTest01, TestSize.Level1)
{
 ...
 * @tc.require: issueI69JAV
 */
HWTEST_F(RSRenderTaskUnitTest, GetSurfaceNode01, TestSize.Level1)
{
 ...
 * @tc.require: issueI69JAV
 */
HWTEST_F(RSRenderTaskUnitTest, GetNextRenderTask01, TestSize.Level1)
{
    auto renderTask = std::make_unique<RSRenderTask>(*rsSurfRenderNode_, RSRenderTask::RenderNodeStage::PREPARE);
    renderTask->SetIdx(0);
    supRenderTask_->AddTask(std::move(renderTask));
 ...
 * @tc.require: issueI69JAV
 */
HWTEST_F(RSRenderTaskUnitTest, GetSurfaceNodeEmpty01, TestSize.Level1)
{
    auto surfaceNode = supRenderTask_->GetSurfaceNode();
 ...
 * @tc.require: issueI69JAV
 */
HWTEST_F(RSRenderTaskUnitTest, GetNextRenderTaskEmpty01, TestSize.Level1)
{
    auto task = supRenderTask_->GetNextRenderTask();
 ...
 */
HWTEST_F(RSRenderTaskUnitTest, RSCompositionTask01, TestSize.Level1)
{
    auto rsContext = std::make_shared<RSContext>();
