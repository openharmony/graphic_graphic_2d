...
class RSComposerAdapterExtTest : public testing::Test {
public:
...
uint32_t RSComposerAdapterExtTest::screenId_ = 0;

void RSComposerAdapterExtTest::SetUpTestCase()
{
...
void RSComposerAdapterExtTest::TearDownTestCase()
{
    hdiOutput_ = nullptr;
    rsScreen_ = nullptr;
...
void RSComposerAdapterExtTest::SetUp() {}
void RSComposerAdapterExtTest::TearDown() {}

void RSComposerAdapterExtTest::CreateComposerAdapterWithScreenInfo(uint32_t width, uint32_t height,
...
/**
 * @tc.name: CommitLayersExtTest001
 * @tc.desc: commitLayer when csurface is nullptr
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CommitLayersExtTest001, Function | SmallTest | Level2)
{
...
/**
 * @tc.name: CommitLayersExtTest002
 * @tc.desc: commitTunnelLayer when csurface is nullptr
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CommitLayersExtTest002, Function | SmallTest | Level2)
{
    CreateComposerAdapterWithScreenInfo(2160, 1080, ScreenColorGamut::COLOR_GAMUT_SRGB, ScreenState::UNKNOWN,
        ScreenRotation::ROTATION_0);
    composerAdapter_->SetHdiBackendDevice(hdiDeviceMock_);
...
/**
 * @tc.name: CommitLayersExtTest003
 * @tc.desc: commitLayer when csurface is nullptr
 * @tc.type: FUNC
 * @tc.require: issueI794H6
 */
HWTEST_F(RSComposerAdapterExtTest, CommitLayersExtTest003, Function | SmallTest | Level2)
{
    CreateComposerAdapterWithScreenInfo(2160, 1080, ScreenColorGamut::COLOR_GAMUT_SRGB, ScreenState::UNKNOWN,
        ScreenRotation::ROTATION_0);
    composerAdapter_->SetHdiBackendDevice(hdiDeviceMock_);
...
/**
 * @tc.name: LayerPresentTimestampExt001
 * @tc.desc: RSComposerAdapter.LayerPresentTimestamp test, not SupportedPresentTimestamp
 * @tc.type: FUNC
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSComposerAdapterExtTest, LayerPresentTimestampExt001, Function | SmallTest | Level2)
{
    uint32_t width = 2160;
...
/**
 * @tc.name: LayerPresentTimestampExt002
 * @tc.desc: RSComposerAdapter.LayerPresentTimestamp test, SupportedPresentTimestamp
 * @tc.type: FUNC
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSComposerAdapterExtTest, LayerPresentTimestampExt002, Function | SmallTest | Level2)
{
    uint32_t width = 2160;
    uint32_t height = 1080;
    CreateComposerAdapterWithScreenInfo(
...
/**
 * @tc.name: LayerPresentTimestampExt003
 * @tc.desc: RSComposerAdapter.LayerPresentTimestamp test with null buffer
 * @tc.type: FUNC
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSComposerAdapterExtTest, LayerPresentTimestampExt003, Function | SmallTest | Level2)
{
    uint32_t width = 2160;
    uint32_t height = 1080;
    CreateComposerAdapterWithScreenInfo(
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSComposerAdapterExtTest, OnPrepareComplete, Function | SmallTest | Level2)
{
    uint32_t width = 2160;
    uint32_t height = 1080;
    CreateComposerAdapterWithScreenInfo(
...
/**
 * @tc.name: CreateLayersExtTest001
 * @tc.desc: CreateLayers when surfaceNode has valid buffer
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayersExtTest001, Function | SmallTest | Level2)
{
    auto surfaceNode1 = RSTestUtil::CreateSurfaceNodeWithBuffer();
...
/**
 * @tc.name: CreateLayersExtTest002
 * @tc.desc: CreateLayers when surfaceNode is out of screen region
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayersExtTest002, Function | SmallTest | Level2)
{
    std::vector<std::shared_ptr<HdiLayerInfo>> layers;
    auto surfaceNode1 = RSTestUtil::CreateSurfaceNodeWithBuffer();
    auto surfaceNode2 = RSTestUtil::CreateSurfaceNode();
...
/**
 * @tc.name: CreateLayersExtTest003
 * @tc.desc: CreateLayers with screen rotation
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayersExtTest003, Function | SmallTest | Level2)
{
    std::vector<std::shared_ptr<HdiLayerInfo>> layers;
    auto surfaceNode1 = RSTestUtil::CreateSurfaceNodeWithBuffer();
    RectI dstRect{0, 0, 400, 600};
...
/**
 * @tc.name: CreateLayersExtTest004
 * @tc.desc: CreateLayers with screen rotation
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayersExtTest004, Function | SmallTest | Level2)
{
    std::vector<std::shared_ptr<HdiLayerInfo>> layers;
    auto surfaceNode1 = RSTestUtil::CreateSurfaceNodeWithBuffer();
    RectI dstRect{0, 0, 400, 600};
...
/**
 * @tc.name: CreateLayersExtTest005
 * @tc.desc: CreateLayers with screen rotation
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayersExtTest005, Function | SmallTest | Level2)
{
    std::vector<std::shared_ptr<HdiLayerInfo>> layers;
    auto surfaceNode1 = RSTestUtil::CreateSurfaceNodeWithBuffer();
    RectI dstRect{0, 0, 400, 600};
...
/**
 * @tc.name: CreateLayersExtTest006
 * @tc.desc: CreateLayers with screen rotation and scale
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayersExtTest006, Function | SmallTest | Level2)
{
    std::vector<std::shared_ptr<HdiLayerInfo>> layers;
    auto surfaceNode1 = RSTestUtil::CreateSurfaceNodeWithBuffer();
...
/**
 * @tc.name: CreateLayersExtTest007
 * @tc.desc: CreateLayers when surfaceNode has metadate
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayersExtTest007, Function | SmallTest | Level2)
{
    std::vector<std::shared_ptr<HdiLayerInfo>> layers;
    auto surfaceNode1 = RSTestUtil::CreateSurfaceNodeWithBuffer();
    RectI dstRect{0, 0, 400, 600};
...
/**
 * @tc.name: CreateLayersExtTest008
 * @tc.desc: CreateLayers when surfaceNode has gravity
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayersExtTest008, Function | SmallTest | Level2)
{
    std::vector<std::shared_ptr<HdiLayerInfo>> layers;
    auto surfaceNode1 = RSTestUtil::CreateSurfaceNodeWithBuffer();
    RectI dstRect{0, 0, 400, 600};
...
/**
 * @tc.name: CreateLayersExtTest009
 * @tc.desc: CreateLayers when surfacenode has scaling mode
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayersExtTest009, Function | SmallTest | Level2)
{
    std::vector<std::shared_ptr<HdiLayerInfo>> layers;
    auto surfaceNode1 = RSTestUtil::CreateSurfaceNodeWithBuffer();
...
/**
 * @tc.name: CreateLayersExtTest010
 * @tc.desc: CreateLayers (DisplayNode)
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayersExtTest010, Function | SmallTest | Level2)
{
    uint32_t width = 2160;
    uint32_t height = 1080;
    CreateComposerAdapterWithScreenInfo(
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSComposerAdapterExtTest, CreateLayer, Function | SmallTest | Level2)
{
    uint32_t width = 2160;
    uint32_t height = 1080;
    CreateComposerAdapterWithScreenInfo(
