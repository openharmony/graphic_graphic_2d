...
class RSUniUiCaptureTaskTest : public testing::Test {
public:
...
void RSUniUiCaptureTaskTest::SetUpTestCase()
{
    RSTestUtil::InitRenderNodeGC();
}
void RSUniUiCaptureTaskTest::TearDownTestCase() {}
void RSUniUiCaptureTaskTest::SetUp() {}
void RSUniUiCaptureTaskTest::TearDown() {}
 ...
 * @tc.author:
 */
HWTEST_F(RSUniUiCaptureTaskTest, TakeLocalCapture001, TestSize.Level1)
{
    NodeId nodeId = 0;
 ...
 */
HWTEST_F(RSUniUiCaptureTaskTest, SetCanvasTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.author:
 */
HWTEST_F(RSUniUiCaptureTaskTest, ProcessRootRenderNodeTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.author:
 */
HWTEST_F(RSUniUiCaptureTaskTest, ProcessCanvasRenderNodeTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.author:
 */
HWTEST_F(RSUniUiCaptureTaskTest, ProcessSurfaceRenderNodeTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.require:
 */
HWTEST_F(RSUniUiCaptureTaskTest, ProcessEffectRenderNode001, TestSize.Level1)
{
    NodeId nodeId = 0;
 ...
 * @tc.require:
 */
HWTEST_F(RSUniUiCaptureTaskTest, PrepareCanvasRenderNodeTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.require:
 */
HWTEST_F(RSUniUiCaptureTaskTest, PrepareSurfaceRenderNodeTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.require:
 */
HWTEST_F(RSUniUiCaptureTaskTest, PrepareRootRenderNodeTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.require:
 */
HWTEST_F(RSUniUiCaptureTaskTest, PrepareEffectRenderNodeTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSEffectRenderNode node(nodeId);
    RSSurfaceCaptureConfig captureConfig;
 ...
 * @tc.author:
 */
HWTEST_F(RSUniUiCaptureTaskTest, CreateSurface, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.author:
 */
HWTEST_F(RSUniUiCaptureTaskTest, PostTaskToRSRecord, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.author:
 */
HWTEST_F(RSUniUiCaptureTaskTest, SetPaintFilterCanvas, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.author:
 */
HWTEST_F(RSUniUiCaptureTaskTest, ProcessRootRenderNode, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
 ...
 * @tc.require: issueIATLPV
 */
HWTEST_F(RSUniUiCaptureTaskTest, ProcessSurfaceRenderNodeWithUni, TestSize.Level1)
{
    NodeId nodeId = 0;
    RSSurfaceCaptureConfig captureConfig;
    captureConfig.scaleX = 0.0;
