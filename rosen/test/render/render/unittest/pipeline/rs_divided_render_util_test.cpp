...
class RsDividedRenderTest : public testing::Test {
public:
...
void RsDividedRenderTest::SetUpTestCase()
{
    RSTestUtil::InitRenderNodeGC();
}
void RsDividedRenderTest::TearDownTestCase() {}
void RsDividedRenderTest::SetUp() {}
void RsDividedRenderTest::TearDown() {}

/*
 * @tc.name: CreateBufferDrawParam01
 * @tc.desc: Test CreateBufferDrawParam
 * @tc.type: FUNC
 * @tc.require: issueI6QM6E
 */
HWTEST_F(RsDividedRenderTest, CreateBufferDrawParam01, TestSize.Level1)
{
...
/*
 * @tc.name: CreateBufferDrawParam02
 * @tc.desc: Test CreateBufferDrawParam
 * @tc.type: FUNC
 * @tc.require: issueI6QM6E
 */
HWTEST_F(RsDividedRenderTest, CreateBufferDrawParam02, TestSize.Level1)
{
    RSSurfaceRenderNodeConfig config;
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(config);
    node->InitRenderParams();
