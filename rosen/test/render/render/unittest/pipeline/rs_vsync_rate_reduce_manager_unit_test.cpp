...
class RSVsyncRateReduceManagerUnitTest : public testing::Test {
public:
...
void RSVsyncRateReduceManagerUnitTest::SetUpTestCase() {}
void RSVsyncRateReduceManagerUnitTest::TearDownTestCase() {}
void RSVsyncRateReduceManagerUnitTest::SetUp() {}
void RSVsyncRateReduceManagerUnitTest::TearDown() {}

/**
 * @tc.name: EnqueueFrameDurationTest001
 * @tc.desc: Test EnqueueFrameDuration, collect last 3 frames duration to estimate RT balance
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, EnqueueFrameDurationTest001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, InitTest001, TestSize.Level1)
{
...
/**
 * @tc.name: ResetFrameValuesTest001
 * @tc.desc: Test ResetFrameValues processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, ResetFrameValuesTest001, TestSize.Level1)
{
    RSVsyncRateReduceManager rateReduceManager;
    sptr<MockVSyncDistributor> vSyncDistributor = new MockVSyncDistributor();
...
/**
 * @tc.name: ResetFrameValuesTest002
 * @tc.desc: Test ResetFrameValues processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, ResetFrameValuesTest002, TestSize.Level1)
{
    RSVsyncRateReduceManager rateReduceManager;
    sptr<MockVSyncDistributor> vSyncDistributor = new MockVSyncDistributor();
    auto rsContext = std::make_shared<RSContext>();
...
/**
 * @tc.name: CollectSurfaceVsyncInfoTest001
 * @tc.desc: Test CollectSurfaceVsyncInfo processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, CollectSurfaceVsyncInfoTest001, TestSize.Level1)
{
    auto rsContext = std::make_shared<RSContext>();
    ASSERT_NE(rsContext, nullptr);
...
/**
 * @tc.name: CheckNeedNotifyTest001
 * @tc.desc: Test CheckNeedNotify processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, CheckNeedNotifyTest001, TestSize.Level1)
{
    RSVsyncRateReduceManager rateReduceManager;
    NodeId nodeId = 1;
    NodeId nodeId2 = 2;
...
/**
 * @tc.name: NotifyVRatesTest001
 * @tc.desc: Test NotifyVRates processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, NotifyVRatesTest001, TestSize.Level1)
{
    RSVsyncRateReduceManager rateReduceManager;
    sptr<MockVSyncDistributor> vSyncDistributor = new MockVSyncDistributor();
    rateReduceManager.appVSyncDistributor_ = vSyncDistributor;
...
/**
 * @tc.name: UpdateRatesLevelTest001
 * @tc.desc: Test UpdateRatesLevel processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, UpdateRatesLevelTest001, TestSize.Level1)
{
...
/**
 * @tc.name: CalcRatesTest001
 * @tc.desc: Test CalcRates processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, CalcRatesTest001, TestSize.Level1)
{
    RSVsyncRateReduceManager rateReduceManager;
...
/**
 * @tc.name: GetRateByBalanceLevelTest001
 * @tc.desc: Test GetRateByBalanceLevel processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, GetRateByBalanceLevelTest001, TestSize.Level1)
{
    RSVsyncRateReduceManager rateReduceManager;
    rateReduceManager.curRatesLevel_ = 1;
...
/**
 * @tc.name: CalcMaxVisibleRectTest001
 * @tc.desc: Test CalcMaxVisibleRect processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, CalcMaxVisibleRectTest001, TestSize.Level1)
{
...
/**
 * @tc.name: CalcVValByAreasTest001
 * @tc.desc: Test CalcVValByAreas processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, CalcVValByAreasTest001, TestSize.Level1)
{
    RSVsyncRateReduceManager rateReduceManager;
...
/**
 * @tc.name: SetFocusedNodeIdTest001
 * @tc.desc: Test SetFocusedNodeId processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, SetFocusedNodeIdTest001, TestSize.Level1)
{
    RSVsyncRateReduceManager rateReduceManager;
    rateReduceManager.vRateReduceEnabled_ = true;
...
/**
 * @tc.name: CollectSurfaceVsyncInfoTest002
 * @tc.desc: Test CollectSurfaceVsyncInfo processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, CollectSurfaceVsyncInfoTest002, TestSize.Level1)
{
    auto rsContext = std::make_shared<RSContext>();
    ASSERT_NE(rsContext, nullptr);
    RSSurfaceRenderNodeConfig config;
...
/**
 * @tc.name: CollectSurfaceVsyncInfoTest003
 * @tc.desc: Test CollectSurfaceVsyncInfo processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, CollectSurfaceVsyncInfoTest003, TestSize.Level1)
{
    auto rsContext = std::make_shared<RSContext>();
    ASSERT_NE(rsContext, nullptr);
    RSSurfaceRenderNodeConfig config;
...
/**
 * @tc.name: NotifyVSyncRatesTest001
 * @tc.desc: Test NotifyVSyncRates processing.
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSVsyncRateReduceManagerUnitTest, NotifyVSyncRatesTest001, TestSize.Level1)
{
    RSVsyncRateReduceManager rateReduceManager;
    sptr<MockVSyncDistributor> vSyncDistributor = new MockVSyncDistributor();
    rateReduceManager.appVSyncDistributor_ = vSyncDistributor;
