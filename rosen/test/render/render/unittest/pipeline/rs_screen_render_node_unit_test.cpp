...
class RSScreenRenderNodeUnitTest : public testing::Test {
public:
...
void RSScreenRenderNodeUnitTest::SetUpTestCase() {}
void RSScreenRenderNodeUnitTest::TearDownTestCase() {}
void RSScreenRenderNodeUnitTest::SetUp() {}
void RSScreenRenderNodeUnitTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, UpdateScreenRenderParams, TestSize.Level1)
{
    NodeId id = 0;
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, UpdatePartialRenderParams, TestSize.Level1)
{
    NodeId id = 0;
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, UpdateDisplayDirtyManager, TestSize.Level1)
{
    NodeId id = 0;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    int32_t bufferage = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, GetSortedChildren, TestSize.Level1)
{
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 */
HWTEST_F(RSScreenRenderNodeUnitTest, GetDisappearedSurfaceRegionBelowCurrent001, TestSize.Level1)
{
    NodeId id = 0;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 * @tc.require: issuesIA8LNR
 */
HWTEST_F(RSScreenRenderNodeUnitTest, GetDisappearedSurfaceRegionBelowCurrent002, TestSize.Level1)
{
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 */
HWTEST_F(RSScreenRenderNodeUnitTest, GetDisappearedSurfaceRegionBelowCurrent003, TestSize.Level1)
{
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 */
HWTEST_F(RSScreenRenderNodeUnitTest, RecordMainAndLeashSurfaces001, TestSize.Level2)
{
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.require: issueIANDBE
 */
HWTEST_F(RSScreenRenderNodeUnitTest, HandleCurMainAndLeashSurfaceNodes001, TestSize.Level2)
{
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    ASSERT_NE(screenNode, nullptr);
}
 ...
 * @tc.require: issueIANDBE
 */
HWTEST_F(RSScreenRenderNodeUnitTest, HandleCurMainAndLeashSurfaceNodes002, TestSize.Level2)
{
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.require: issueIANDBE
 */
HWTEST_F(RSScreenRenderNodeUnitTest, HandleCurMainAndLeashSurfaceNodes003, TestSize.Level2)
{
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    ASSERT_NE(screenNode, nullptr);
    auto surfaceNode = std::make_shared<RSSurfaceRenderNode>(id + 1, context);
 ...
 * @tc.require: issueIANDBE
 */
HWTEST_F(RSScreenRenderNodeUnitTest, HandleCurMainAndLeashSurfaceNodes004, TestSize.Level2)
{
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    ASSERT_NE(screenNode, nullptr);
    auto surfaceNode = std::make_shared<RSSurfaceRenderNode>(id + 1, context);
 ...
 * @tc.require: issueIANDBE
 */
HWTEST_F(RSScreenRenderNodeUnitTest, HandleCurMainAndLeashSurfaceNodes005, TestSize.Level2)
{
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    ASSERT_NE(screenNode, nullptr);
    auto surfaceNode = std::make_shared<RSSurfaceRenderNode>(id + 1, context);
 ...
 */
HWTEST_F(RSScreenRenderNodeUnitTest, ForceCloseHdrTest, TestSize.Level1)
{
 ...
 * @tc.require: issuesIB6QKS
 */
HWTEST_F(RSScreenRenderNodeUnitTest, HasUniRenderHdrSurfaceTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(node, nullptr);
    node->InitRenderParams();
 ...
 * @tc.require: issuesIB6QKS
 */
HWTEST_F(RSScreenRenderNodeUnitTest, IsLuminanceStatusChangeTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(node, nullptr);
    node->InitRenderParams();
 ...
 * @tc.require: issuesIB6QKS
 */
HWTEST_F(RSScreenRenderNodeUnitTest, GetColorSpaceTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 1, context);
    node->InitRenderParams();
 ...
 * @tc.require: issuesIB6QKS
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetColorSpaceTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 1, context);
    node->InitRenderParams();
 ...
 */
HWTEST_F(RSScreenRenderNodeUnitTest, UpdateColorSpaceTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 1, context);
    node->InitRenderParams();
 ...
 * @tc.require: issuesIB6QKS
 */
HWTEST_F(RSScreenRenderNodeUnitTest, PixelFormatTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 1, context);
    node->InitRenderParams();
 ...
 */
HWTEST_F(RSScreenRenderNodeUnitTest, GetTargetSurfaceRenderNodeId, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
 ...
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetForceFreeze, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSScreenRenderNodeUnitTest, CheckSurfaceChangedTest001, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSScreenRenderNodeUnitTest, CheckSurfaceChangedTest002, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSScreenRenderNodeUnitTest, CheckSurfaceChangedTest003, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSScreenRenderNodeUnitTest, CheckSurfaceChangedTest004, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSScreenRenderNodeUnitTest, CheckSurfaceChangedTest005, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
...
void RSScreenRenderNodeUnitTest::CheckWithStatusLevel(const RSScreenRenderNode::HeadroomMap &map,
...
void RSScreenRenderNodeUnitTest::CheckWithoutStatusLevel(const RSScreenRenderNode::HeadroomMap &map,
    HdrStatus status, uint32_t level)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSScreenRenderNodeUnitTest, GetHeadroomMap, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSScreenRenderNodeUnitTest, UpdateHeadroomMapIncrease, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSScreenRenderNodeUnitTest, UpdateHeadroomMapDecrease, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSScreenRenderNodeUnitTest, ResetVideoHeadroomInfo, TestSize.Level1)
{
    NodeId id = 1;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, 1, context);
    ASSERT_NE(screenNode, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetCloneNodeMapTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetLogicalCameraRotationCorrectionTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, PrepareTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SkipFrameTest001, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SkipFrameTest002, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SkipFrameTest003, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SkipFrameTest004, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SkipFrameTest005, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    uint32_t refreshRate = 60; // 60hz
    uint32_t skipFrameInterval = 2; // skipFrameInterval 2
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SkipFrameTest006, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SkipFrameTest007, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    uint32_t refreshRate = 60; // 60hz
    uint32_t skipFrameInterval = 6; // skipFrameInterval 6
 ...
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SkipFrameTest008, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require: issuesIAVK8D
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SkipFrameTest009, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require: issuesIAVK8D
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SkipFrameTest010, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, IsMirrorScreenTest001, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, IsMirrorScreenTest002, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetIsMirrorScreenTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
    EXPECT_NE(node, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetReleaseTaskTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
    EXPECT_NE(node, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, ResetMirrorSourceTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetDisplayGlobalZorderTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetNeedForceUpdateHwcNodesTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
    node->stagingRenderParams_ = std::make_unique<RSScreenRenderParams>(node->GetId());
    ASSERT_NE(node->stagingRenderParams_, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetFingerprintTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, FixVirtualBuffer10BitTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, ExistHWCNodeTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetHDRPresentTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, GetHDRPresentTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetBrightnessRatioTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, 0, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetColorSpaceTest002, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    node->stagingRenderParams_ = std::make_unique<RSScreenRenderParams>(node->GetId());
    ASSERT_NE(node->stagingRenderParams_, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetTargetSurfaceRenderNodeDrawableTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetHasMirrorScreenTest, TestSize.Level1)
{
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    node->stagingRenderParams_ = std::make_unique<RSScreenRenderParams>(node->GetId());
    ASSERT_NE(node->stagingRenderParams_, nullptr);
 ...
 * @tc.require:SR000HSUII
 */
HWTEST_F(RSScreenRenderNodeUnitTest, GetBootAnimationTest, TestSize.Level1)
{
    NodeId id = 0;
    auto node = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 */
HWTEST_F(RSScreenRenderNodeUnitTest, CollectSurface, TestSize.Level2)
{
    NodeId id = 0;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, ProcessTest, TestSize.Level1)
{
    std::shared_ptr<RSNodeVisitor> visitor = nullptr;
    NodeId id = 0;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetIsOnTheTree, TestSize.Level1)
{
    NodeId id = 0;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
    bool flag = true;
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetCompositeType, TestSize.Level1)
{
    NodeId id = 0;
    auto screenNode = std::make_shared<RSScreenRenderNode>(id, screenId, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, SetForceSoftComposite, TestSize.Level1)
{
    NodeId id = 0;
 ...
 * @tc.require:
 */
HWTEST_F(RSScreenRenderNodeUnitTest, UpdateRenderParams, TestSize.Level1)
{
    NodeId id = 0;
