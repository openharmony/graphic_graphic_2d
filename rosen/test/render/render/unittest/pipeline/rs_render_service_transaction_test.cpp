 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, SetRenderThreadClient001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, SetRenderThreadClient002, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, SetRenderServiceClient001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, SetRenderServiceClient002, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, FlushImplicitTransaction003, TestSize.Level1)
{
    uint64_t timestamp = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, FlushImplicitTransaction004, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, IsEmpty001, TestSize.Level1)
{
    auto rsTransactionProxy = RSTransactionProxy::GetInstance();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, FlushImplicitTransaction005, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, FlushImplicitTransaction006, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, FlushImplicitTransaction007, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, FlushImplicitTransactionFromRT001, TestSize.Level1)
{
    uint64_t timestamp = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, FlushImplicitTransactionFromRT002, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
    renderServiceClient.reset();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, FlushImplicitTransactionFromRT003, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
    ASSERT_NE(renderServiceClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, Commit001, TestSize.Level1)
{
    uint64_t timestamp = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, Commit002, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
    ASSERT_NE(renderServiceClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, Commit003, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
    renderServiceClient.reset();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, Commit004, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
    renderServiceClient.reset();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, CommitSyncTransaction001, TestSize.Level1)
{
    uint64_t timestamp = 1;
    RSTransactionProxy::GetInstance()->Begin();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, CommitSyncTransaction002, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, CommitSyncTransaction003, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, CommitSyncTransaction004, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, CommitSyncTransaction005, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, MarkTransactionNeedSync001, TestSize.Level1)
{
    auto rsTransactionProxy = RSTransactionProxy::GetInstance();
    ASSERT_NE(rsTransactionProxy, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, MarkTransactionNeedSync002, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, MarkTransactionNeedCloseSync001, TestSize.Level1)
{
    auto rsTransactionProxy = RSTransactionProxy::GetInstance();
    ASSERT_NE(rsTransactionProxy, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, MarkTransactionNeedCloseSync002, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, AddCommand001, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    renderThreadClient.reset();
    ASSERT_EQ(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, AddCommand002, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, AddCommand003, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, AddCommand004, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, AddCommand005, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, AddCommand006, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    renderThreadClient.reset();
    ASSERT_EQ(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, AddCommand007, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, AddCommandFromRT001, TestSize.Level1)
{
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
    renderServiceClient.reset();
    ASSERT_EQ(renderServiceClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, AddCommandFromRT002, TestSize.Level1)
{
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
    ASSERT_NE(renderServiceClient, nullptr);
    RSTransactionProxy::GetInstance()->SetRenderServiceClient(renderServiceClient);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, ExecuteSynchronousTask001, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
    RSTransactionProxy::GetInstance()->SetRenderThreadClient(renderThreadClient);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, ExecuteSynchronousTask002, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    renderThreadClient.reset();
    ASSERT_EQ(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, ExecuteSynchronousTask003, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    renderThreadClient.reset();
    ASSERT_EQ(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, ExecuteSynchronousTask004, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    renderThreadClient.reset();
    ASSERT_EQ(renderThreadClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, ExecuteSynchronousTask005, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, ExecuteSynchronousTask006, TestSize.Level1)
{
    auto renderThreadClient = CreateRenderThreadClient();
    ASSERT_NE(renderThreadClient, nullptr);
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, AddCommonCommandTest, TestSize.Level1)
{
    RSTransactionProxy::GetInstance()->Begin();
 ...
 */
HWTEST_F(RSTransactionTest, FlushImplicitTransactionFromRT004, TestSize.Level1)
{
    uint64_t timestamp = 1;
    auto renderServiceClient = std::make_shared<RSRenderServiceClient>();
    renderServiceClient.reset();
 ...
 * @tc.require:
 */
HWTEST_F(RSTransactionTest, StartCloseSyncTransactionFallbackTaskTest, TestSize.Level1)
{
