...
class RSUniRenderVirtualProcessorExtTest : public testing::Test {
public:
...
void RSUniRenderVirtualProcessorExtTest::SetUpTestCase() {}
void RSUniRenderVirtualProcessorExtTest::TearDownTestCase() {}
void RSUniRenderVirtualProcessorExtTest::SetUp()
{
...
void RSUniRenderVirtualProcessorExtTest::TearDown() {}
 ...
 * @tc.author:
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, CreateAndDestroy, TestSize.Level2)
{
 ...
 * @tc.author:
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, Init001, TestSize.Level2)
{
 ...
 * @tc.author:
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, ProcessSurface, TestSize.Level2)
{
 ...
 * @tc.author:
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, ProcessDisplaySurface, TestSize.Level2)
{
    RSDisplayNodeConfig config;
    NodeId id = 0;
    RSDisplayRenderNode rsDisplayRenderNode(id, config);
 ...
 * @tc.author:
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, PostProcess, TestSize.Level2)
{
    auto processor = RSProcessorFactory::CreateProcessor(RSDisplayRenderNode::CompositeType::
        UNI_RENDER_MIRROR_COMPOSITE);
 ...
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, CanvasInit_001, TestSize.Level2)
{
 ...
 * @tc.require:issuesIAJ4FW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, CanvasInit_002, TestSize.Level2)
{
 ...
 * @tc.require:issuesIAJ4FW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, GetBufferAge_001, TestSize.Level2)
{
 ...
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, OriginScreenRotation, TestSize.Level2)
{
    auto processor = RSProcessorFactory::CreateProcessor(RSDisplayRenderNode::CompositeType::
        UNI_RENDER_MIRROR_COMPOSITE);
 ...
 * @tc.require: issueI992VW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, Fill, TestSize.Level2)
{
    auto processor = RSProcessorFactory::CreateProcessor(RSDisplayRenderNode::CompositeType::
        UNI_RENDER_MIRROR_COMPOSITE);
    auto virtualProcessor = std::static_pointer_cast<RSUniRenderVirtualProcessor>(processor);
 ...
 * @tc.require: issueI992VW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, UniScale, TestSize.Level2)
{
    auto processor = RSProcessorFactory::CreateProcessor(RSDisplayRenderNode::CompositeType::
        UNI_RENDER_MIRROR_COMPOSITE);
    auto virtualProcessor = std::static_pointer_cast<RSUniRenderVirtualProcessor>(processor);
 ...
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, ProcessRcdSurfaceTest, TestSize.Level2)
{
 ...
 * @tc.require:issuesI9KRF1
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, ProcessDisplaySurfaceTest, TestSize.Level2)
{
    RSDisplayNodeConfig config;
    NodeId id = 0;
 ...
 * @tc.require:issuesIAJ4FW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, SetDirtyInfo_001, TestSize.Level2)
{
 ...
 * @tc.require:issuesIAJ4FW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, SetDirtyInfo_002, TestSize.Level2)
{
    virtualProcessor_->renderFrame_ = std::make_unique<RSRenderFrame>(nullptr, nullptr);
    ASSERT_NE(virtualProcessor_->renderFrame_, nullptr);
    std::vector<RectI> damageRegion {};
 ...
 * @tc.require:issuesIAJ4FW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, ProcessDisplaySurfaceForRenderThread_001, TestSize.Level2)
{
 ...
 * @tc.require:issuesIAJ4FW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, ProcessDisplaySurfaceForRenderThread_002, TestSize.Level2)
{
 ...
 * @tc.require:issuesIAJ4FW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, ProcessDisplaySurfaceForRenderThread_003, TestSize.Level2)
{
    virtualProcessor_->isExpand_ = false;
 ...
 * @tc.require:issuesIAJ4FW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, ProcessDisplaySurfaceForRenderThread_004, TestSize.Level2)
{
    virtualProcessor_->isExpand_ = false;
    virtualProcessor_->canvas_ = nullptr;
    auto surfaceHandler = displayDrawable_->GetRSSurfaceHandlerOnDraw();
 ...
 * @tc.require:issuesIAJ4FW
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, ProcessDisplaySurfaceForRenderThread_005, TestSize.Level2)
{
    virtualProcessor_->isExpand_ = false;
 ...
 */
HWTEST_F(RSUniRenderVirtualProcessorExtTest, CanvasClipRegion_001, TestSize.Level2)
{
    auto processor = RSProcessorFactory::CreateProcessor(RSDisplayRenderNode::CompositeType::
        UNI_RENDER_MIRROR_COMPOSITE);
    auto virtualProcessor = std::static_pointer_cast<RSUniRenderVirtualProcessor>(processor);
