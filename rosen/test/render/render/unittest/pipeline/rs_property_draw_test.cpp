...
namespace OHOS {
namespace Rosen {
class RSPropertyDrawTest : public testing::Test {
public:
...
void RSPropertyDrawTest::SetUpTestCase() {}
void RSPropertyDrawTest::TearDownTestCase() {}
void RSPropertyDrawTest::SetUp() {}
void RSPropertyDrawTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertyDrawTest, GenerateDirtySlots, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertyDrawTest, UpdateDrawableVec, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSPropertyDrawTest, UpdateSaveRestore001, TestSize.Level1)
{
    RSRenderContent content;
    RSPropertyDrawable::DrawableVec drawableVec;
    uint8_t status = 1;
 ...
 */
HWTEST_F(RSPropertyDrawTest, UpdateSaveRestore002, TestSize.Level1)
{
    RSRenderContent content;
    RSPropertyDrawable::DrawableVec drawableVec;
    uint8_t status = 1;
 ...
 * @tc.require: issueI9RBVH
 */
HWTEST_F(RSPropertyDrawTest, UpdateSaveRestore003, TestSize.Level1)
{
    RSRenderContent content;
    RSPropertyDrawable::DrawableVec drawableVec;
    uint8_t status = 1;
 ...
 * @tc.require: issueI9RBVH
 */
HWTEST_F(RSPropertyDrawTest, UpdateSaveRestore004, TestSize.Level1)
{
    RSRenderContent content;
    RSPropertyDrawable::DrawableVec drawableVec;
    uint8_t status = 1;
 ...
 * @tc.require: issueI9RBVH
 */
HWTEST_F(RSPropertyDrawTest, UpdateSaveRestore005, TestSize.Level1)
{
    RSRenderContent content;
    RSPropertyDrawable::DrawableVec drawableVec;
    uint8_t status = 55;
 ...
 * @tc.require: issueI9RBVH
 */
HWTEST_F(RSPropertyDrawTest, UpdateSaveRestore006, TestSize.Level1)
{
    RSRenderContent content;
    RSPropertyDrawable::DrawableVec drawableVec;
    uint8_t status = 55;
 ...
 * @tc.require: issueI9RBVH
 */
HWTEST_F(RSPropertyDrawTest, UpdateSaveRestore007, TestSize.Level1)
{
    RSRenderContent content;
    RSPropertyDrawable::DrawableVec drawableVec;
    uint8_t status = 55;
 ...
 * @tc.require: issueI9RBVH
 */
HWTEST_F(RSPropertyDrawTest, UpdateSaveRestore008, TestSize.Level1)
{
    RSRenderContent content;
    RSPropertyDrawable::DrawableVec drawableVec;
    uint8_t status = 55;
 ...
 * @tc.require: issueI9RBVH
 */
HWTEST_F(RSPropertyDrawTest, UpdateSaveRestore009, TestSize.Level1)
{
    RSRenderContent content;
    RSPropertyDrawable::DrawableVec drawableVec;
    uint8_t status = 24;
