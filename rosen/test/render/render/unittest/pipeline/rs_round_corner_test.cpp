...
#include "pipeline/round_corner_display/rs_rcd_render_listener.h"
...
class RSRoundCornerTest : public testing::Test {
public:
...
void RSRoundCornerTest::SetUpTestCase() {}
void RSRoundCornerTest::TearDownTestCase() {}
void RSRoundCornerTest::SetUp() {}
void RSRoundCornerTest::TearDown() {}
 ...
 * @tc.desc: Test RSRoundCornerTest.RCDLoadConfigFileTest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RCDLoadConfigFileTest, TestSize.Level1)
{
...
/*
 * @tc.name: RCDInitTest
 * @tc.desc: Test RSRoundCornerTest.RCDInitTest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RCDInitTest, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
 ...
 * @tc.desc: Test RSRoundCornerTest.UpdateParameterTest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, UpdateParameterTest, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
    auto res = rcdInstance.Init();
    EXPECT_TRUE(res == true);
 ...
 * @tc.desc: Test RSRoundCornerTest.RSDrawRoundCornerTest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSDrawRoundCornerTest, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
    auto res = rcdInstance.Init();
    EXPECT_TRUE(res == true);
 ...
 * @tc.desc: Test RSRoundCornerTest.RSLoadImgTest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSLoadImgTest, TestSize.Level1)
{
    ...
    if (imgBottomPortrait == nullptr) {
        std::cout << "RSRoundCornerTest: current os less rcd source" << std::endl;
        EXPECT_TRUE(res == true);
        return;
    }
 ...
 * @tc.desc: Test RSRoundCornerTest.RSLoadImgTest001
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSLoadImgTest001, TestSize.Level1)
{
    std::shared_ptr<Drawing::Image> imgBottomPortrait;
    Drawing::Bitmap bitmapBottomPortrait;
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
 ...
 * @tc.desc: Test RSRoundCornerTest.RSGetSurfaceSourceTest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSGetSurfaceSourceTest, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
 ...
 * @tc.desc: Test RSRoundCornerTest.RSChooseResourceTest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSChooseResourceTest, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
    rcdInstance.Init();
 ...
 * @tc.desc: Test RSRoundCornerTest.IsNotchNeedUpdate
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, IsNotchNeedUpdate, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
    rcdInstance.Init();
 ...
 * @tc.desc: Test RSRoundCornerTest.RunHardwareTask
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RunHardwareTask, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
    bool res = rcdInstance.Init();
    rcdInstance.RunHardwareTask(
        []() {
            std::cout << "do RSRoundCornerTest.RunHardwareTask1" << std::endl;
        }
    );
    rcdInstance.RunHardwareTask(
        []() {
            std::cout << "do RSRoundCornerTest.RunHardwareTask2" << std::endl;
        }
    );
    EXPECT_EQ(true, res);
}
 ...
 * @tc.desc: Test RSRoundCornerTest.DrawRoundCorner
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, DrawRoundCorner, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
    bool res = rcdInstance.Init();
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, ProcessRcdSurfaceRenderNode1, TestSize.Level1)
{
    // prepare test
    std::shared_ptr<Drawing::Image> imgBottomPortrait;
    Drawing::Bitmap bitmapBottomPortrait;
    ...
    if (lcdModel == nullptr) {
        std::cout << "RSRoundCornerTest: current os less lcdModel source" << std::endl;
        return;
    }
    int width = 0;
    int height = 0;
    ...
    if (rog == nullptr) {
        std::cout << "RSRoundCornerTest: current os less rog source" << std::endl;
        return;
    }
    ...
    if (portrait == std::nullopt) {
        std::cout << "RSRoundCornerTest: current os less bottomLayer source" << std::endl;
        return;
    }
 ...
 * @tc.desc: Test RSRoundCornerTest.ConsumeAndUpdateBufferTest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, ConsumeAndUpdateBufferTest, TestSize.Level1)
{
...
/*
 * @tc.name: MessageBus
 * @tc.desc: Test RSRoundCornerTest.MessageBus
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, MessageBus, TestSize.Level1)
{
    auto& msgBus = RSSingleton<RsMessageBus>::GetInstance();
...
/*
 * @tc.name: RCDConfig
 * @tc.desc: Test RSRoundCornerTest.RCDConfig
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RCDConfig, TestSize.Level1)
{
    auto& rcdCfg = RSSingleton<rs_rcd::RCDConfig>::GetInstance();
...
/*
 * @tc.name: LCDModel
 * @tc.desc: Test RSRoundCornerTest.LCDModel
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, LCDModel, TestSize.Level1)
{
    auto& rcdCfg = RSSingleton<rs_rcd::RCDConfig>::GetInstance();
    rcdCfg.Load(std::string(rs_rcd::PATH_CONFIG_FILE));
 ...
 * @tc.desc: Test RSRoundCornerTest.HardwareComposerConfig
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, HardwareComposerConfig, TestSize.Level1)
{
 ...
 * @tc.desc: Test RSRoundCornerTest.HardwareComposer
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, HardwareComposer, TestSize.Level1)
{
 ...
 * @tc.desc: Test RSRoundCornerTest.SideRegionConfig
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, SideRegionConfig, TestSize.Level1)
{
 ...
 * @tc.desc: Test RSRoundCornerTest.SurfaceConfig
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, SurfaceConfig, TestSize.Level1)
{
...
/*
 * @tc.name: ROGSetting
 * @tc.desc: Test RSRoundCornerTest.ROGSetting
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, ROGSetting, TestSize.Level1)
{
 ...
 * @tc.desc: Test RSRoundCornerTest.RogLandscape
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RogLandscape, TestSize.Level1)
{
...
/*
 * @tc.name: RogPortrait
 * @tc.desc: Test RSRoundCornerTest.RogPortrait
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RogPortrait, TestSize.Level1)
{
 ...
 * @tc.desc: Test RSRoundCornerTest.RoundCornerLayer
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RoundCornerLayer, TestSize.Level1)
{
...
/*
 * @tc.name: XMLReader
 * @tc.desc: Test RSRoundCornerTest.XMLReader
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, XMLReader, TestSize.Level1)
{
...
/*
 * @tc.name: RcdExtInfo
 * @tc.desc: Test RSRoundCornerTest.RcdExtInfo
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RcdExtInfo, TestSize.Level1)
{
    RcdExtInfo info;
    info.Clear();
 ...
 * @tc.desc: Test RSRoundCornerTest.RSRcdSurfaceRenderNode
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSRcdSurfaceRenderNode, TestSize.Level1)
{
    for (int i = 0; i < 2; i++)
    {
 ...
 * @tc.desc: Test RSRoundCornerTest.RSRcdSurfaceRenderNodeResource
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSRcdSurfaceRenderNodeResource, TestSize.Level1)
{
 ...
 * @tc.desc: Test RSRoundCornerTest.RSRoundCornerDisplayResource
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSRoundCornerDisplayResource, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
 ...
 * @tc.desc: Test RSRoundCornerTest.RSRoundCornerDisplayUpdateHardWare
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSRoundCornerDisplayUpdateHardWare, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
 ...
 * @tc.desc: Test RSRoundCornerTest.RSRoundCornerDisplayChooseRS
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSRoundCornerDisplayChooseRS, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
    for (int i = 0; i < 4; i++) {
 ...
 * @tc.desc: Test RSRoundCornerTest.RSRoundCornerDisplayDrawOne
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSRoundCornerDisplayDrawOne, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RcdChooseHardwareResourceTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, UpdateNotchStatusTest, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
    rcdInstance.Init();
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RcdChooseTopResourceTypeTest, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
    rcdInstance.Init();
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, ProcessFillHardwareResource, TestSize.Level1)
{
    // prepare test
    ...
    if (bottomSurfaceNode == nullptr) {
        std::cout << "RSRoundCornerTest: current os less bottomSurfaceNode source" << std::endl;
        return;
    }
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RoundCornerDisplayManager_AddRcd, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RoundCornerDisplayManager_AddLayer, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplayManager>::GetInstance();
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RoundCornerDisplayManagerNULLRcd, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplayManager>::GetInstance();
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RoundCornerDisplayManagerUpdate, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplayManager>::GetInstance();
        // add layer and NodeId
    NodeId id = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RoundCornerDisplayManagerDraw, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplayManager>::GetInstance();
    // add layer and NodeId
    NodeId id = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSRcdRenderManager, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RSRoundCornerDirtyRegion, TestSize.Level1)
{
    auto &rcdInstance = RSSingleton<RoundCornerDisplayManager>::GetInstance();
    NodeId id = 1;
    RectI dirtyRect;
 ...
 * @tc.require:
 */
HWTEST_F(RSRoundCornerTest, RoundCornerDisplayPrintRCD, TestSize.Level1)
{
    auto& rcdInstance = RSSingleton<RoundCornerDisplay>::GetInstance();
    rcdInstance.lcdModel_ = nullptr;
    rcdInstance.rog_ = nullptr;
