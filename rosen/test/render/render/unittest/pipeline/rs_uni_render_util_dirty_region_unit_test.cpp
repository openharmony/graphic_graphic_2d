...
class RSUniRenderUtilDirtyRegionUnitTest : public testing::Test {
public:
...
void RSUniRenderUtilDirtyRegionUnitTest::SetUpTestCase()
{
    RSTestUtil::InitRenderNodeGC();
}
void RSUniRenderUtilDirtyRegionUnitTest::TearDownTestCase() {}
void RSUniRenderUtilDirtyRegionUnitTest::SetUp() {}
void RSUniRenderUtilDirtyRegionUnitTest::TearDown() {}

/*
 * @tc.name: MergeDirtyHistoryInVirtual001
 * @tc.desc: Verify function MergeDirtyHistoryInVirtual while displayNode has no param
 * @tc.type: FUNC
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeDirtyHistoryInVirtual001, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeDirtyHistoryInVirtual002, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeDirtyHistoryInVirtual003, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    auto topNode = std::make_shared<RSRenderNode>(nodeId++);
    DrawableV2::RSDisplayRenderNodeDrawable displayNodeDrawable(topNode);
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleDirtyRegionInVirtualTest001, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    auto topNode = std::make_shared<RSRenderNode>(nodeId++);
    DrawableV2::RSDisplayRenderNodeDrawable displayNodeDrawable(topNode);
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleDirtyRegionInVirtualTest002, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    auto topNode = std::make_shared<RSRenderNode>(nodeId++);
    DrawableV2::RSDisplayRenderNodeDrawable displayNodeDrawable(topNode);
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleDirtyRegionInVirtualTest003, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    auto topNode = std::make_shared<RSRenderNode>(nodeId++);
    DrawableV2::RSDisplayRenderNodeDrawable displayNodeDrawable(topNode);
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, SetAllSurfaceDrawableGlobalDirtyRegionTest001,
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, SetAllSurfaceDrawableGlobalDirtyRegionTest002,
    Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceDrawables;
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, SetAllSurfaceDrawableGlobalDirtyRegionTest003,
    Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceDrawables;
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, AlignedDirtyRegion_001, Function | SmallTest | Level2)
{
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, AlignedDirtyRegion_002, Function | SmallTest | Level2)
{
    Occlusion::Region dirtyRegion;
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleDirtyRegionTest, Function | SmallTest | Level2)
{
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleDirtyRegionTest001, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceNodeDrawables;
    std::vector<NodeId> hasVisibleDirtyRegionSurfaceVec;
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleDirtyRegionTest002, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceNodeDrawables;
    std::vector<NodeId> hasVisibleDirtyRegionSurfaceVec;
    NodeId id = 1;
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleDirtyRegionTest003, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceNodeDrawables;
    std::vector<NodeId> hasVisibleDirtyRegionSurfaceVec;
    NodeId id = 1;
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleAdvancedDirtyRegionTest004, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceDrawawble;
    std::vector<NodeId> hasVisibleDirtyRegionSurfaceVec;
    NodeId id = 1;
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleAdvancedDirtyRegionTest001, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceNodeDrawables;
    std::vector<NodeId> hasVisibleDirtyRegionSurfaceVec;
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleAdvancedDirtyRegionTest002, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceNodeDrawables;
    std::vector<NodeId> hasVisibleDirtyRegionSurfaceVec;
    NodeId id = 1;
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleAdvancedDirtyRegionTest003, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceNodeDrawables;
    std::vector<NodeId> hasVisibleDirtyRegionSurfaceVec;
    NodeId id = 1;
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, SetDrawRegionForQuickRejectTest001, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceNodeDrawables;
    NodeId id = 1;
    auto surfaceNode = std::make_shared<RSSurfaceRenderNode>(id);
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, SetDrawRegionForQuickRejectTest002, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceNodeDrawables;
    NodeId id = 1;
    auto surfaceNode = std::make_shared<RSSurfaceRenderNode>(id);
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, SetDrawRegionForQuickRejectTest003, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceNodeDrawables;
    NodeId id = 1;
    auto surfaceNode = std::make_shared<RSSurfaceRenderNode>(id);
 ...
 * @tc.require: issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, SetDrawRegionForQuickRejectTest004, Function | SmallTest | Level2)
{
    std::vector<DrawableV2::RSRenderNodeDrawableAdapter::SharedPtr> allSurfaceNodeDrawables;
    NodeId id = 1;
    auto surfaceNode = std::make_shared<RSSurfaceRenderNode>(id);
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleDirtyRegionInVirtualTest004, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    auto topNode = std::make_shared<RSRenderNode>(nodeId++);
    DrawableV2::RSDisplayRenderNodeDrawable displayNodeDrawable(topNode);
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleDirtyRegionInVirtualTest005, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    auto topNode = std::make_shared<RSRenderNode>(nodeId++);
    DrawableV2::RSDisplayRenderNodeDrawable displayNodeDrawable(topNode);
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeVisibleDirtyRegionInVirtualTest006, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    auto topNode = std::make_shared<RSRenderNode>(nodeId++);
    DrawableV2::RSDisplayRenderNodeDrawable displayNodeDrawable(topNode);
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeDirtyHistoryInVirtual004, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    DrawableV2::RSDisplayRenderNodeDrawable drawable(node);
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeDirtyHistoryInVirtual005, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    auto topNode = std::make_shared<RSRenderNode>(nodeId++);
    DrawableV2::RSDisplayRenderNodeDrawable displayNodeDrawable(topNode);
 ...
 * @tc.require: issueIC4T5J
*/
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, MergeDirtyHistoryInVirtual006, Function | SmallTest | Level2)
{
    NodeId nodeId = 1;
    auto topNode = std::make_shared<RSRenderNode>(nodeId++);
    DrawableV2::RSDisplayRenderNodeDrawable displayNodeDrawable(topNode);
 ...
 * @tc.require:issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, ScreenIntersectDirtyRectsTest, Function | SmallTest | Level2)
{
 ...
 * @tc.require:issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, ExpandDamageRegionToSingleRect001, Function | SmallTest | Level2)
{
    Occlusion::Region region;
 ...
 * @tc.require:issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, ExpandDamageRegionToSingleRect002, Function | SmallTest | Level2)
{
 ...
 * @tc.require:issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, ExpandDamageRegionToSingleRect003, Function | SmallTest | Level2)
{
 ...
 * @tc.require:issueIC4T5J
 */
HWTEST_F(RSUniRenderUtilDirtyRegionUnitTest, ExpandDamageRegionToSingleRect004, Function | SmallTest | Level2)
{
    const auto clipRectThreshold = RSSystemProperties::GetClipRectThreshold();
    Occlusion::Region region1 = Occlusion::Region { DEFAULT_RECT1 };
