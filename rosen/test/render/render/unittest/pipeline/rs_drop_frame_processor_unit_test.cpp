...
/**
 * @tc.name: DropFrameProcessorTest01
 * @tc.desc: Test drop frame when pointer is null.
 * @tc.type: FUNC
 * @tc.require: issueI5VQWQ
 */
HWTEST_F(RsDropFrameProcessorTest, DropFrameProcessorTest01, TestSize.Level1)
{
...
/**
 * @tc.name: DropFrameProcessorTest02
 * @tc.desc: Create node
 * @tc.type: Test if AcquireBuffer is not OK.
 * @tc.require: issueI5VQWQ
 */
HWTEST_F(RsDropFrameProcessorTest, DropFrameProcessorTest02, TestSize.Level1)
{
    RSSurfaceRenderNodeConfig config;
    rsNode = std::make_shared<RSSurfaceRenderNode>(config);
...
/**
 * @tc.name: DropFrameProcessorTest03
 * @tc.desc: Test DropFrameProcess is OK.
 * @tc.type: FUNC
 * @tc.require: issueI5VQWQ
 */
HWTEST_F(RsDropFrameProcessorTest, DropFrameProcessorTest03, TestSize.Level1)
{
    RSSurfaceRenderNodeConfig config;
    rsNode = std::make_shared<RSSurfaceRenderNode>(config);
    ASSERT_NE(rsNode, nullptr);
