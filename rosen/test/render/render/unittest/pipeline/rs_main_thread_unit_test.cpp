...
class RSMainThreadUnitTest : public testing::Test {
public:
...
void RSMainThreadUnitTest::SetUpTestCase()
{
    RSTestUtil::InitRenderNodeGC();
}
void RSMainThreadUnitTest::TearDownTestCase() {}
void RSMainThreadUnitTest::SetUp() {}
void RSMainThreadUnitTest::TearDown()
{
...
void* RSMainThreadUnitTest::CreateParallelSyncSignal(uint32_t count)
{
    (void)(count);
    return nullptr;
}
 ...
 * @tc.desc: Test RSMainThreadUnitTest.ProcessCommandForDividedRender
 * @tc.type: FUNC
 * @tc.require: issueIB8HAQ
 */
HWTEST_F(RSMainThreadUnitTest, ProcessCommandForDividedRender002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
...
/**
 * @tc.name: Start001
 * @tc.desc: Test RSMainThreadUnitTest.Start
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, Start001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->Start();
 ...
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, Start002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.desc: Test RSMainThreadUnitTest.ProcessCommand
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, ProcessCommand, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.desc: Test RSMainThreadUnitTest.RsEventParamDump
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, RsEventParamDump, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    std::string str = "";
 ...
 * @tc.desc: Test RSMainThreadUnitTest.RemoveRSEventDetector, with init
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, RemoveRSEventDetector001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.desc: Test RSMainThreadUnitTest.RemoveRSEventDetector, without init
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, RemoveRSEventDetector002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->RemoveRSEventDetector();
 ...
 * @tc.desc: Test RSMainThreadUnitTest.InitRSEventDetector, without init
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, InitRSEventDetector, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.desc: Test RSMainThreadUnitTest.SetRSEventDetectorLoopStartTag, with init
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, SetRSEventDetectorLoopStartTag001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->InitRSEventDetector();
 ...
 * @tc.desc: Test RSMainThreadUnitTest.SetRSEventDetectorLoopStartTag, without init
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, SetRSEventDetectorLoopStartTag002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->rsCompositionTimeoutDetector_ = nullptr;
 ...
 * @tc.desc: Test RSMainThreadUnitTest.SetRSEventDetectorLoopFinishTag, with init
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, SetRSEventDetectorLoopFinishTag001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->InitRSEventDetector();
 ...
 * @tc.desc: Test RSMainThreadUnitTest.SetRSEventDetectorLoopFinishTag, without init
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, SetRSEventDetectorLoopFinishTag002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->rsCompositionTimeoutDetector_ = nullptr;
 ...
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, ProcessCommandForDividedRender001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->ProcessCommandForDividedRender();
 ...
 * @tc.desc: Test RSMainThreadUnitTest.CalcOcclusion, doWindowAnimate_ is false, isUniRender_ is true
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, CalcOcclusion, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
...
/**
 * @tc.name: Animate001
 * @tc.desc: Test RSMainThreadUnitTest.Animate, doWindowAnimate_ is false
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, Animate001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->doWindowAnimate_ = false;
...
/**
 * @tc.name: Animate002
 * @tc.desc: Test RSMainThreadUnitTest.Animate, doWindowAnimate_ is true
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, Animate002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.desc: Test RSMainThreadUnitTest.Animate
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, UnRegisterOcclusionChangeCallback, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.desc: Test RSMainThreadUnitTest.RenderServiceTreeDump, str is an empty string
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, RenderServiceTreeDump, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    std::string str = "";
 ...
 * @tc.desc: Test RSMainThreadUnitTest.SetFocusAppInfo, input pid, uid is -1, str is an empty string
 * @tc.type: FUNC
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSMainThreadUnitTest, SetFocusAppInfo, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    std::string str = "";
 ...
 */
HWTEST_F(RSMainThreadUnitTest, SetFocusAppInfo002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, AddPidNeedDropFrame, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIB612L
 */
HWTEST_F(RSMainThreadUnitTest, ClearNeedDropframePidList, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, IsNeedDropFrameByPid001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIB7PH1
 */
HWTEST_F(RSMainThreadUnitTest, IsNeedDropFrameByPid002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, ProcessSyncRSTransactionData001, TestSize.Level1)
{
 ...
 * @tc.require: issueI6Q9A2
 */
HWTEST_F(RSMainThreadUnitTest, ProcessSyncRSTransactionData002, TestSize.Level1)
{
 ...
 * @tc.require: issueI6Q9A2
 */
HWTEST_F(RSMainThreadUnitTest, StartSyncTransactionFallbackTask001, TestSize.Level1)
{
    auto rsTransactionData = std::make_unique<RSTransactionData>();
    rsTransactionData->SetSyncId(1);
 ...
 * @tc.require: issueI6Q9A2
 */
HWTEST_F(RSMainThreadUnitTest, ProcessSyncTransactionCount, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    auto rsTransactionData = std::make_unique<RSTransactionData>();
 ...
 * @tc.require: issueI6Q9A2
 */
HWTEST_F(RSMainThreadUnitTest, GetContext, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
 ...
 * @tc.require: issueI6Q9A2
 */
HWTEST_F(RSMainThreadUnitTest, ClassifyRSTransactionData001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
 ...
 */
HWTEST_F(RSMainThreadUnitTest, ClassifyRSTransactionData002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    mainThread->pendingEffectiveCommands_.clear();
    auto rsTransactionData = std::make_unique<RSTransactionData>();
 ...
 * @tc.require: issueI6R34I
 */
HWTEST_F(RSMainThreadUnitTest, ClassifyRSTransactionData003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    mainThread->pendingEffectiveCommands_.clear();
    auto rsTransactionData = std::make_unique<RSTransactionData>();
 ...
 * @tc.require: issueI6R34I
 */
HWTEST_F(RSMainThreadUnitTest, ClassifyRSTransactionData004, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    // build the NodeTree
    NodeId nodeId = 1;
 ...
 * @tc.require: issueI6Q9A2
 */
HWTEST_F(RSMainThreadUnitTest, AddActiveNode, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
 ...
 */
HWTEST_F(RSMainThreadUnitTest, CheckAndUpdateInstanceContentStaticStatus01, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    mainThread->context_->activeNodesInRoot_.clear();
    // valid nodeid
 ...
 * @tc.require: issueI8IXTX
 */
HWTEST_F(RSMainThreadUnitTest, CheckAndUpdateInstanceContentStaticStatus02, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    mainThread->context_->activeNodesInRoot_.clear();
    // valid nodeid
 ...
 */
HWTEST_F(RSMainThreadUnitTest, IsNeedProcessBySingleFrameComposerTest001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
 ...
 * @tc.require: issueI9HPBS
 */
HWTEST_F(RSMainThreadUnitTest, IsNeedProcessBySingleFrameComposerTest002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
 ...
 * @tc.require: issueI6R34I
 */
HWTEST_F(RSMainThreadUnitTest, RecvRSTransactionData, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    std::unique_ptr<RSTransactionData> transactionData = nullptr;
 ...
 * @tc.require: issueI6R34I
 */
HWTEST_F(RSMainThreadUnitTest, PostSyncTask, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
 ...
 */
HWTEST_F(RSMainThreadUnitTest, ShowWatermark, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
 ...
 * @tc.desc: Test RSMainThreadUnitTest.MergeToEffectiveTransactionDataMap
 * @tc.type: FUNC
 * @tc.require: issueI8V6MD
 */
HWTEST_F(RSMainThreadUnitTest, MergeToEffectiveTransactionDataMap001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    mainThread->Start();
 ...
 */
HWTEST_F(RSMainThreadUnitTest, ProcessCommandForUniRender, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_EQ(mainThread->effectiveTransactionDataIndexMap_.empty(), true);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, GetWatermarkImg, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
 ...
 */
HWTEST_F(RSMainThreadUnitTest, IsWatermarkFlagChanged, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, DoParallelComposition, TestSize.Level1)
{
    NodeId nodeId = 1;
    std::weak_ptr<RSContext> context = {};
    auto node = std::make_shared<RSBaseRenderNode>(nodeId, context);
    ...
    auto mainThread = RSMainThread::Instance();
    RSInnovation::_s_createParallelSyncSignal = (void*)RSMainThreadUnitTest::CreateParallelSyncSignal;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetIdleTimerExpiredFlag, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.desc: Test RSMainThreadUnitTest.SetFocusLeashWindowId
 * @tc.type: FUNC
 * @tc.require: issueI8V6MD
 */
HWTEST_F(RSMainThreadUnitTest, SetFocusLeashWindowId, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    mainThread->Start();
    NodeId id = 1;
 ...
 */
HWTEST_F(RSMainThreadUnitTest, SetFocusLeashWindowId002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI98VTC
 */
HWTEST_F(RSMainThreadUnitTest, SetFocusLeashWindowId003, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    auto node = RSTestUtil::CreateSurfaceNode();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI98VTC
 */
HWTEST_F(RSMainThreadUnitTest, SetFocusLeashWindowId004, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
 ...
 * @tc.require: issueI98VTC
 */
HWTEST_F(RSMainThreadUnitTest, SetFocusLeashWindowId005, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    auto childNode = RSTestUtil::CreateSurfaceNode();
    auto parentNode = RSTestUtil::CreateSurfaceNode();
 ...
 * @tc.desc: Test RSMainThreadUnitTest.SetIsCachedSurfaceUpdated
 * @tc.type: FUNC
 * @tc.require: issueI8V6MD
 */
HWTEST_F(RSMainThreadUnitTest, SetIsCachedSurfaceUpdated, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.desc: Test RSMainThreadUnitTest.PrintCurrentStatus
 * @tc.type: FUNC
 * @tc.require: issueI8V6MD
 */
HWTEST_F(RSMainThreadUnitTest, PrintCurrentStatus, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.desc: Test RSMainThreadUnitTest.SetDeviceType
 * @tc.type: FUNC
 * @tc.require: issueI8V6MD
 */
HWTEST_F(RSMainThreadUnitTest, SetDeviceType, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.desc: Test RSMainThreadUnitTest.CacheCommands
 * @tc.type: FUNC
 * @tc.require: issueI8V6MD
 */
HWTEST_F(RSMainThreadUnitTest, CacheCommands, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto data = std::make_unique<RSTransactionData>();
 ...
 * @tc.desc: Test RSMainThreadUnitTest.CheckParallelSubThreadNodesStatus
 * @tc.type: FUNC
 * @tc.require: issueI8V6MD
 */
HWTEST_F(RSMainThreadUnitTest, CheckParallelSubThreadNodesStatus, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, IsNeedSkip, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SkipCommandByNodeId001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SkipCommandByNodeId002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, SkipCommandByNodeId003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    std::vector<std::unique_ptr<RSTransactionData>> transactionVec;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ConsumeAndUpdateAllNodes001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ConsumeAndUpdateAllNodes002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    bool isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CheckSubThreadNodeStatusIsDoing001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->subThreadNodes_.clear();
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CheckSubThreadNodeStatusIsDoing002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->subThreadNodes_.clear();
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CollectInfoForHardwareComposer001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    bool isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CollectInfoForHardwareComposer002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    bool isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, IsLastFrameUIFirstEnabled001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->subThreadNodes_.clear();
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, IsLastFrameUIFirstEnabled002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->subThreadNodes_.clear();
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CheckIfHardwareForcedDisabled, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIAS924
 */
HWTEST_F(RSMainThreadUnitTest, CheckIfHardwareForcedDisabled002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 * @tc.require: issueIAS924
 */
HWTEST_F(RSMainThreadUnitTest, CheckIfHardwareForcedDisabled003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, WaitUntilUnmarshallingTaskFinished001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    bool isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, NotifyUnmarshalTask001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    bool isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, MergeToEffectiveTransactionDataMap, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, UniRender001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, UniRender002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto& uniRenderThread = RSUniRenderThread::Instance();
 ...
 */
HWTEST_F(RSMainThreadUnitTest, IsFirstFrameOfOverdrawSwitch, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, GetRealTimeOffsetOfDvsync, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    int64_t time = 1000;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, Render, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto& uniRenderThread = RSUniRenderThread::Instance();
 ...
 * @tc.require: issueIAS924
 */
HWTEST_F(RSMainThreadUnitTest, Render002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CallbackDrawContextStatusToWMS, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CheckSurfaceNeedProcess, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, GetRegionVisibleLevel001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    // empty region
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, GetRegionVisibleLevel002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    // equal region
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, GetRegionVisibleLevel003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CalcOcclusionImplementation, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    RSDisplayNodeConfig config;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CallbackToWMS001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CallbackToWMS002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    VisibleData curVisVec;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SurfaceOcclusionCallback001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    // prepare listeners
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SurfaceOcclusionCallback002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    // prepare listeners
 ...
 */
HWTEST_F(RSMainThreadUnitTest, SurfaceOcclusionCallback003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issuesIBE1C8
 */
HWTEST_F(RSMainThreadUnitTest, SurfaceOcclusionCallback004, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    RectI rectBottom = RectI(-1000000, -1000000, 999999, 999999);
 ...
 * @tc.require: issuesIBE1C8
 */
HWTEST_F(RSMainThreadUnitTest, SurfaceOcclusionCallback005, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issuesIBE1C8
 */
HWTEST_F(RSMainThreadUnitTest, CheckSurfaceOcclusionNeedProcess001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    RSSurfaceRenderNodeConfig config;
 ...
 * @tc.require: issuesIBE1C8
 */
HWTEST_F(RSMainThreadUnitTest, CheckSurfaceOcclusionNeedProcess002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    RSSurfaceRenderNodeConfig config;
 ...
 * @tc.require: issuesIBE1C8
 */
HWTEST_F(RSMainThreadUnitTest, CheckSurfaceOcclusionNeedProcess003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    RSSurfaceRenderNodeConfig config;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CalcOcclusion002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    // prepare states
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, Aniamte, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId id = 0;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, RecvRSTransactionData002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    bool isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ConsumeAndUpdateAllNodes003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    bool isUniRender = mainThread->isUniRender_;
 ...
 */
HWTEST_F(RSMainThreadUnitTest, ConsumeAndUpdateAllNodes004, TestSize.Level1)
{
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CollectInfoForHardwareComposer003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    bool isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ClassifyRSTransactionData005, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    bool isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ReleaseAllNodesBuffer, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    bool isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueIAS924
 */
HWTEST_F(RSMainThreadUnitTest, ReleaseAllNodesBuffer002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, PostTask001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->runner_ = AppExecFwk::EventRunner::Create(false);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, PostTask002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->runner_ = AppExecFwk::EventRunner::Create(false);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, RemoveTask, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->runner_ = AppExecFwk::EventRunner::Create(false);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, PostSyncTask002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->runner_ = AppExecFwk::EventRunner::Create(false);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, RegisterSurfaceOcclusionChangeCallBack001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId id = 0;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, RegisterSurfaceOcclusionChangeCallBack002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId id = 0;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ClearSurfaceOcclusionChangeCallback, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    // prepare listeners
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SendCommands, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSMainThreadUnitTest, SendCommands001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId id = 1;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ClearTransactionDataPidInfo001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    int remotePid = 0;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ClearTransactionDataPidInfo002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    int remotePid = 1;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, AddTransactionDataPidInfo001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, AddTransactionDataPidInfo002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, PerfAfterAnim001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, PerfAfterAnim002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, PerfAfterAnim003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ForceRefreshForUni001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ForceRefreshForUni002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 */
HWTEST_F(RSMainThreadUnitTest, ForceRefreshForUni003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, PerfForBlurIfNeeded, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->runner_ = AppExecFwk::EventRunner::Create(false);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, PerfMultiWindow001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, PerfMultiWindow002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, RenderFrameStart, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetSystemAnimatedScenes001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetSystemAnimatedScenes002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    SystemAnimatedScenes scenesInit = mainThread->systemAnimatedScenes_;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetSystemAnimatedScenes003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CheckNodeHasToBePreparedByPid001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId id = 1;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CheckNodeHasToBePreparedByPid002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId id = 1;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetVSyncRateByVisibleLevel001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetVSyncRateByVisibleLevel002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    if (mainThread->appVSyncDistributor_ == nullptr) {
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetVSyncRateByVisibleLevel003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    if (mainThread->appVSyncDistributor_ == nullptr) {
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetVSyncRateByVisibleLevel004, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    if (mainThread->appVSyncDistributor_ == nullptr) {
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetSystemAnimatedScenes004, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetSystemAnimatedScenes005, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetSystemAnimatedScenes006, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetSystemAnimatedScenes007, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetSystemAnimatedScenes008, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, SetSystemAnimatedScenes009, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, IsDrawingGroupChanged, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId id = 1;
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, CheckAndUpdateInstanceContentStaticStatus003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI7HDVG
 */
HWTEST_F(RSMainThreadUnitTest, ReleaseSurface, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, SetLuminanceChangingStatus, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    for (int i = 0; i < 10; i++) {
 ...
 * @tc.require: issueI9ABGS
 */
HWTEST_F(RSMainThreadUnitTest, ExchangeLuminanceChangingStatus, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    for (int i = 0; i < 10; i++) {
 ...
 */
HWTEST_F(RSMainThreadUnitTest, CalcOcclusionImplementation001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    std::vector<RSBaseRenderNode::SharedPtr> curAllSurfaces;
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, CalcOcclusionImplementation002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    std::vector<RSBaseRenderNode::SharedPtr> curAllSurfaces;
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, CalcOcclusionImplementation003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    std::vector<RSBaseRenderNode::SharedPtr> curAllSurfaces;
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, CalcOcclusionImplementation004, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    std::vector<RSBaseRenderNode::SharedPtr> curAllSurfaces;
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, CalcOcclusionImplementation005, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    std::vector<RSBaseRenderNode::SharedPtr> curAllSurfaces;
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, UpdateDisplayNodeScreenId001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, UpdateDisplayNodeScreenId002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, UpdateDisplayNodeScreenId003, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId rootId = 0;
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, ProcessScreenHotPlugEvents, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, CheckSystemSceneStatus001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, CheckSystemSceneStatus002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->SetSystemAnimatedScenes(SystemAnimatedScenes::ENTER_TFS_WINDOW);
 ...
 * @tc.require: issueI97LXT
 */
HWTEST_F(RSMainThreadUnitTest, DoDirectComposition, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId rootId = 0;
 ...
 * @tc.require: issueI9LOXQ
 */
HWTEST_F(RSMainThreadUnitTest, UpdateNeedDrawFocusChange001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI9LOXQ
 */
HWTEST_F(RSMainThreadUnitTest, UpdateNeedDrawFocusChange002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI9LOXQ
 */
HWTEST_F(RSMainThreadUnitTest, UpdateNeedDrawFocusChange003, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI9LOXQ
 */
HWTEST_F(RSMainThreadUnitTest, UpdateFocusNodeId001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI9LOXQ
 */
HWTEST_F(RSMainThreadUnitTest, UpdateFocusNodeId002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueI9LOXQ
 */
HWTEST_F(RSMainThreadUnitTest, UpdateFocusNodeId003, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, UiCaptureTasks, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, UIExtensionNodesTraverseAndCallback001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIABHAX
 */
HWTEST_F(RSMainThreadUnitTest, CheckUIExtensionCallbackDataChanged002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIABHAX
 */
HWTEST_F(RSMainThreadUnitTest, CheckOnUIExtensionCallback001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->lastFrameUIExtensionDataEmpty_ = false;
 ...
 * @tc.require: issueIABHAX
 */
HWTEST_F(RSMainThreadUnitTest, CheckOnUIExtensionCallback002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    uint64_t userId = 0;
 ...
 */
HWTEST_F(RSMainThreadUnitTest, GetDynamicRefreshRate002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIAIPI3
 */
HWTEST_F(RSMainThreadUnitTest, SetFrameIsRender001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIAIPI3
 */
HWTEST_F(RSMainThreadUnitTest, SetFrameIsRender002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIAIPI3
 */
HWTEST_F(RSMainThreadUnitTest, OnUniRenderDraw001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueIAIPI3
 */
HWTEST_F(RSMainThreadUnitTest, OnUniRenderDraw002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 */
HWTEST_F(RSMainThreadUnitTest, ProcessDataBySingleFrameComposer001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require: issueIAIZ2Y
 */
HWTEST_F(RSMainThreadUnitTest, ProcessDataBySingleFrameComposer002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto isUniRender = mainThread->isUniRender_;
 ...
 * @tc.require:
 */
HWTEST_F(RSMainThreadUnitTest, IsHardwareEnabledNodesNeedSync, TestSize.Level2)
{
    NodeId id = 1;
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIAS924
 */
HWTEST_F(RSMainThreadUnitTest, IsSingleDisplay, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, HasMirrorDisplay001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 * @tc.require: issueIB5EAA
 */
HWTEST_F(RSMainThreadUnitTest, HasMirrorDisplay002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 * @tc.require: issueIAIZ2Y
 */
HWTEST_F(RSMainThreadUnitTest, ResetAnimateNodeFlag, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, SendClientDumpNodeTreeCommands, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 * @tc.require: issueIAKME2
 */
HWTEST_F(RSMainThreadUnitTest, CollectClientNodeTreeResult, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->nodeTreeDumpTasks_.clear();
 ...
 */
HWTEST_F(RSMainThreadUnitTest, OnDrawingCacheDfxSwitchCallback, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIAKME2
 */
HWTEST_F(RSMainThreadUnitTest, OnCommitDumpClientNodeTree, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->nodeTreeDumpTasks_.clear();
 ...
 */
HWTEST_F(RSMainThreadUnitTest, TraverseCanvasDrawingNodesNotOnTree, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, RenderServiceAllNodeDump01, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId id = 1;
...
HWTEST_F(RSMainThreadUnitTest, ConnectChipsetVsyncSer, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
#if defined(RS_ENABLE_CHIPSET_VSYNC)
HWTEST_F(RSMainThreadUnitTest, SetVsyncInfo, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSMainThreadUnitTest, IsOcclusionNodesNeedSync001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->nodeTreeDumpTasks_.clear();
 ...
 * @tc.require:
 */
HWTEST_F(RSMainThreadUnitTest, IsOcclusionNodesNeedSync002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->nodeTreeDumpTasks_.clear();
 ...
 * @tc.require:
 */
HWTEST_F(RSMainThreadUnitTest, IsOcclusionNodesNeedSync003, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->nodeTreeDumpTasks_.clear();
 ...
 * @tc.require:
 */
HWTEST_F(RSMainThreadUnitTest, IsOcclusionNodesNeedSync004, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    mainThread->nodeTreeDumpTasks_.clear();
 ...
 * @tc.require:
 */
HWTEST_F(RSMainThreadUnitTest, ProcessHgmFrameRate, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, SetCurtainScreenUsingStatus001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIB5RAM
 */
HWTEST_F(RSMainThreadUnitTest, CountMem, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    ASSERT_NE(mainThread->context_, nullptr);
 ...
 */
HWTEST_F(RSMainThreadUnitTest, UpdateSubSurfaceCnt001, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIBBUDG
 */
HWTEST_F(RSMainThreadUnitTest, UpdateSubSurfaceCnt002, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto context = mainThread->context_;
 ...
 * @tc.require: issueIBBUDG
 */
HWTEST_F(RSMainThreadUnitTest, UpdateSubSurfaceCnt003, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto context = mainThread->context_;
 ...
 * @tc.require: issueIB8HAQ
 */
HWTEST_F(RSMainThreadUnitTest, ClearMemoryCache, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIB8HAQ
 */
HWTEST_F(RSMainThreadUnitTest, DoDirectComposition001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId rootId = 0;
 ...
 * @tc.require: issueIB8HAQ
 */
HWTEST_F(RSMainThreadUnitTest, DoDirectComposition002, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    NodeId rootId = 0;
 ...
 */
HWTEST_F(RSMainThreadUnitTest, MultiDisplayChangeTest, TestSize.Level2)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIBGV2W
 */
HWTEST_F(RSMainThreadUnitTest, CheckFastCompose001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    auto receiver = mainThread->receiver_;
 ...
 */
HWTEST_F(RSMainThreadUnitTest, InitVulkanErrorCallback001, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIB57QP
 */
HWTEST_F(RSMainThreadUnitTest, RenderServiceAllSurafceDump01, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
    //prepare nodemap
 ...
 */
HWTEST_F(RSMainThreadUnitTest, ExistBufferIsVisibleAndUpdateTest, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
 ...
 * @tc.require: issueIC0AQO
 */
HWTEST_F(RSMainThreadUnitTest, GetForceCommitReasonTest, TestSize.Level1)
{
    auto mainThread = RSMainThread::Instance();
    ASSERT_NE(mainThread, nullptr);
