 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, CreateDisplayRenderNodeDrawable, TestSize.Level1)
{
    RSDisplayNodeConfig config;
    NodeId id = 1;
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, PrepareOffscreenRender001, TestSize.Level1)
{
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, PrepareOffscreenRender002, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(renderNode_, nullptr);
 ...
 * @tc.require: #IB5JZQ
 */
HWTEST_F(RSDisplayNodeDrawableTest, InitTranslateForWallpaper, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, ClearTransparentBeforeSaveLayer, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
    auto& rtThread = RSUniRenderThread::Instance();
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, DrawCurtainScreen, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, DrawWatermarkIfNeed, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: #IA76UC
 */
HWTEST_F(RSDisplayNodeDrawableTest, CalculateVirtualDirtyForWiredScreen001, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: #IA76UC
 */
HWTEST_F(RSDisplayNodeDrawableTest, CalculateVirtualDirtyForWiredScreen002, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: #IA76UC
 */
HWTEST_F(RSDisplayNodeDrawableTest, CalculateVirtualDirtyForWiredScreen003, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(mirroredNode_, nullptr);
 ...
 * @tc.require: #IA76UC
 */
HWTEST_F(RSDisplayNodeDrawableTest, CalculateVirtualDirtyForWiredScreen004, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(mirroredNode_, nullptr);
 ...
 * @tc.require: #IA76UC
 */
HWTEST_F(RSDisplayNodeDrawableTest, CalculateVirtualDirtyForWiredScreen005, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(mirroredNode_, nullptr);
 ...
 * @tc.require: #IA76UC
 */
HWTEST_F(RSDisplayNodeDrawableTest, CalculateVirtualDirtyForWiredScreen006, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(mirroredNode_, nullptr);
 ...
 * @tc.require: #IB1MHX
 */
HWTEST_F(RSDisplayNodeDrawableTest, RenderOverDraw, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: #IAX2SN
 */
HWTEST_F(RSDisplayNodeDrawableTest, HardCursorCreateLayerTest, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, CheckDisplayNodeSkipTest, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
 ...
 */
HWTEST_F(RSDisplayNodeDrawableTest, CheckAndUpdateFilterCacheOcclusionTest, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
 ...
 * @tc.require: issueIAL2EA
 */
HWTEST_F(RSDisplayNodeDrawableTest, CheckFilterCacheFullyCoveredTest, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, OnDrawTest, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, DrawMirrorScreenTest, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, CalculateVirtualDirtyTest, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, DrawMirrorTest, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, DrawExpandScreenTest, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSDisplayNodeDrawableTest, WiredScreenProjectionTest, TestSize.Level1)
{
    ASSERT_NE(renderNode_, nullptr);
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByIntervalTest001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByIntervalTest002, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByIntervalTest003, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByIntervalTest004, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByIntervalTest005, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
    uint32_t skipFrameInterval = 2; // skipFrameInterval 2
    displayDrawable_->SkipFrameByInterval(refreshRate, skipFrameInterval);
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByIntervalTest006, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByIntervalTest007, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
    uint32_t skipFrameInterval = 6; // skipFrameInterval 6
    displayDrawable_->SkipFrameByInterval(refreshRate, skipFrameInterval);
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByRefreshRateTest001, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByRefreshRateTest002, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByRefreshRateTest003, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByRefreshRateTest004, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
    uint32_t expectedRefreshRate = 60; // 60hz
    displayDrawable_->SkipFrameByRefreshRate(refreshRate, expectedRefreshRate);
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameTest001, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
 ...
 * @tc.require:
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameTest002, TestSize.Level1)
{
    uint32_t refreshRate = 60; // 60hz
    ScreenInfo screenInfo;
 ...
 */
HWTEST_F(RSDisplayNodeDrawableTest, GetSpecialLayerType, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, RotateMirrorCanvas, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, ScaleAndRotateMirrorForWiredScreen, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 */
HWTEST_F(RSDisplayNodeDrawableTest, ScaleAndRotateMirrorForWiredScreen002, TestSize.Level2)
{
 ...
 * @tc.require: issueIANDBE
 */
HWTEST_F(RSDisplayNodeDrawableTest, ScaleAndRotateMirrorForWiredScreen003, TestSize.Level2)
{
    // set drawable screenInfo
    ASSERT_NE(displayDrawable_, nullptr);
    auto mainParams = displayDrawable_->GetRenderParams() ?
 ...
 * @tc.require: issueIANDBE
 */
HWTEST_F(RSDisplayNodeDrawableTest, ScaleAndRotateMirrorForWiredScreen004, TestSize.Level2)
{
    // set drawable screenInfo
    ASSERT_NE(displayDrawable_, nullptr);
    auto mainParams = displayDrawable_->GetRenderParams() ?
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, DrawMirrorCopy, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
    ASSERT_NE(mirroredNode_, nullptr);
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, DrawHardwareEnabledNodes001, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
    Drawing::Canvas canvas;
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, DrawHardwareEnabledNodes002, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
    Drawing::Canvas canvas;
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, DrawHardwareEnabledNodesMissedInCacheImage, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
    Drawing::Canvas canvas;
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, SwitchColorFilter, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
    Drawing::Canvas drawingCanvas;
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, FindHardwareEnabledNodes, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, MakeBrightnessAdjustmentShader, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, FinishOffscreenRender, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
    ASSERT_NE(displayDrawable_->renderParams_, nullptr);
    Drawing::SamplingOptions sampling;
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, CreateSurface, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, SkipFrameByInterval, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 * @tc.require: issueIAGR5V
 */
HWTEST_F(RSDisplayNodeDrawableTest, UseCanvasSizeTest, TestSize.Level1)
{
    ASSERT_NE(displayDrawable_, nullptr);
 ...
 */
HWTEST_F(RSDisplayNodeDrawableTest, EnablescRGBForP3AndUiFirstTest, TestSize.Level2)
{
    ASSERT_NE(displayDrawable_, nullptr);
...
HWTEST_F(RSDisplayNodeDrawableTest, DrawWiredMirrorOnDraw, TestSize.Level2)
{
    ASSERT_NE(displayDrawable_, nullptr);
