...
namespace OHOS {
namespace Rosen {
class RSSurfaceRenderNodeUtilOneTest : public testing::Test {
public:
...
void RSSurfaceRenderNodeUtilOneTest::SetUpTestCase()
{
    canvas_ = new RSPaintFilterCanvas(&drawingCanvas_);
}
void RSSurfaceRenderNodeUtilOneTest::TearDownTestCase()
{
    delete canvas_;
    canvas_ = nullptr;
}
void RSSurfaceRenderNodeUtilOneTest::SetUp() {}
void RSSurfaceRenderNodeUtilOneTest::TearDown() {}
 ...
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, CollectSurfaceTest003, TestSize.Level1)
{
 ...
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, UpdateSpecialLayerInfoByTypeChangeTest, TestSize.Level1)
{
    id = 1;
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, ResetSurfaceOpaqueRegion03, TestSize.Level1)
{
 ...
 * @tc.require: issueIB9LWV
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, UpdateSpecialLayerInfoByOnTreeStateChange001, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
    renderNode->SetProtectedLayer(true);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, IsYUVBufferFormatTest, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, ClearChildrenCache, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, OnTreeStateChangedTest, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, UpdateSrcRectTest, TestSize.Level1)
{
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, SetIsSubSurfaceNodeTest, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, OnSubSurfaceChangedTest, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
    renderNode->nodeType_ = RSSurfaceNodeType::ABILITY_COMPONENT_NODE;
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, GetAllSubSurfaceNodesTest, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, UpdateChildSubSurfaceNodesTest, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, IsLeashWindowSurfaceNodeVisibleTest, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
    renderNode->nodeType_ = RSSurfaceNodeType::LEASH_WINDOW_NODE;
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, SetIsNodeToBeCapturedTest, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
    renderNode->stagingRenderParams_ = nullptr;
 ...
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, SetInFixedRotationTest001, TestSize.Level1)
{
 ...
 * @tc.require: issueICCYNK
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, SetInFixedRotationTest002, TestSize.Level1)
{
    auto surfaceNode = std::make_shared<RSSurfaceRenderNode>(0);
    surfaceNode->InitRenderParams();
    RectI srcRect1 { 0, 0, 10, 10 };
 ...
 * @tc.require: issueICCYNK
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, SetInFixedRotationTest003, TestSize.Level1)
{
    auto surfaceNode = std::make_shared<RSSurfaceRenderNode>(0);
    surfaceNode->InitRenderParams();
 ...
 * @tc.require: issueICCYNK
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, SetInFixedRotationTest005, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
    renderNode->stagingRenderParams_ = nullptr;
    renderNode->isFixRotationByUser_ = true;
...
/**
 * @tc.name: SetInFixedRotationTest006
 * @tc.desc: test results of SetInFixedRotation with screenChanged while not rotating
 * @tc.type: FUNC
 * @tc.require: issueICCYNK
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, SetInFixedRotationTest006, TestSize.Level1)
{
    auto surfaceNode = std::make_shared<RSSurfaceRenderNode>(0);
    surfaceNode->InitRenderParams();
    RectI srcRect1 { 0, 0, 10, 10 };
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, SetForceUIFirstTest, TestSize.Level1)
{
    auto renderNode = std::make_shared<RSSurfaceRenderNode>(0);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, AccumulateOcclusionRegion, TestSize.Level1)
{
 ...
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, AccumulateOcclusionRegion002, TestSize.Level1)
{
    auto testNode = std::make_shared<RSSurfaceRenderNode>(id, context);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, UpdateSurfaceSubTreeDirtyFlag, TestSize.Level1)
{
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, UpdateFilterCacheStatusWithVisible, TestSize.Level1)
{
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, UpdateFilterCacheStatusIfNodeStatic, TestSize.Level1)
{
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, CheckParticipateInOcclusion, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(id);
 ...
 * @tc.require: issue20843
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, CheckParticipateInOcclusion002, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(id);
    node->SetAbilityBGAlpha(255);
    node->SetGlobalAlpha(1.0f);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, GetChildrenNeedFilterRectsWithoutCacheValidTest, TestSize.Level1)
{
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, SetHwcChildrenDisabledState, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(id);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, LeashWindowRelatedAppWindowOccluded, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(id);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, IsUIFirstSelfDrawCheck, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(id);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, UpdateCacheSurfaceDirtyManager, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(id);
    int bufferAge = 1;
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, HasOnlyOneRootNode, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(id);
 ...
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, GetNodeIsSingleFrameComposer, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(id);
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, QuerySubAssignable, TestSize.Level1)
{
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, GetGravityTranslate, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(id);
    float imgWidth = 1.0f;
 ...
 * @tc.require: issueIA4VTS
 */
HWTEST_F(RSSurfaceRenderNodeUtilOneTest, UpdatePartialRenderParams, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> node = std::make_shared<RSSurfaceRenderNode>(id);
