...
class RSRenderBastUtilTest : public testing::Test {
public:
...
void RSRenderBastUtilTest::SetUpTestCase() {}
void RSRenderBastUtilTest::TearDownTestCase() {}
void RSRenderBastUtilTest::SetUp() {}
void RSRenderBastUtilTest::TearDown() {}
 ...
 */
HWTEST_F(RSRenderBastUtilTest, AddChild001, TestSize.Level1)
{
    /**
 ...
 * @tc.require: issueI5HRIF
 */
HWTEST_F(RSRenderBastUtilTest, RemoveChild001, TestSize.Level1)
{
    /**
     * @tc.steps: step1. AddChild
     */
 ...
 * @tc.require: issueI5HRIF
 */
HWTEST_F(RSRenderBastUtilTest, ClearChildren001, TestSize.Level1)
{
    /**
     * @tc.steps: step1. AddChild
     */
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, MoveChild001, TestSize.Level1)
{
    /**
     * @tc.steps: step1. AddChild
     */
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, SetIsOnTheTree001, TestSize.Level1)
{
    /**
     * @tc.steps: step1. AddChild
     */
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, AddCrossParentChild001, TestSize.Level1)
{
    /**
     * @tc.steps: step1. AddChild
     */
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, RemoveCrossParentChild001, TestSize.Level1)
{
    /**
     * @tc.steps: step1. AddChild
     */
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, SetIsOnTheTree002, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    auto childone = nullptr;
    int index = -1;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, AddCrossParentChildTest001, TestSize.Level1)
{
    int32_t index = 1;
    int32_t index_ = 0;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, RemoveCrossParentChildTest001, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    std::shared_ptr<RSBaseRenderNode> child = nullptr;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, RemoveFromTreeTest, TestSize.Level1)
{
    bool skipTransition = false;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, PrepareTest, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, RemoveModifier, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, UpdateDrawableVec, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, UpdateDrawableVecInternal, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, UpdateEffectRegion, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GetModifier, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    Drawing::Matrix matrix;
    PropertyId id = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, FilterModifiersByPid, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    pid_t pid = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, UpdateShouldPaint, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, SetSharedTransitionParam, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, SetGlobalAlpha, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, NeedInitCacheSurface, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, NeedInitCacheCompletedSurface, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GetOptionalBufferSize, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    Drawing::Matrix matrix;
    PropertyId id = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, DrawCacheSurface, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GetCompletedImage, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    Drawing::Canvas canvas;
    RSPaintFilterCanvas paintFilterCanvas(&canvas);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, UpdateBackendTexture, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GetCompletedCacheSurface, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    uint32_t threadIndex = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, ClearCacheSurfaceInThread, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GetCacheSurface, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    uint32_t threadIndex = 1;
    bool needCheckThread = false;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, CheckGroupableAnimation, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    PropertyId id = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, MarkNodeGroup, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, CheckDrawingCacheType, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id + 1, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GetFilterRectsInCache, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GetFilterRect, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    node->GetFilterRect();
    ASSERT_TRUE(true);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, OnTreeStateChanged, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, HasDisappearingTransition, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GenerateFullChildrenList, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, HasChildrenOutOfRect, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GetInstanceRootNode, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GetFirstLevelNode, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 */
HWTEST_F(RSRenderBastUtilTest, SetStaticCached, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    EXPECT_NE(node, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, UpdateSubSurfaceCnt, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderBastUtilTest, GetNodeGroupType, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 */
HWTEST_F(RSRenderBastUtilTest, IsPureContainer, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, IsContentNodeTest, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, SetContainBootAnimation, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, UpdateChildrenRect, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    RectI rect(1, 1, 1, 1);
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, SetParent, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, ResetParent, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    node->ResetParent();
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, FallbackAnimationsToRoot, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, ActivateDisplaySync, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, UpdateDisplaySyncRange, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, Animate, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
    int64_t timestamp = 4;
    int64_t period = 2;
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, Update, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
 ...
 * @tc.require: issueI9KBCZ
 */
HWTEST_F(RSRenderBastUtilTest, UpdateBufferDirtyRegion, TestSize.Level1)
{
    auto node = std::make_shared<RSBaseRenderNode>(id, context);
