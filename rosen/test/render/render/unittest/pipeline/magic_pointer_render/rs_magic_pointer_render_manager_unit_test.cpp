...
class RSMagicPointerRenderManagerUnitTest : public testing::Test {
public:
...
std::shared_ptr<RenderContext> RSMagicPointerRenderManagerUnitTest::renderContext_ = std::make_shared<RenderContext>();

void RSMagicPointerRenderManagerUnitTest::SetUpTestCase()
{
...
void RSMagicPointerRenderManagerUnitTest::TearDownTestCase()
{
    renderContext_ = nullptr;
}
void RSMagicPointerRenderManagerUnitTest::SetUp() {}
void RSMagicPointerRenderManagerUnitTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RSMagicPointerRenderManagerUnitTest, SetPointerColorInversionConfig01, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSMagicPointerRenderManagerUnitTest, SetPointerColorInversionEnabled01, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSMagicPointerRenderManagerUnitTest, RegisterPointerLuminanceChangeCallback01, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSMagicPointerRenderManagerUnitTest, ColorPickerWithImage01, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSMagicPointerRenderManagerUnitTest, ColorPickerWithoutImage01, TestSize.Level1)
{
    const Drawing::ImageInfo info =
    Drawing::ImageInfo{200, 200, Drawing::COLORTYPE_N32, Drawing::ALPHATYPE_OPAQUE };
    auto surface = Drawing::Surface::MakeRaster(info);
