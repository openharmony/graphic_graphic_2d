...
class RSRenderServiceClientTest : public testing::Test {
public:
...
void RSRenderServiceClientTest::SetUpTestCase()
{
    rsClient = std::make_shared<RSRenderServiceClient>();
}
void RSRenderServiceClientTest::TearDownTestCase() {}
void RSRenderServiceClientTest::SetUp() {}
void RSRenderServiceClientTest::TearDown()
{
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderServiceClientTest, CreateNode_Test, TestSize.Level1)
{
 ...
 * @tc.require: I6X9V1
 */
HWTEST_F(RSRenderServiceClientTest, TakeSurfaceCapture_Test, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderServiceClientTest, TakeSurfaceCapture_Nullptr, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
    RSSurfaceCaptureConfig captureConfig;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderServiceClientTest, TakeSurfaceCapture01, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
    RSSurfaceCaptureConfig captureConfig;
 ...
 * @tc.require: IB2O0L
 */
HWTEST_F(RSRenderServiceClientTest, SetHwcNodeBounds_Test, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderServiceClientTest, RegisterBufferAvailableListener_True, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderServiceClientTest, RegisterBufferAvailableListener_False, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
    BufferAvailableCallback cb = [](){};
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderServiceClientTest, RegisterBufferAvailableListener_Nullptr, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderServiceClientTest, UnregisterBufferAvailableListener_False, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
    BufferAvailableCallback cb = [](){};
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderServiceClientTest, RegisterApplicationAgent_Nullptr, TestSize.Level1)
{
 ...
 */
HWTEST_F(RSRenderServiceClientTest, CreateVirtualScreen, TestSize.Level2)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 */
HWTEST_F(RSRenderServiceClientTest, SetVirtualScreenUsingStatus001, TestSize.Level2)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issueI9ABGS
 */
HWTEST_F(RSRenderServiceClientTest, SetVirtualScreenUsingStatus002, TestSize.Level2)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issueI9ABGS
 */
HWTEST_F(RSRenderServiceClientTest, SetCurtainScreenUsingStatus001, TestSize.Level2)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issueI9ABGS
 */
HWTEST_F(RSRenderServiceClientTest, SetCurtainScreenUsingStatus002, TestSize.Level2)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 */
HWTEST_F(RSRenderServiceClientTest, ExecuteSynchronousTask001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetUniRenderEnabled001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetMemoryGraphic001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetTotalAppMemSize001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
    float cpuMemSize = 0;
    float gpuMemSize = 0;
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, CreateNodeAndSurface001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, CreatePixelMapFromSurfaceId001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, SetFocusAppInfo001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetActiveScreenId001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetAllScreenIds001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
    auto csurface = IConsumerSurface::Create();
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, SetVirtualScreenSurface001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
    auto csurface = IConsumerSurface::Create();
    ASSERT_NE(csurface, nullptr);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, SetScreenChangeCallback001, TestSize.Level1)
{
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, SetPointerColorInversionConfig001, TestSize.Level1)
{
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, SetPointerColorInversionEnabled001, TestSize.Level1)
{
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, RegisterPointerLuminanceChangeCallback001, TestSize.Level1)
{
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, UnRegisterPointerLuminanceChangeCallback001, TestSize.Level1)
{
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, SetScreenActiveMode001, TestSize.Level1)
{
 ...
 */
HWTEST_F(RSRenderServiceClientTest, SetScreenActiveRect001, Function | SmallTest | Level2)
{
    auto screenId = rsClient->GetDefaultScreenId();
    EXPECT_NE(screenId, INVALID_SCREEN_ID);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, SetScreenRefreshRate001, TestSize.Level1)
{
    auto screenId = rsClient->GetDefaultScreenId();
    EXPECT_NE(screenId, INVALID_SCREEN_ID);
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderServiceClientTest, UnregisterFrameRateLinker001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
    FrameRateLinkerId id = 0;
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, SetRefreshRateMode001, TestSize.Level1)
{
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetScreenSupportedRefreshRates001, TestSize.Level1)
{
    auto screenId = rsClient->GetDefaultScreenId();
    EXPECT_NE(screenId, INVALID_SCREEN_ID);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetRefreshInfo001, TestSize.Level1)
{
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, SetVirtualScreenResolution001, TestSize.Level1)
{
    auto csurface = IConsumerSurface::Create();
    EXPECT_NE(csurface, nullptr);
    auto producer = csurface->GetProducer();
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, SetScreenPowerStatus001, TestSize.Level1)
{
    auto screenId = rsClient->GetDefaultScreenId();
    EXPECT_NE(screenId, INVALID_SCREEN_ID);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetScreenSupportedModes001, TestSize.Level1)
{
    auto screenId = rsClient->GetDefaultScreenId();
    EXPECT_NE(screenId, INVALID_SCREEN_ID);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetScreenCapability001, TestSize.Level1)
{
    auto screenId = rsClient->GetDefaultScreenId();
    EXPECT_NE(screenId, INVALID_SCREEN_ID);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetScreenData001, TestSize.Level1)
{
    auto screenId = rsClient->GetDefaultScreenId();
    EXPECT_NE(screenId, INVALID_SCREEN_ID);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, GetScreenBacklight001, TestSize.Level1)
{
    auto screenId = rsClient->GetDefaultScreenId();
    EXPECT_NE(screenId, INVALID_SCREEN_ID);
 ...
 * @tc.require: issuesI9K7SJ
 */
HWTEST_F(RSRenderServiceClientTest, RegisterBufferClearListener001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 * @tc.require: issuesI9K7SJ
*/
HWTEST_F(RSRenderServiceClientTest, GetScreenSupportedColorGamuts001, TestSize.Level1)
{
 ...
 * @tc.require: issuesI9K7SJ
*/
HWTEST_F(RSRenderServiceClientTest, GetScreenSupportedMetaDataKeys001, TestSize.Level1)
{
    auto screenId = rsClient->GetDefaultScreenId();
    EXPECT_NE(screenId, INVALID_SCREEN_ID);
 ...
 * @tc.require: issuesI9K7SJ
*/
HWTEST_F(RSRenderServiceClientTest, GetScreenColorGamut001, TestSize.Level1)
{
    auto csurface = IConsumerSurface::Create();
    EXPECT_NE(csurface, nullptr);
    auto producer = csurface->GetProducer();
 ...
 * @tc.require: issuesI9K7SJ
*/
HWTEST_F(RSRenderServiceClientTest, SetScreenGamutMap001, TestSize.Level1)
{
 ...
 * @tc.require: issuesI9K7SJ
*/
HWTEST_F(RSRenderServiceClientTest, SetScreenCorrection001, TestSize.Level1)
{
    ScreenId screenId = rsClient->GetDefaultScreenId();
 ...
 * @tc.require: issuesI9K7SJ
*/
HWTEST_F(RSRenderServiceClientTest, SetVirtualMirrorScreenCanvasRotation001, TestSize.Level1)
{
    auto csurface = IConsumerSurface::Create();
    EXPECT_NE(csurface, nullptr);
    auto producer = csurface->GetProducer();
 ...
 * @tc.require: issuesI9K7SJ
*/
HWTEST_F(RSRenderServiceClientTest, SetVirtualMirrorScreenScaleMode001, TestSize.Level1)
{
    auto csurface = IConsumerSurface::Create();
    EXPECT_NE(csurface, nullptr);
    auto producer = csurface->GetProducer();
 ...
 * @tc.require: issuesI9K7SJ
*/
HWTEST_F(RSRenderServiceClientTest, SetGlobalDarkColorMode001, TestSize.Level1)
{
 ...
 */
HWTEST_F(RSRenderServiceClientTest, RegisterUIExtensionCallback_001, TestSize.Level1)
{
 ...
 * @tc.require: issueIABHAX
 */
HWTEST_F(RSRenderServiceClientTest, RegisterUIExtensionCallback_002, TestSize.Level1)
{
 ...
 */
HWTEST_F(RSRenderServiceClientTest, SetFreeMultiWindowStatus, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
 ...
 */
HWTEST_F(RSRenderServiceClientTest, SetLayerTop001, TestSize.Level1)
{
    ASSERT_NE(rsClient, nullptr);
