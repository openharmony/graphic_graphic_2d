...
class RSUniPrevalidateUtilUnitTest : public testing::Test {
public:
...
void RSUniPrevalidateUtilUnitTest::SetUpTestCase()
{
    RSTestUtil::InitRenderNodeGC();
}
void RSUniPrevalidateUtilUnitTest::TearDownTestCase() {}
void RSUniPrevalidateUtilUnitTest::SetUp() {}
void RSUniPrevalidateUtilUnitTest::TearDown() {}
 ...
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, CreateSurfaceNodeLayerInfo001, TestSize.Level1)
{
 ...
 * @tc.require: issueIAZAWR
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, CreateSurfaceNodeLayerInfo002, TestSize.Level1)
{
    auto& uniHwcPrevalidateUtil = RSUniHwcPrevalidateUtil::GetInstance();
 ...
 * @tc.require: issueIAZAWR
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, IsYUVBufferFormat001, TestSize.Level1)
{
    auto& uniHwcPrevalidateUtil = RSUniHwcPrevalidateUtil::GetInstance();
 ...
 * @tc.require: issueIAZAWR
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, IsYUVBufferFormat002, TestSize.Level1)
{
    auto& uniHwcPrevalidateUtil = RSUniHwcPrevalidateUtil::GetInstance();
    auto surfaceNode = RSTestUtil::CreateSurfaceNodeWithBuffer();
 ...
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, CreateDisplayNodeLayerInfo001, TestSize.Level1)
{
    auto& uniHwcPrevalidateUtil = RSUniHwcPrevalidateUtil::GetInstance();
 ...
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, CreateDisplayNodeLayerInfo002, TestSize.Level1)
{
    auto& uniHwcPrevalidateUtil = RSUniHwcPrevalidateUtil::GetInstance();
    ScreenInfo screenInfo;
 ...
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, CreateRCDLayerInfo001, TestSize.Level1)
{
    auto& uniHwcPrevalidateUtil = RSUniHwcPrevalidateUtil::GetInstance();
    ScreenInfo screenInfo;
    RequestLayerInfo info;
 ...
 * @tc.require: issueI60QXK
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, CreateRCDLayerInfo002, TestSize.Level1)
{
    auto& uniHwcPrevalidateUtil = RSUniHwcPrevalidateUtil::GetInstance();
    NodeId id = 1;
 ...
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, IsPrevalidateEnable001, TestSize.Level1)
{
    auto& uniHwcPrevalidateUtil = RSUniHwcPrevalidateUtil::GetInstance();
 ...
 * @tc.require: issueIATEBN
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, CheckHwcNodeAndGetPointerWindow001, TestSize.Level1)
{
 ...
 * @tc.require: issueIATEBN
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, CheckHwcNodeAndGetPointerWindow002, TestSize.Level1)
{
 ...
 * @tc.require: issueIATEBN
 */
HWTEST_F(RSUniPrevalidateUtilUnitTest, CheckHwcNodeAndGetPointerWindow003, TestSize.Level1)
{
    std::shared_ptr<RSSurfaceRenderNode> hwcNode = RSTestUtil::CreateSurfaceNode();
    std::shared_ptr<RSSurfaceRenderNode> pointerWindow = nullptr;
    hwcNode->isOnTheTree_ = true;
