...
class RSCanvasDrawingRenderNodeUnitTest : public testing::Test {
public:
...
void RSCanvasDrawingRenderNodeUnitTest::SetUpTestCase()
{
    canvas_ = new RSPaintFilterCanvas(&drawingCanvas_);
}
void RSCanvasDrawingRenderNodeUnitTest::TearDownTestCase()
{
    if (canvas_) {
        delete canvas_;
        canvas_ = nullptr;
...
void RSCanvasDrawingRenderNodeUnitTest::SetUp() {}
void RSCanvasDrawingRenderNodeUnitTest::TearDown() {}
 ...
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, IsNeedProcessTest, TestSize.Level1)
{
    NodeId nodeId = 3;
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, SetNeedProcessTest, TestSize.Level1)
{
    NodeId nodeId = 4;
    auto rsCanvasDrawingRenderNode = std::make_shared<RSCanvasDrawingRenderNode>(nodeId);
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, GetTidTest, TestSize.Level1)
{
    NodeId nodeId = 5;
    auto rsCanvasDrawingRenderNode = std::make_shared<RSCanvasDrawingRenderNode>(nodeId);
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, GetImageTest, TestSize.Level1)
{
    NodeId nodeId = 6;
    auto rsCanvasDrawingRenderNode = std::make_shared<RSCanvasDrawingRenderNode>(nodeId);
    uint64_t tid = 1;
 ...
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, CheckCanvasDrawingPostPlaybackedTest, TestSize.Level1)
{
    NodeId nodeId = 7;
    auto rsCanvasDrawingRenderNode = std::make_shared<RSCanvasDrawingRenderNode>(nodeId);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ApplyCachedCmdListTest, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ApplyModifiersTest, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, CheckCachedOpTest, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ContentStyleSlotUpdateTest001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ContentStyleSlotUpdateTest003, TestSize.Level1)
{
    auto node = std::make_shared<RSCanvasDrawingRenderNode>(12);
    node->dirtyTypesNG_.set(static_cast<int>(ModifierNG::RSModifierType::CONTENT_STYLE), true);
    node->SetWaitSync(false);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ContentStyleSlotUpdateTest004, TestSize.Level1)
{
    auto node = std::make_shared<RSCanvasDrawingRenderNode>(12);
    node->dirtyTypesNG_.set(static_cast<int>(ModifierNG::RSModifierType::CONTENT_STYLE), true);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ContentStyleSlotUpdateTest005, TestSize.Level1)
{
    auto node = std::make_shared<RSCanvasDrawingRenderNode>(12);
    node->dirtyTypesNG_.set(static_cast<int>(ModifierNG::RSModifierType::CONTENT_STYLE), true);
    node->SetWaitSync(false);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ContentStyleSlotUpdateTest006, TestSize.Level1)
{
    auto node = std::make_shared<RSCanvasDrawingRenderNode>(12);
    node->dirtyTypesNG_.set(static_cast<int>(ModifierNG::RSModifierType::CONTENT_STYLE), true);
    node->SetWaitSync(false);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ContentStyleSlotUpdateTest007, TestSize.Level1)
{
    auto node = std::make_shared<RSCanvasDrawingRenderNode>(12);
    node->dirtyTypesNG_.set(static_cast<int>(ModifierNG::RSModifierType::CONTENT_STYLE), true);
    node->SetWaitSync(false);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ContentStyleSlotUpdateTest008, TestSize.Level1)
{
    auto node = std::make_shared<RSCanvasDrawingRenderNode>(12);
    node->dirtyTypesNG_.set(static_cast<int>(ModifierNG::RSModifierType::CONTENT_STYLE), true);
    node->SetWaitSync(false);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ContentStyleSlotUpdateTest009, TestSize.Level1)
{
    auto node = std::make_shared<RSCanvasDrawingRenderNode>(12);
    node->dirtyTypesNG_.set(static_cast<int>(ModifierNG::RSModifierType::CONTENT_STYLE), true);
    node->SetWaitSync(false);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, SplitDrawCmdListTest, TestSize.Level1)
{
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ProcessRenderContentsOtherTest, TestSize.Level1)
{
    NodeId nodeId = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ResetSurfaceTest001, TestSize.Level1)
{
    int width = 0;
    int height = 0;
    NodeId nodeId = 1;
 ...
 * @tc.require: #ICDBD1
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ResetSurfaceTest002, TestSize.Level1)
{
    int width = 0;
    int height = 0;
    NodeId nodeId = 1;
    ...
    ASSERT_EQ(stagingRenderParams->surfaceParams_.colorSpace,
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, GetSizeFromDrawCmdModifiersTest001, TestSize.Level1)
{
    int32_t width = 0;
    int32_t height = 0;
    NodeId nodeId = 1;
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, IsNeedResetSurfaceTest, TestSize.Level1)
{
    NodeId nodeId = 1;
    std::weak_ptr<RSContext> context;
    RSCanvasDrawingRenderNode rsCanvasDrawingRenderNode(nodeId, context);
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, InitRenderParamsTest, TestSize.Level1)
{
    NodeId nodeId = 1;
    auto rsCanvasDrawingRenderNode = std::make_shared<RSCanvasDrawingRenderNode>(nodeId);
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, GetBitmap, TestSize.Level1)
{
    NodeId nodeId = 1;
    std::weak_ptr<RSContext> context;
    RSCanvasDrawingRenderNode rsCanvasDrawingRenderNode(nodeId, context);
 ...
 * @tc.require:
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, GetPixelmap, TestSize.Level1)
{
    NodeId nodeId = 1;
    std::weak_ptr<RSContext> context;
    RSCanvasDrawingRenderNode rsCanvasDrawingRenderNode(nodeId, context);
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, GetPixelmapSurfaceImgValidTest, TestSize.Level1)
{
    uint64_t tid = 1;
    NodeId nodeId = 2;
    auto rsCanvasDrawingRenderNode = std::make_shared<RSCanvasDrawingRenderNode>(nodeId);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, AddDirtyTypeTest, TestSize.Level1)
{
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ResetSurface, TestSize.Level1)
{
    NodeId nodeId = 1;
    std::weak_ptr<RSContext> context;
    int width = 1;
 ...
 * @tc.require: issueI9W0GK
 */
HWTEST_F(RSCanvasDrawingRenderNodeUnitTest, ResetSurfaceWithTextureTest, TestSize.Level1)
{
#if (defined(RS_ENABLE_GL) || defined(RS_ENABLE_VK))
    NodeId nodeId = 2;
    auto rsCanvasDrawingRenderNode = std::make_shared<RSCanvasDrawingRenderNode>(nodeId);
