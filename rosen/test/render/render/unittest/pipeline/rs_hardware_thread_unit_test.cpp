...
class RSHardwareThreadUnitTest : public testing::Test {
public:
...
void RSHardwareThreadUnitTest::SetUpTestCase()
{
...
void RSHardwareThreadUnitTest::TearDownTestCase() {}
void RSHardwareThreadUnitTest::TearDown()
{
...
void RSHardwareThreadUnitTest::SetUp()
{
    screenManager_ = OHOS::Rosen::impl::RSScreenManager::GetInstance();
...
void RSHardwareThreadUnitTest::CreateComposerAdapterWithScreenInfo(uint32_t width, uint32_t height,
 ...
 * @tc.desc: Test RSHardwareThreadUnitTest.ClearFrameBuffers
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, ClearFrameBuffers001, TestSize.Level1)
{
...
/**
 * @tc.name: Start001
 * @tc.desc: Test RSHardwareThreadUnitTest.Start
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, Start001, TestSize.Level1)
{
    auto& hardwareThread = RSHardwareThread::Instance();
...
/**
 * @tc.name: Start002
 * @tc.desc: Test RSHardwareThreadUnitTest.PostTask
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, Start002, TestSize.Level1)
{
    auto& hardwareThread = RSHardwareThread::Instance();
...
/**
 * @tc.name: Start003
 * @tc.desc: Test RSHardwareThreadUnitTest.CommitAndReleaseLayers
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, Start003, TestSize.Level1)
{
    auto& hardwareThread = RSHardwareThread::Instance();
    hardwareThread.Start();
    SetUp();
...
/**
 * @tc.name: Start004
 * @tc.desc: Test RSHardwareThreadUnitTest.ReleaseBuffer
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, Start004, TestSize.Level1)
{
...
/**
 * @tc.name: Start005
 * @tc.desc: Test RSHardwareThreadUnitTest.AddRefreshRateCount
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, Start005, TestSize.Level1)
{
 ...
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, ClearFrameBuffers002, TestSize.Level1)
{
    auto& hardwareThread = RSHardwareThread::Instance();
 ...
 * @tc.desc: Test RSHardwareThreadUnitTest.IsDelayRequired
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, IsDelayRequired001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    auto &hgmCore = HgmCore::Instance();
 ...
 * @tc.desc: Test RSHardwareThreadUnitTest.CalculateDelayTime
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, CalculateDelayTime001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    auto &hgmCore = HgmCore::Instance();
    RefreshRateParam param = {
 ...
 * @tc.desc: Test RSHardwareThreadUnitTest.RecordTimestamp
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, RecordTimestamp, TestSize.Level1)
{
    auto& hardwareThread = RSHardwareThread::Instance();
    auto surfaceNode1 = RSTestUtil::CreateSurfaceNodeWithBuffer();
    auto surfaceNode2 = RSTestUtil::CreateSurfaceNodeWithBuffer();
 ...
 * @tc.desc: Test RSHardwareThreadUnitTest.ExecuteSwitchRefreshRate
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, ExecuteSwitchRefreshRate, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    OutputPtr output = HdiOutput::CreateHdiOutput(screenId_);
 ...
 * @tc.desc: Test RSHardwareThreadUnitTest.PerformSetActiveMode
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, PerformSetActiveMode, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    OutputPtr output = HdiOutput::CreateHdiOutput(screenId_);
    ASSERT_NE(output, nullptr);
 ...
 * @tc.desc: Test RSHardwareThreadUnitTest.OnPrepareComplete
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, OnPrepareComplete, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
 ...
 * @tc.desc: Test RSHardwareThreadUnitTest.CreateFrameBufferSurfaceOhos
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, CreateFrameBufferSurfaceOhos, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    auto csurface = IConsumerSurface::Create();
    ASSERT_NE(csurface, nullptr);
...
/*
* @tc.name: PreAllocateProtectedBuffer001
* @tc.desc: Test RSHardwareThreadUnitTest.PreAllocateProtectedBuffer001
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, PreAllocateProtectedBuffer001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    auto rsSurfaceRenderNode = RSTestUtil::CreateSurfaceNode();
    const auto& surfaceConsumer = rsSurfaceRenderNode->GetRSSurfaceHandler()->GetConsumer();
 ...
 * @tc.desc: Test RSHardwareThreadUnitTest.DumpEventQueue
 * @tc.type: FUNC
 * @tc.require: issueIC511I
 */
HWTEST_F(RSHardwareThreadUnitTest, DumpEventQueue001, TestSize.Level1)
{
    auto& hardwareThread = RSHardwareThread::Instance();
    hardwareThread.PostTask([&]() {});
    hardwareThread.Start();
...
#ifdef RS_ENABLE_VK
/*
* @tc.name: ComputeTargetColorGamut001
* @tc.desc: Test RSHardwareThreadUnitTest.ComputeTargetColorGamut001
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, ComputeTargetColorGamut001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    auto rsSurfaceRenderNode = RSTestUtil::CreateSurfaceNode();
    const auto& surfaceConsumer = rsSurfaceRenderNode->GetRSSurfaceHandler()->GetConsumer();
...
/*
* @tc.name: ComputeTargetColorGamut002
* @tc.desc: Test RSHardwareThreadUnitTest.ComputeTargetColorGamut002
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, ComputeTargetColorGamut002, TestSize.Level1)
{
    auto rsSurfaceRenderNode = RSTestUtil::CreateSurfaceNode();
    const auto& surfaceConsumer = rsSurfaceRenderNode->GetRSSurfaceHandler()->GetConsumer();
    auto producer = surfaceConsumer->GetProducer();
...
/*
* @tc.name: ComputeTargetPixelFormat001
* @tc.desc: Test RSHardwareThreadUnitTest.ComputeTargetPixelFormat001
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, ComputeTargetPixelFormat001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    auto rsSurfaceRenderNode = RSTestUtil::CreateSurfaceNode();
    const auto& surfaceConsumer = rsSurfaceRenderNode->GetRSSurfaceHandler()->GetConsumer();
...
* @tc.desc: Test RSHardwareThreadUnitTest.ChangeLayersForActiveRectOutside
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, ChangeLayersForActiveRectOutside001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    std::vector<LayerInfoPtr> layers;
...
* @tc.desc: Test RSHardwareThreadUnitTest.ClearRedrawGPUCompositionCache
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, ClearRedrawGPUCompositionCache001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    hardwareThread.Start();
    ASSERT_NE(hardwareThread.hdiBackend_, nullptr);
...
* @tc.desc: Test RSHardwareThreadUnitTest.RefreshRateCounts
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, RefreshRateCounts001, TestSize.Level1)
{
    OutputPtr output = HdiOutput::CreateHdiOutput(screenId_);
    auto &hardwareThread = RSHardwareThread::Instance();
    auto count = hardwareThread.refreshRateCounts_;
...
* @tc.desc: Test RSHardwareThreadUnitTest.ClearRefreshRateCounts
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, ClearRefreshRateCounts001, TestSize.Level1)
{
    OutputPtr output = HdiOutput::CreateHdiOutput(screenId_);
    auto &hardwareThread = RSHardwareThread::Instance();
    auto count = hardwareThread.refreshRateCounts_;
...
* @tc.desc: Test RSHardwareThreadUnitTest.OnScreenVBlankIdleCallback
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, OnScreenVBlankIdleCallback001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    hardwareThread.Start();
    ASSERT_NE(hardwareThread.hdiBackend_, nullptr);
...
* @tc.desc: Test RSHardwareThreadUnitTest.ChangeDssRefreshRate
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, ChangeDssRefreshRate001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    hardwareThread.Start();
    ASSERT_NE(hardwareThread.hdiBackend_, nullptr);
...
* @tc.desc: Test RSHardwareThreadUnitTest.RedrawScreenRCD
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, RedrawScreenRCD001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    hardwareThread.Start();
...
/*
* @tc.name: Redraw001
* @tc.desc: Test RSHardwareThreadUnitTest.Redraw
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, Redraw001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
    auto csurface = IConsumerSurface::Create();
    ASSERT_NE(csurface, nullptr);
...
/*
* @tc.name: EndCheck001
* @tc.desc: Test RSHardwareThreadUnitTest.EndCheck
* @tc.type: FUNC
* @tc.require: issueIC511I
*/
HWTEST_F(RSHardwareThreadUnitTest, EndCheck001, TestSize.Level1)
{
    auto &hardwareThread = RSHardwareThread::Instance();
