...
/**
 * @tc.name: SetScaleReferenceSizeExtTest
 * @tc.desc: Test SetScaleReferenceSize
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimatRateDeciderTest, SetScaleReferenceSizeExtTest, TestSize.Level1)
{
...
/**
 * @tc.name: SetEnableExtTest
 * @tc.desc: Test SetEnable
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimatRateDeciderTest, SetEnableExtTest, TestSize.Level1)
{
    RSAnimationRateDecider rsAnimationRateDecider;
    bool enabled = true;
...
/**
 * @tc.name: AddDecisionElementExtTest
 * @tc.desc: Test AddDecisionElement
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimatRateDeciderTest, AddDecisionElementExtTest, TestSize.Level1)
{
    RSAnimationRateDecider rsAnimationRateDecider;
    PropertyId id = 0;
...
/**
 * @tc.name: ResetExtTest
 * @tc.desc: Test Reset
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimatRateDeciderTest, ResetExtTest, TestSize.Level1)
{
    RSAnimationRateDecider rsAnimationRateDecider;
...
/**
 * @tc.name: GetFrameRateRangeExtTest
 * @tc.desc: Test GetFrameRateRange
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimatRateDeciderTest, GetFrameRateRangeExtTest, TestSize.Level1)
{
    RSAnimationRateDecider rsAnimationRateDecider;
...
/**
 * @tc.name: MakeDecisionExtTest
 * @tc.desc: Test MakeDecision
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimatRateDeciderTest, MakeDecisionExtTest, TestSize.Level1)
{
...
/**
 * @tc.name: ProcessVector4fSingelTest
 * @tc.desc: Test ProcessVector4f
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimatRateDeciderTest, ProcessVector4fSingelTest, TestSize.Level1)
{
    RSAnimationRateDecider rsAnimationRateDecider;
...
/**
 * @tc.name: CalculatePreferredRateSingelTest
 * @tc.desc: Test CalculatePreferredRate
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimatRateDeciderTest, CalculatePreferredRateSingelTest, TestSize.Level1)
{
    RSAnimationRateDecider rsAnimationRateDecider;
    auto frameRateGetFunc = [this](const RSPropertyUnit unit, float velocity) -> int32_t{
        return 0;
...
/**
 * @tc.name: ProcessVector2fSingelTest
 * @tc.desc: Test ProcessVector2f
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimatRateDeciderTest, ProcessVector2fSingelTest, TestSize.Level1)
{
    RSAnimationRateDecider rsAnimationRateDecider;
    PropertyValue property = std::make_shared<RSRenderAnimatableProperty<float>>(
        0.0, 1, RSRenderPropertyType::PROPERTY_FLOAT, RSPropertyUnit::PIXEL_POSITION);
...
/**
 * @tc.name: ProcessFloatSingelTest
 * @tc.desc: Test ProcessFloat
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimatRateDeciderTest, ProcessFloatSingelTest, TestSize.Level1)
{
    RSAnimationRateDecider rsAnimationRateDecider;
    PropertyValue property = std::make_shared<RSRenderAnimatableProperty<float>>(
        0.0, 1, RSRenderPropertyType::PROPERTY_FLOAT, RSPropertyUnit::PIXEL_POSITION);
