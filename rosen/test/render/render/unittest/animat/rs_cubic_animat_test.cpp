...
void RSCubicBezierInterpolatorExtTest::SetUpTestCase() {}
void RSCubicBezierInterpolatorExtTest::TearDownTestCase() {}
void RSCubicBezierInterpolatorExtTest::SetUp() {}
void RSCubicBezierInterpolatorExtTest::TearDown() {}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCubicBezierInterpolatorExtTest, MarshallingExtTest, TestSize.Level1)
{
    float ctlX1 = 0.f;
    float ctlY1 = 0.f;
    float ctlX2 = 0.f;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCubicBezierInterpolatorExtTest, InterpolateImplExtTest, TestSize.Level1)
{
    float ctlX1 = 0.f;
    float ctlY1 = 0.f;
    float ctlX2 = 0.f;
...
/**
 * @tc.name: BinarySearchExtTest
 * @tc.desc: test results of BinarySearch
 * @tc.type: FUNC
 */
HWTEST_F(RSCubicBezierInterpolatorExtTest, BinarySearchExtTest, TestSize.Level1)
{
    float ctlX1 = 0.f;
    float ctlY1 = 0.f;
    float ctlX2 = 0.f;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCubicBezierInterpolatorExtTest, UnmarshallingExtTest, TestSize.Level1)
{
    float ctlX1 = 0.f;
    float ctlY1 = 0.f;
    float ctlX2 = 0.f;
