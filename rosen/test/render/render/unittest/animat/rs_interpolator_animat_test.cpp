...
/**
 * @tc.name: UnmarshallingSingleTest
 * @tc.desc: test results of Unmarshalling
 * @tc.type: FUNC
 */
HWTEST_F(LinearInterpolatorSingleTest, UnmarshallingSingleTest, TestSize.Level1)
{
    uint64_t id = 0;
...
/**
 * @tc.name: MarshallingSingleTest
 * @tc.desc: test results of Marshalling
 * @tc.type: FUNC
 */
HWTEST_F(LinearInterpolatorSingleTest, MarshallingSingleTest, TestSize.Level1)
{
    uint64_t id = 0;
    LinearInterpolator linearInterpolator(id);
    Parcel parcel;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCustomInterpolatorSingleTest, UnmarshallingSingleTest, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSCustomInterpolatorSingleTest, MarshallingSingleTest, TestSize.Level1)
{
    std::function<float(float)> func;
    int duration = 0;
    RSCustomInterpolator rsCustomInterpolator(func, duration);
...
/**
 * @tc.name: ConvertSingleTest
 * @tc.desc: test results of Convert
 * @tc.type: FUNC
 */
HWTEST_F(RSCustomInterpolatorSingleTest, ConvertSingleTest, TestSize.Level1)
{
    std::function<float(float)> func;
    int duration = 0;
    RSCustomInterpolator rsCustomInterpolator(func, duration);
