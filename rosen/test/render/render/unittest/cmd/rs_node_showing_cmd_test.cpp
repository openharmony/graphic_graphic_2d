...
class RSNodeGetShowingPropertyAndCancelAnimatUniTest : public testing::Test {
public:
...
void RSNodeGetShowingPropertyAndCancelAnimatUniTest::SetUpTestCase() {}
void RSNodeGetShowingPropertyAndCancelAnimatUniTest::TearDownTestCase() {}
void RSNodeGetShowingPropertyAndCancelAnimatUniTest::SetUp() {}
void RSNodeGetShowingPropertyAndCancelAnimatUniTest::TearDown() {}

class RSNodeGetShowingPropertiesAndCancelAnimatUniTest : public testing::Test {
public:
    static void SetUpTestCase();
    static void TearDownTestCase();
    void SetUp() override;
...
void RSNodeGetShowingPropertiesAndCancelAnimatUniTest::SetUpTestCase() {}
void RSNodeGetShowingPropertiesAndCancelAnimatUniTest::TearDownTestCase() {}
void RSNodeGetShowingPropertiesAndCancelAnimatUniTest::SetUp() {}
void RSNodeGetShowingPropertiesAndCancelAnimatUniTest::TearDown() {}

/**
 * @tc.name: UnmarshallingUniTest001
 * @tc.desc: test results of Unmarshalling
 * @tc.type: FUNC
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSNodeGetShowingPropertyAndCancelAnimatUniTest, UnmarshallingUniTest001, TestSize.Level1)
{
    NodeId targetId = 0;
    Parcel parcel;
...
/**
 * @tc.name: MarshallingUniTest001
 * @tc.desc: test results of Marshalling
 * @tc.type: FUNC
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSNodeGetShowingPropertyAndCancelAnimatUniTest, MarshallingUniTest001, TestSize.Level1)
{
    NodeId targetId = 0;
    Parcel parcel;
    auto property = std::make_shared<RSRenderPropertyBase>();
...
/**
 * @tc.name: ReadFromParcelUniTest001
 * @tc.desc: test results of ReadFromParcel
 * @tc.type: FUNC
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSNodeGetShowingPropertyAndCancelAnimatUniTest, ReadFromParcelUniTest001, TestSize.Level1)
{
    NodeId targetId = 0;
    Parcel parcel;
    auto property = std::make_shared<RSRenderPropertyBase>();
...
/**
 * @tc.name: CheckHeaderUniTest001
 * @tc.desc: test results of CheckHeader
 * @tc.type: FUNC
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSNodeGetShowingPropertyAndCancelAnimatUniTest, CheckHeaderUniTest001, TestSize.Level1)
{
    NodeId targetId = 0;
    Parcel parcel;
    auto property = std::make_shared<RSRenderPropertyBase>();
 ...
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSNodeGetShowingPropertiesAndCancelAnimatUniTest, MarshallingUniTest001, TestSize.Level1)
{
...
/**
 * @tc.name: ProcessUniTest001
 * @tc.desc: test results of Process
 * @tc.type: FUNC
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSNodeGetShowingPropertyAndCancelAnimatUniTest, ProcessUniTest001, TestSize.Level1)
{
    RSContext context;
    NodeId targetId = 0;
    PropertyId id = 0;
 ...
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSNodeGetShowingPropertiesAndCancelAnimatUniTest, CheckHeaderUniTest001, TestSize.Level1)
{
    uint64_t timeoutNS = 0;
    Parcel parcel;
    RSNodeGetShowingPropertiesAndCancelAnimation animation(timeoutNS);
 ...
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSNodeGetShowingPropertiesAndCancelAnimatUniTest, UnmarshallingUniTest001, TestSize.Level1)
{
    uint64_t timeoutNS = 0;
    Parcel parcel;
    RSNodeGetShowingPropertiesAndCancelAnimation animation(timeoutNS);
 ...
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSNodeGetShowingPropertiesAndCancelAnimatUniTest, ProcessUniTest001, TestSize.Level1)
{
    RSContext context;
    uint64_t timeoutNS = 0;
    RSNodeGetShowingPropertiesAndCancelAnimation animation(timeoutNS);
 ...
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSNodeGetShowingPropertiesAndCancelAnimatUniTest, ReadFromParcelUniTest001, TestSize.Level1)
{
    uint64_t timeoutNS = 0;
    Parcel parcel;
    RSNodeGetShowingPropertiesAndCancelAnimation animation(timeoutNS);
...
/**
 * @tc.name: ProcessUniTest002
 * @tc.desc: test results of Process
 * @tc.type: FUNC
 * @tc.require: issueIA61E9
 */
HWTEST_F(RSNodeGetShowingPropertiesAndCancelAnimatUniTest, ProcessUniTest002, TestSize.Level1)
{
    uint64_t timeoutNS = 0;
    RSNodeGetShowingPropertiesAndCancelAnimation animation(timeoutNS);
    RSContext context;
...
/**
 * @tc.name: ProcessUniTest003
 * @tc.desc: test results of Process
 * @tc.type: FUNC
 * @tc.require: issueIA61E9
 */
HWTEST_F(RSNodeGetShowingPropertiesAndCancelAnimatUniTest, ProcessUniTest003, TestSize.Level1)
{
    RSContext context;
