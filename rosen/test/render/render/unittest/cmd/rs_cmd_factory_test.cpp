...
class RSCmdFactoryUniTest : public testing::Test {
public:
...
void RSCmdFactoryUniTest::SetUpTestCase() {}
void RSCmdFactoryUniTest::TearDownTestCase() {}
void RSCmdFactoryUniTest::SetUp() {}
void RSCmdFactoryUniTest::TearDown() {}

/**
 * @tc.name: GetUnmarshallingFuncUniTest001
 * @tc.desc: test results of GetUnmarshallingFunc
 * @tc.type: FUNC
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSCmdFactoryUniTest, GetUnmarshallingFuncUniTest001, TestSize.Level1)
{
...
/**
 * @tc.name: RegisterUniTest001
 * @tc.desc: test results of Register
 * @tc.type: FUNC
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSCmdFactoryUniTest, RegisterUniTest001, TestSize.Level1)
{
    RSCommandFactory& factory = RSCommandFactory::Instance();
