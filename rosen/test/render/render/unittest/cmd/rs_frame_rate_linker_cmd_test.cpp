...
namespace OHOS {
namespace Rosen {
class RSFrameRateLinkerCmdExtTest : public testing::Test {
public:
...
void RSFrameRateLinkerCmdExtTest::SetUpTestCase() {}
void RSFrameRateLinkerCmdExtTest::TearDownTestCase() {}
void RSFrameRateLinkerCmdExtTest::SetUp() {}
void RSFrameRateLinkerCmdExtTest::TearDown() {}

/**
 * @tc.name: DestroyExtTest001
 * @tc.desc: test results of Destroy
 * @tc.type: FUNC
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSFrameRateLinkerCmdExtTest, DestroyExtTest001, TestSize.Level1)
{
    RSContext context;
    FrameRateLinkerId linkerId = 0;
    auto& linkerMap = context.GetMutableFrameRateLinkerMap();
    RSFrameRateLinkerCmdHelper::Destroy(context, linkerId);
    ...
    RSFrameRateLinkerCmdHelper::Destroy(context, linkerId1);
    EXPECT_EQ(linkerMap.GetFrameRateLinker(linkerId1), nullptr);
}

/**
 * @tc.name: UpdateRangeExtTest002
 * @tc.desc: test results of UpdateRange
 * @tc.type: FUNC
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSFrameRateLinkerCmdExtTest, UpdateRangeExtTest002, TestSize.Level1)
{
    RSContext context;
    FrameRateLinkerId linkerId = 1;
    FrameRateRange range = { 0, 0, 0 };
    auto& linkerMap = context.GetMutableFrameRateLinkerMap();
    RSFrameRateLinkerCmdHelper::UpdateRange(context, linkerId, range, true);
...
/**
 * @tc.name: UpdateRangeExtTest001
 * @tc.desc: test results of UpdateRange
 * @tc.type: FUNC
 * @tc.require: issueI9P2KH
 */
HWTEST_F(RSFrameRateLinkerCmdExtTest, UpdateRangeExtTest001, TestSize.Level1)
{
    RSContext context;
    FrameRateLinkerId linkerId = 1;
    FrameRateRange range = { 0, 0, 0 };
    RSFrameRateLinkerCmdHelper::UpdateRange(context, linkerId, range, false);
