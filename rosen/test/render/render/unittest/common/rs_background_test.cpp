...
class RSBackgroundTest : public testing::Test {
public:
...
void RSBackgroundTest::SetUpTestCase() {}
void RSBackgroundTest::TearDownTestCase() {}
void RSBackgroundTest::SetUp() {}
void RSBackgroundTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RSBackgroundTest, PostTaskTest, TestSize.Level1)
{
 ...
 */
HWTEST_F(RSBackgroundTest, PostSyncTaskTest, TestSize.Level1)
{
    std::function<void()> func = []() -> void {};
