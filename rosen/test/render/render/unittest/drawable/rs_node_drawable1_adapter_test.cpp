...
class RSNodeDrawableAdapterTest : public testing::Test {
public:
...
class ConcreteRSNodeDrawableAdapter : public DrawableV2::RSRenderNodeDrawableAdapter {
public:
    explicit ConcreteRSNodeDrawableAdapter(std::shared_ptr<const RSRenderNode> node)
        : RSRenderNodeDrawableAdapter(std::move(node))
    {}
    void Draw(Drawing::Canvas& canvas) {}
};

void RSNodeDrawableAdapterTest::SetUpTestCase() {}
void RSNodeDrawableAdapterTest::TearDownTestCase() {}
void RSNodeDrawableAdapterTest::SetUp() {}
void RSNodeDrawableAdapterTest::TearDown() {}

/**
 * @tc.name: GetDrawableByIdExtTest
 * @tc.desc: Test GetDrawableByIdTree
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, GetDrawableByIdExtTest, TestSize.Level1)
{
    NodeId id = 1;
...
/**
 * @tc.name: OnGenerateExtTest
 * @tc.desc: Test OnGenerateTree
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, OnGenerateExtTest, TestSize.Level1)
{
    NodeId id = 0;
...
/**
 * @tc.name: DumpDrawableTreeExtTest
 * @tc.desc: Test DumpDrawableTree
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, DumpDrawableTreeExtTest, TestSize.Level1)
{
    NodeId id = 3;
    int32_t depth = 3;
    std::string out;
...
/**
 * @tc.name: OnGenerateShadowDrawableExtTest
 * @tc.desc: Test OnGenerateShadowDrawableTree
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, OnGenerateShadowDrawableExtTest, TestSize.Level1)
{
...
/**
 * @tc.name: DumpDrawableVecExtTest
 * @tc.desc: Test DumpDrawableVec
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, DumpDrawableVecExtTest, TestSize.Level1)
{
    NodeId id = 5;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(node);
...
/**
 * @tc.name: GetRenderParamsAndGetUifirstRenderParamsExtTest
 * @tc.desc: Test GetRenderParamsAndGetUifirstRenderParams
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, GetRenderParamsAndGetUifirstRenderParamsExtTest, TestSize.Level1)
{
    NodeId id = 4;
    auto node = std::make_shared<RSRenderNode>(id);
...
/**
 * @tc.name: HasFilterOrEffectExtTest
 * @tc.desc: Test HasFilterOrEffect
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, HasFilterOrEffectExtTest, TestSize.Level1)
{
    NodeId id = 7;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
...
/**
 * @tc.name: QuickRejectExtTest
 * @tc.desc: Test QuickReject
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, QuickRejectExtTest, TestSize.Level1)
{
    NodeId id = 6;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
...
/**
 * @tc.name: DrawUifirstContentChildrenExtTest
 * @tc.desc: Test DrawUifirstContentChildren
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, DrawUifirstContentChildrenExtTest, TestSize.Level1)
{
    NodeId id = 9;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
...
/**
 * @tc.name: DrawRangeImplAndRelatedExtTest
 * @tc.desc: Test DrawRangeImplAndRelated
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, DrawRangeImplAndRelatedExtTest, TestSize.Level1)
{
    NodeId id = 8;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
...
/**
 * @tc.name: DrawChildrenExtTest
 * @tc.desc: Test DrawChildren
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, DrawChildrenExtTest, TestSize.Level1)
{
    NodeId id = 11;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
...
/**
 * @tc.name: DrawContentExtTest
 * @tc.desc: Test DrawContent
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, DrawContentExtTest, TestSize.Level1)
{
    NodeId id = 10;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
...
/**
 * @tc.name: InitRenderParamsExtTest
 * @tc.desc: Test InitRenderParams
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, InitRenderParamsExtTest, TestSize.Level1)
{
    NodeId id = 13;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter =
...
/**
 * @tc.name: DrawImplExtTest
 * @tc.desc: Test DrawImpl
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, DrawImplExtTest, TestSize.Level1)
{
    NodeId id = 12;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
...
/**
 * @tc.name: DrawBackgroundWithoutFilterAndEffectExtTest
 * @tc.desc: Test DrawBackgroundWithoutFilterAndEffect
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, DrawBackgroundWithoutFilterAndEffectExtTest, TestSize.Level1)
{
    NodeId id = 15;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
...
/**
 * @tc.name: GetSkipIndexExtTest
 * @tc.desc: Test GetSkipIndex
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSNodeDrawableAdapterTest, GetSkipIndexExtTest, TestSize.Level1)
{
    NodeId id = 14;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
...
/**
 * @tc.name: GetFilterCachedRegionExtTest
 * @tc.desc: Test GetFilterCachedRegion
 * @tc.type: FUNC
 * @tc.require: issueIALKED
 */
HWTEST(RSNodeDrawableAdapterTest, GetFilterCachedRegionExtTest, TestSize.Level1)
{
    NodeId id = 19;
    auto node = std::make_shared<RSRenderNode>(id);
    std::shared_ptr<DrawableV2::RSRenderNodeDrawableAdapter> adapter =
        std::make_shared<ConcreteRSNodeDrawableAdapter>(node);
    ASSERT_NE(adapter, nullptr);
    EXPECT_EQ(adapter->GetFilterCachedRegion(), RectI());
}

/**
 * @tc.name: IsFilterCacheValidForOcclusionExtTest
 * @tc.desc: Test IsFilterCacheValidForOcclusion
 * @tc.type: FUNC
 * @tc.require: issueIALKED
 */
HWTEST(RSNodeDrawableAdapterTest, IsFilterCacheValidForOcclusionExtTest, TestSize.Level1)
{
    NodeId id = 18;
    auto node = std::make_shared<RSRenderNode>(id);
    std::shared_ptr<DrawableV2::RSRenderNodeDrawableAdapter> adapter =
