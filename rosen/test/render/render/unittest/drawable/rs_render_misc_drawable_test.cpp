...
class RSRenderMiscDrawableTest : public testing::Test {
public:
...
void RSRenderMiscDrawableTest::SetUpTestCase() {}
void RSRenderMiscDrawableTest::TearDownTestCase() {}
void RSRenderMiscDrawableTest::SetUp() {}
void RSRenderMiscDrawableTest::TearDown() {}
 ...
 */
HWTEST_F(RSRenderMiscDrawableTest, RSChildrenDrawable001, TestSize.Level1)
{
    NodeId id = 1;
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSRenderMiscDrawableTest, RSChildrenDrawable002, TestSize.Level1)
{
    NodeId id = 1;
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSRenderMiscDrawableTest, RSCustomModifierDrawable, TestSize.Level1)
{
    NodeId id = 1;
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSRenderMiscDrawableTest, RSBeginBlenderDrawable, TestSize.Level1)
{
    NodeId id = 1;
    RSRenderNode node(id);
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSRenderMiscDrawableTest, RSEndBlenderDrawable001, TestSize.Level1)
{
    NodeId id = 1;
    RSRenderNode node(id);
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSRenderMiscDrawableTest, RSEndBlenderDrawable002, TestSize.Level1)
{
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSRenderMiscDrawableTest, RSEnvFGColorDrawable001, TestSize.Level1)
{
    NodeId id = 1;
    RSRenderNode node(id);
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSRenderMiscDrawableTest, RSEnvFGColorDrawable002, TestSize.Level1)
{
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSRenderMiscDrawableTest, RSEnvFGColorStrategyDrawable001, TestSize.Level1)
{
    NodeId id = 1;
    RSRenderNode node(id);
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSRenderMiscDrawableTest, RSEnvFGColorStrategyDrawable002, TestSize.Level1)
{
 ...
 */
HWTEST_F(RSRenderMiscDrawableTest, RSCustomClipToFrameDrawable001, TestSize.Level1)
{
    NodeId id = 1;
    RSRenderNode node(id);
 ...
 * @tc.require: issueI9QIQO
 */
HWTEST_F(RSRenderMiscDrawableTest, RSCustomClipToFrameDrawable002, TestSize.Level1)
{
