...
class RSUIFirstRenderDrawableTest : public testing::Test {
public:
...
void RSUIFirstRenderDrawableTest::SetUpTestCase() {}
void RSUIFirstRenderDrawableTest::TearDownTestCase() {}
void RSUIFirstRenderDrawableTest::SetUp()
{
...
void RSUIFirstRenderDrawableTest::TearDown() {}

/**
 * @tc.name: GetCacheSurfaceExtTest
 * @tc.desc: Test If GetCacheSurface Can Run
 * @tc.type: FUNC
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSUIFirstRenderDrawableTest, GetCacheSurfaceExtTest, TestSize.Level1)
{
...
/**
 * @tc.name: CreateUIFirstSurfaceRenderNodeDrawableSingleTest
 * @tc.desc: Test If UIFirstSurfaceRenderNodeDrawable Can Be Created
 * @tc.type: FUNC
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSUIFirstRenderDrawableTest, CreateUIFirstSurfaceRenderNodeDrawableSingleTest, TestSize.Level1)
{
    ASSERT_NE(surfaceDrawable_, nullptr);
}

/**
 * @tc.name: DrawCacheSurfaceSingleTest
 * @tc.desc: Test If DrawCacheSurface Can Run
 * @tc.type: FUNC
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSUIFirstRenderDrawableTest, DrawCacheSurfaceSingleTest, TestSize.Level1)
{
    if (surfaceDrawable_ == nullptr) {
        return;
    }
...
/**
 * @tc.name: GetCompletedImageExtTest
 * @tc.desc: Test If GetCompletedImage Can Run
 * @tc.type: FUNC
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSUIFirstRenderDrawableTest, GetCompletedImageExtTest, TestSize.Level1)
{
    if (surfaceDrawable_ == nullptr) {
        return;
    }
...
/**
 * @tc.name: UpdateCompletedCacheSurfaceExtTest
 * @tc.desc: Test If UpdateCompletedCacheSurface Can Run
 * @tc.type: FUNC
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSUIFirstRenderDrawableTest, UpdateCompletedCacheSurfaceExtTest, TestSize.Level1)
{
    if (surfaceDrawable_ == nullptr) {
        return;
    }
...
/**
 * @tc.name: NeedInitCacheSurfaceExtTest
 * @tc.desc: Test If NeedInitCacheSurface Can Run
 * @tc.type: FUNC
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSUIFirstRenderDrawableTest, NeedInitCacheSurfaceExtTest, TestSize.Level1)
{
...
/**
 * @tc.name: IsCurFrameStaticSingleTest
 * @tc.desc: Test If IsCurFrameStatic Can Run
 * @tc.type: FUNC
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSUIFirstRenderDrawableTest, IsCurFrameStaticSingleTest, TestSize.Level1)
{
    if (surfaceDrawable_ == nullptr) {
        return;
    }
...
#ifdef RS_ENABLE_VK
/**
 * @tc.name: ClearCacheSurfaceSingleTest
 * @tc.desc: Test If ClearCacheSurface Can Run
 * @tc.type: FUNC
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSUIFirstRenderDrawableTest, ClearCacheSurfaceSingleTest, TestSize.Level1)
{
    if (surfaceDrawable_ == nullptr) {
        return;
    }
...
/**
 * @tc.name: DrawUIFirstCacheExtTest
 * @tc.desc: Test If DrawUIFirstCache Can Run
 * @tc.type: FUNC
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSUIFirstRenderDrawableTest, DrawUIFirstCacheExtTest, TestSize.Level1)
{
    if (surfaceDrawable_ == nullptr) {
        return;
    }
...
/**
 * @tc.name: SubDrawExtTest
 * @tc.desc: Test If SubDraw Can Run
 * @tc.type: FUNC
 * @tc.require: #I9NVOG
 */
HWTEST_F(RSUIFirstRenderDrawableTest, SubDrawExtTest, TestSize.Level1)
{
    if (surfaceDrawable_ == nullptr) {
        return;
    }
...
/**
 * @tc.name: UpdateBackendTextureSingleTest
 * @tc.desc: Test If UpdateBackendTexture Can Run
 * @tc.type: FUNC
 * @tc.require: issueIAH6OI
 */
HWTEST_F(RSUIFirstRenderDrawableTest, UpdateBackendTextureSingleTest, TestSize.Level1)
{
    ASSERT_NE(surfaceDrawable_, nullptr);
...
/**
 * @tc.name: DrawUIFirstCacheWithStartingSingleTest
 * @tc.desc: Test If DrawUIFirstCacheWithStarting Can Run
 * @tc.type: FUNC
 * @tc.require: issueIAH6OI
 */
HWTEST_F(RSUIFirstRenderDrawableTest, DrawUIFirstCacheWithStartingSingleTest, TestSize.Level1)
{
    ASSERT_NE(surfaceDrawable_, nullptr);
    Drawing::Canvas* drawingCanvas = new Drawing::Canvas(DEFAULT_CANVAS_SIZE, DEFAULT_CANVAS_SIZE);
    auto rscanvas = static_cast<RSPaintFilterCanvas*>(drawingCanvas);
...
/**
 * @tc.name: GetGravityTranslateExtTest
 * @tc.desc: Test If GetGravityTranslate Can Run
 * @tc.type: FUNC
 * @tc.require: issueIAH6OI
 */
HWTEST_F(RSUIFirstRenderDrawableTest, GetGravityTranslateExtTest, TestSize.Level1)
{
    ASSERT_NE(surfaceDrawable_, nullptr);
...
/**
 * @tc.name: InitCacheSurfaceExtTest
 * @tc.desc: Test If InitCacheSurface Can Run
 * @tc.type: FUNC
 * @tc.require: issueIAH6OI
 */
HWTEST_F(RSUIFirstRenderDrawableTest, InitCacheSurfaceExtTest, TestSize.Level1)
{
    ASSERT_NE(surfaceDrawable_, nullptr);
...
/**
 * @tc.name: ClearCacheSurfaceInThreadSingleTest
 * @tc.desc: Test If ClearCacheSurfaceInThread Can Run
 * @tc.type: FUNC
 * @tc.require: issueIAH6OI
 */
HWTEST_F(RSUIFirstRenderDrawableTest, ClearCacheSurfaceInThreadSingleTest, TestSize.Level1)
{
    ASSERT_NE(surfaceDrawable_, nullptr);
    RSSurfaceRenderNodeDrawable::ClearCacheSurfaceFunc func;
...
/**
 * @tc.name: ClearCacheSurfaceOnlySingleTest
 * @tc.desc: Test If ClearCacheSurfaceOnly Can Run
 * @tc.type: FUNC
 * @tc.require: issueIAH6OI
 */
HWTEST_F(RSUIFirstRenderDrawableTest, ClearCacheSurfaceOnlySingleTest, TestSize.Level1)
{
    ASSERT_NE(surfaceDrawable_, nullptr);
    RSSurfaceRenderNodeDrawable::ClearCacheSurfaceFunc func;
