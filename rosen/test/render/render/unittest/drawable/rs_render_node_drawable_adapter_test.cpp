...
class RSDrawableAdapterTest : public testing::Test {
public:
...
void RSDrawableAdapterTest::SetUpTestCase() {}
void RSDrawableAdapterTest::TearDownTestCase() {}
void RSDrawableAdapterTest::SetUp() {}
void RSDrawableAdapterTest::TearDown() {}
 ...
 */
HWTEST(RSDrawableAdapterTest, OnGenerateTest, TestSize.Level1)
{
    NodeId id = 0;
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, GetDrawableByIdTest, TestSize.Level1)
{
    NodeId id = 1;
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, OnGenerateShadowDrawableTest, TestSize.Level1)
{
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, DumpDrawableTreeTest, TestSize.Level1)
{
    NodeId id = 3;
    int32_t depth = 3;
    std::string out;
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, GetRenderParamsAndGetUifirstRenderParamsTest, TestSize.Level1)
{
    NodeId id = 4;
    auto node = std::make_shared<RSRenderNode>(id);
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, DumpDrawableVecTest, TestSize.Level1)
{
    NodeId id = 5;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(node);
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, QuickRejectTest, TestSize.Level1)
{
    NodeId id = 6;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, HasFilterOrEffectTest, TestSize.Level1)
{
    NodeId id = 7;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, DrawRangeImplAndRelatedTest, TestSize.Level1)
{
    NodeId id = 8;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, DrawUifirstContentChildrenTest, TestSize.Level1)
{
    NodeId id = 9;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, DrawContentTest, TestSize.Level1)
{
    NodeId id = 10;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, DrawChildrenTest, TestSize.Level1)
{
    NodeId id = 11;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, DrawImplTest, TestSize.Level1)
{
    NodeId id = 12;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, InitRenderParamsTest, TestSize.Level1)
{
    NodeId id = 13;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter =
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, GetSkipIndexTest, TestSize.Level1)
{
    NodeId id = 14;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueI9UTMA
 */
HWTEST(RSDrawableAdapterTest, DrawBackgroundWithoutFilterAndEffectTest, TestSize.Level1)
{
    NodeId id = 15;
    auto node = std::make_shared<RSRenderNode>(id);
    auto adapter = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 */
HWTEST(RSDrawableAdapterTest, IsFilterCacheValidForOcclusionTest, TestSize.Level1)
{
    NodeId id = 18;
    auto node = std::make_shared<RSRenderNode>(id);
 ...
 * @tc.require: issueIALKED
 */
HWTEST(RSDrawableAdapterTest, GetFilterCachedRegionTest, TestSize.Level1)
{
    NodeId id = 19;
    auto node = std::make_shared<RSRenderNode>(id);
    std::shared_ptr<DrawableV2::RSRenderNodeDrawableAdapter> adapter =
