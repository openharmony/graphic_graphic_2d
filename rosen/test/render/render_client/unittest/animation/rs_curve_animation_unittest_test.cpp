...
class RsCurAnimationTest : public testing::Test {
public:
...
void RsCurAnimationTest::SetUpTestCase() {}
void RsCurAnimationTest::TearDownTestCase() {}
void RsCurAnimationTest::SetUp() {}
void RsCurAnimationTest::TearDown() {}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RsCurAnimationTest, StartRenderAnimationTest, Level1)
{
