...
class RsExtNodeOperationsTest : public testing::Test {
public:
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RsExtNodeOperationsTest, GetInstance001, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RsExtNodeOperationsTest, CheckNeedToProcess001, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RsExtNodeOperationsTest, ProcessRSSurfaceNode001, TestSize.Level1)
{
