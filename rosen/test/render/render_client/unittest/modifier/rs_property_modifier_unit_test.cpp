...
class RSPropertyModifierUnitTest : public testing::Test {
public:
...
void RSPropertyModifierUnitTest::SetUpTestCase() {}
void RSPropertyModifierUnitTest::TearDownTestCase() {}
void RSPropertyModifierUnitTest::SetUp() {}
void RSPropertyModifierUnitTest::TearDown() {}

/**
 * @tc.name: GetModifierType001
 * @tc.desc: RSEnvForegroundColorModifier Test
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, GetModifierType001, TestSize.Level1)
{
...
/**
 * @tc.name: CreateRenderModifier001
 * @tc.desc: RSEnvForegroundColorModifier Test
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, CreateRenderModifier001, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
    std::shared_ptr<RSEnvForegroundColorModifier> colorModifier =
...
/**
 * @tc.name: RSHDRBrightnessModifier002
 * @tc.desc: RSHDRBrightnessModifier CreateRenderModifier Test
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, RSHDRBrightnessModifier002, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
...
/**
 * @tc.name: RSHDRBrightnessModifier003
 * @tc.desc: RSHDRBrightnessModifier GetModifierType Test
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, RSHDRBrightnessModifier003, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
    std::shared_ptr<RSHDRBrightnessModifier> hdrModifier =
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, GetModifierType03, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, CreateRenderModifier03, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
    std::shared_ptr<RSEnvForegroundColorStrategyModifier> colorStrategyModifier =
...
/**
 * @tc.name: GetModifierType04
 * @tc.desc: RSCustomClipToFrameModifier Test
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, GetModifierType04, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
...
/**
 * @tc.name: CreateRenderModifier05
 * @tc.desc: RSCustomClipToFrameModifier Test
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, CreateRenderModifier05, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
    std::shared_ptr<RSCustomClipToFrameModifier> clipModifier =
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, Apply02, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, Apply03, TestSize.Level1)
{
    std::shared_ptr<RSObjAbsGeometry> geometry = std::make_shared<RSObjAbsGeometry>();
    ASSERT_NE(geometry, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, Apply04, TestSize.Level1)
{
    std::shared_ptr<RSObjAbsGeometry> geometry = std::make_shared<RSObjAbsGeometry>();
    ASSERT_NE(geometry, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, Apply05, TestSize.Level1)
{
    std::shared_ptr<RSObjAbsGeometry> geometry = std::make_shared<RSObjAbsGeometry>();
    ASSERT_NE(geometry, nullptr);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSPropertyModifierUnitTest, Apply06, TestSize.Level1)
{
    std::shared_ptr<RSObjAbsGeometry> geometry = std::make_shared<RSObjAbsGeometry>();
    ASSERT_NE(geometry, nullptr);
...
/**
 * @tc.name: RSBehindWindowFilterRadiusModifierTest001
 * @tc.desc: RSBehindWindowFilterRadiusModifierTest
 * @tc.type: FUNC
 * @tc.require: issueIB0UQV
 */
HWTEST_F(RSPropertyModifierUnitTest, RSBehindWindowFilterRadiusModifierTest001, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
...
/**
 * @tc.name: RSBehindWindowFilterSaturationModifierTest001
 * @tc.desc: RSBehindWindowFilterSaturationModifierTest
 * @tc.type: FUNC
 * @tc.require: issueIB0UQV
 */
HWTEST_F(RSPropertyModifierUnitTest, RSBehindWindowFilterSaturationModifierTest001, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
...
/**
 * @tc.name: RSBehindWindowFilterBrightnessModifierTest001
 * @tc.desc: RSBehindWindowFilterBrightnessModifierTest
 * @tc.type: FUNC
 * @tc.require: issueIB0UQV
 */
HWTEST_F(RSPropertyModifierUnitTest, RSBehindWindowFilterBrightnessModifierTest001, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
...
/**
 * @tc.name: RSBehindWindowFilterMaskColorModifierTest001
 * @tc.desc: RSBehindWindowFilterMaskColorModifierTest
 * @tc.type: FUNC
 * @tc.require: issueIB0UQV
 */
HWTEST_F(RSPropertyModifierUnitTest, RSBehindWindowFilterMaskColorModifierTest001, TestSize.Level1)
{
    std::shared_ptr<RSPropertyBase> property = std::make_shared<RSPropertyBase>();
    ASSERT_NE(property, nullptr);
