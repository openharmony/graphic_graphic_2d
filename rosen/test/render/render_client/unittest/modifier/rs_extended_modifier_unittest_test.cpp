...
/**
 * @tc.name: GetModifierTypeTest
 * @tc.desc: GetModifierType Test
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSExtendedModifierTest, GetModifierTypeTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSExtendedModifierTest, DrawTest, TestSize.Level1)
{
    GeometryTransModifierTest geometryTransModifier;
 ...
 * @tc.require:
 */
HWTEST_F(RSExtendedModifierTest, FinishDrawingTest001, TestSize.Level1)
{
    RSDrawingContext ctx;
...
/**
 * @tc.name: FinishDrawingTest002
 * @tc.desc: long text FinishDrawingTest
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSExtendedModifierTest, FinishDrawingTest002, TestSize.Level1)
{
