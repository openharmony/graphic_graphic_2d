...
class RSHgmConfigChangeCallbackStubUnitMock : public RSHgmConfigChangeCallbackStub {
public:
    RSHgmConfigChangeCallbackStubUnitMock() = default;
    virtual ~RSHgmConfigChangeCallbackStubUnitMock() = default;
...
class RSHgmConfigChangeCallbackStubUnitTest : public testing::Test {
public:
    static sptr<RSHgmConfigChangeCallbackStubUnitMock> stub;
...
sptr<RSHgmConfigChangeCallbackStubUnitMock> RSHgmConfigChangeCallbackStubUnitTest::stub = nullptr;

void RSHgmConfigChangeCallbackStubUnitTest::SetUpTestCase()
{
    stub = new RSHgmConfigChangeCallbackStubUnitMock();
}
void RSHgmConfigChangeCallbackStubUnitTest::TearDownTestCase()
{
    stub = nullptr;
}
void RSHgmConfigChangeCallbackStubUnitTest::SetUp() {}
void RSHgmConfigChangeCallbackStubUnitTest::TearDown() {}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSHgmConfigChangeCallbackStubUnitTest, OnRemoteRequest001, TestSize.Level1)
{
    MessageParcel data;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSHgmConfigChangeCallbackStubUnitTest, OnRemoteRequest002, TestSize.Level1)
{
    MessageParcel data;
    MessageOption option;
    MessageParcel reply;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSHgmConfigChangeCallbackStubUnitTest, OnRemoteRequest003, TestSize.Level1)
{
    MessageParcel data;
    MessageOption option;
    MessageParcel reply;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSHgmConfigChangeCallbackStubUnitTest, OnRemoteRequest004, TestSize.Level1)
{
    MessageParcel data;
    MessageOption option;
    MessageParcel reply;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSHgmConfigChangeCallbackStubUnitTest, OnRemoteRequest005, TestSize.Level1)
{
    MessageParcel data;
    MessageOption option;
    MessageParcel reply;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSHgmConfigChangeCallbackStubUnitTest, OnRemoteRequest006, TestSize.Level1)
{
    MessageParcel data;
    MessageOption option;
    MessageParcel reply;
