...
class RSBufferClearCallbackProxyUnitTest : public testing::Test {
public:
...
void RSBufferClearCallbackProxyUnitTest::SetUpTestCase() {}
void RSBufferClearCallbackProxyUnitTest::TearDownTestCase() {}
void RSBufferClearCallbackProxyUnitTest::SetUp() {}
void RSBufferClearCallbackProxyUnitTest::TearDown() {}
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSBufferClearCallbackProxyUnitTest, OnBufferClear001, TestSize.Level1)
{
...
* @tc.type:FUNC
*/
HWTEST_F(RSBufferClearCallbackProxyUnitTest, OnBufferClear003, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSBufferClearCallbackProxyUnitTest, OnBufferClear002, TestSize.Level1)
{
    sptr<MockIRemoteObject> remoteMocker = new MockIRemoteObject();
    ASSERT_TRUE(remoteMocker != nullptr);
