...
class RSBufferAvailableCallbackStubUnitTest : public testing::Test {
public:
...
void RSBufferAvailableCallbackStubUnitTest::SetUpTestCase() {}
void RSBufferAvailableCallbackStubUnitTest::TearDownTestCase() {}
void RSBufferAvailableCallbackStubUnitTest::SetUp() {}
void RSBufferAvailableCallbackStubUnitTest::TearDown() {}
 ...
 */
HWTEST_F(RSBufferAvailableCallbackStubUnitTest, OnRemoteRequest002, TestSize.Level1)
{
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.require: issueIAKP5Y
 */
HWTEST_F(RSBufferAvailableCallbackStubUnitTest, OnRemoteRequest001, TestSize.Level1)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
