...
class RSOcclusionChangeCallbackProxyUnitTest : public testing::Test {
public:
...
void RSOcclusionChangeCallbackProxyUnitTest::SetUpTestCase() {}
void RSOcclusionChangeCallbackProxyUnitTest::TearDownTestCase() {}
void RSOcclusionChangeCallbackProxyUnitTest::SetUp() {}
void RSOcclusionChangeCallbackProxyUnitTest::TearDown() {}
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSOcclusionChangeCallbackProxyUnitTest, OnOcclusionVisibleChanged003, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSOcclusionChangeCallbackProxyUnitTest, OnOcclusionVisibleChanged002, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSOcclusionChangeCallbackProxyUnitTest, OnOcclusionVisibleChanged001, TestSize.Level1)
{
    sptr<MockIRemoteObject> remoteMocker = new MockIRemoteObject();
    ASSERT_TRUE(remoteMocker != nullptr);
    auto occlusionChangeCallbackProxy = std::make_shared<RSOcclusionChangeCallbackProxy>(remoteMocker);
