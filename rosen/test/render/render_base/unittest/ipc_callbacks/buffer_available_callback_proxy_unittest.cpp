...
class RSBufferAvailableCallbackProxyUnitTest : public testing::Test {
public:
...
void RSBufferAvailableCallbackProxyUnitTest::SetUpTestCase() {}
void RSBufferAvailableCallbackProxyUnitTest::TearDownTestCase() {}
void RSBufferAvailableCallbackProxyUnitTest::SetUp() {}
void RSBufferAvailableCallbackProxyUnitTest::TearDown() {}
 ...
 */
HWTEST_F(RSBufferAvailableCallbackProxyUnitTest, OnBufferAvailable002, TestSize.Level1)
{
 ...
 * @tc.require: issueIB2AHG
 */
HWTEST_F(RSBufferAvailableCallbackProxyUnitTest, OnBufferAvailable001, TestSize.Level1)
{
    sptr<MockIRemoteObject> remoteMocker = new MockIRemoteObject();
    ASSERT_TRUE(remoteMocker != nullptr);
    auto rsBufferAvailableCallbackProxy = std::make_shared<RSBufferAvailableCallbackProxy>(remoteMocker);
