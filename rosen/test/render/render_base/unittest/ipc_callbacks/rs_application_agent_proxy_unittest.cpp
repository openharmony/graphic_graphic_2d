...
class RSApplicationAgentProxyUnitTest : public testing::Test {
public:
...
void RSApplicationAgentProxyUnitTest::SetUpTestCase() {}
void RSApplicationAgentProxyUnitTest::TearDownTestCase() {}
void RSApplicationAgentProxyUnitTest::SetUp() {}
void RSApplicationAgentProxyUnitTest::TearDown() {}
 ...
 */
HWTEST_F(RSApplicationAgentProxyUnitTest, OnTransaction002, TestSize.Level1)
{
 ...
 * @tc.require: issueIB2AHG
 */
HWTEST_F(RSApplicationAgentProxyUnitTest, OnTransaction001, TestSize.Level1)
{
    sptr<MockIRemoteObject> remoteMocker = new MockIRemoteObject();
    ASSERT_TRUE(remoteMocker != nullptr);
    auto rsApplicationAgentProxy = std::make_shared<RSApplicationAgentProxy>(remoteMocker);
