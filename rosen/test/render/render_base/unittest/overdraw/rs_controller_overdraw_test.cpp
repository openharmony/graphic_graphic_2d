...
class RSControllerOverdrawTest : public testing::Test {
public:
...
void RSControllerOverdrawTest::SetUpTestCase() {}
void RSControllerOverdrawTest::TearDownTestCase() {}
void RSControllerOverdrawTest::SetUp() {}
void RSControllerOverdrawTest::TearDown() {}
 ...
 */
HWTEST_F(RSControllerOverdrawTest, Singleton, Function | SmallTest | Level0)
{
 ...
 */
HWTEST_F(RSControllerOverdrawTest, Enable, Function | SmallTest | Level0)
{
    PART("CaseDescription") {
        bool e = false;
 ...
 */
HWTEST_F(RSControllerOverdrawTest, CreateListenerDisable, Function | SmallTest | Level2)
{
 ...
 *                  3. CreateListener<RSValidCanvasListener>(MockRSPaintFilterCanvas) != nullptr
 */
HWTEST_F(RSControllerOverdrawTest, CreateListenerEnable, Function | SmallTest | Level2)
{
    auto &controller = RSOverdrawController::GetInstance();
    PART("EnvConditions") {
 ...
 */
HWTEST_F(RSControllerOverdrawTest, OnColorChangeTest001, TestSize.Level1)
{
    auto& controller = RSOverdrawController::GetInstance();
    controller.SetEnable(false);
 ...
 * @tc.require:issueI9NDED
 */
HWTEST_F(RSControllerOverdrawTest, SwitchFunctionTest002, TestSize.Level1)
{
    auto& controller = RSOverdrawController::GetInstance();
    controller.SetEnable(true);
