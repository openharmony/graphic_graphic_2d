...
class RSGPUOverdrawTest : public testing::Test {
public:
...
void RSGPUOverdrawTest::SetUpTestCase() {}
void RSGPUOverdrawTest::TearDownTestCase() {}
void RSGPUOverdrawTest::SetUp() {}
void RSGPUOverdrawTest::TearDown() {}
 ...
 * @tc.require:#I8K89C
 */
HWTEST_F(RSGPUOverdrawTest, Create001, TestSize.Level1)
{
 ...
 * @tc.require:#I8K89C
 */
HWTEST_F(RSGPUOverdrawTest, onDrawRect001, TestSize.Level1)
{
    Drawing::Canvas canvas;
    Drawing::Rect rect;
    auto listener = new RSGPUOverdrawCanvasListener(canvas);
 ...
 * @tc.require:#I8K89C
 */
HWTEST_F(RSGPUOverdrawTest, onDrawOval001, TestSize.Level1)
{
    Drawing::Canvas canvas;
    Drawing::Rect rect;
    auto listener = new RSGPUOverdrawCanvasListener(canvas);
 ...
 * @tc.require:#I8K89C
 */
HWTEST_F(RSGPUOverdrawTest, onDrawArc001, TestSize.Level1)
{
    Drawing::Canvas canvas;
    Drawing::Rect rect;
 ...
 * @tc.require:#I8K89C
 */
HWTEST_F(RSGPUOverdrawTest, onDrawArc002, TestSize.Level1)
{
    Drawing::Canvas canvas;
    Drawing::Rect rect;
    Drawing::scalar startAngle = 0.0;
 ...
 * @tc.require:#I8K89C
 */
HWTEST_F(RSGPUOverdrawTest, onDrawPath001, TestSize.Level1)
{
    Drawing::Canvas canvas;
    Drawing::Path path;
    auto listener = new RSGPUOverdrawCanvasListener(canvas);
 ...
 * @tc.require:#I8K89C
 */
HWTEST_F(RSGPUOverdrawTest, onDrawRegion001, TestSize.Level1)
{
    Drawing::Canvas canvas;
 ...
 * @tc.require:#I8K89C
 */
HWTEST_F(RSGPUOverdrawTest, onDrawPicture001, TestSize.Level1)
{
    Drawing::Canvas canvas;
 ...
 */
HWTEST_F(RSGPUOverdrawTest, DrawAndDrawPointTest001, TestSize.Level1)
{
    Drawing::Canvas canvas;
 ...
 * @tc.require:issueI9NDED
 */
HWTEST_F(RSGPUOverdrawTest, OverdrawCanvaIsNullTest002, TestSize.Level1)
{
 ...
 * @tc.require: issueI9NDED
 */
HWTEST_F(RSGPUOverdrawTest, DrawRegionWithSpecifiedRegionTest003, TestSize.Level1)
{
 ...
 * @tc.require:issueI9NDED
 */
HWTEST_F(RSGPUOverdrawTest, DrawingFunctionsTest004, TestSize.Level1)
{
    Drawing::Canvas canvas;
    RSGPUOverdrawCanvasListener listener(canvas);
 ...
 * @tc.require:issueI9NDED
 */
HWTEST_F(RSGPUOverdrawTest, DrawingFunctionsTest005, TestSize.Level1)
{
    Drawing::Canvas canvas;
    RSGPUOverdrawCanvasListener listener(canvas);
    std::shared_ptr<Drawing::Canvas> canvasTest = std::make_shared<Drawing::Canvas>();
 ...
 * @tc.require:issueI9NDED
 */
HWTEST_F(RSGPUOverdrawTest, BitmapFunctionsTest006, TestSize.Level1)
{
    Drawing::Canvas canvas;
    RSGPUOverdrawCanvasListener listener(canvas);
    std::shared_ptr<Drawing::Canvas> canvasTest = std::make_shared<Drawing::Canvas>();
 ...
 * @tc.require:issueI9NDED
 */
HWTEST_F(RSGPUOverdrawTest, ImageFunctionsTest007, TestSize.Level1)
{
    Drawing::Canvas canvas;
    RSGPUOverdrawCanvasListener listener(canvas);
    std::shared_ptr<Drawing::Canvas> canvasTest = std::make_shared<Drawing::Canvas>();
 ...
 * @tc.require:issueI9NDED
 */
HWTEST_F(RSGPUOverdrawTest, PenAndBrushFunctionsTest008, TestSize.Level1)
{
    Drawing::Canvas canvas;
    RSGPUOverdrawCanvasListener listener(canvas);
    std::shared_ptr<Drawing::Canvas> canvasTest = std::make_shared<Drawing::Canvas>();
