...
class RSCPUOverdrawTest : public testing::Test {
public:
...
void RSCPUOverdrawTest::SetUpTestCase() {}
void RSCPUOverdrawTest::TearDownTestCase() {}
void RSCPUOverdrawTest::SetUp() {}
void RSCPUOverdrawTest::TearDown() {}
 ...
 */
HWTEST_F(RSCPUOverdrawTest, NoIntersect, Function | SmallTest | Level2)
{
 ...
 */
HWTEST_F(RSCPUOverdrawTest, DrawText001, TestSize.Level1)
{
 ...
 * @tc.require: issueI9NDED
 */
HWTEST_F(RSCPUOverdrawTest, DrawTextBlobAndAppendRegionTest002, TestSize.Level1)
{
    // configuration AppendRegion functions condition
    Drawing::Canvas canvas;
    RSCPUOverdrawCanvasListener canvasListener(canvas);
 ...
 * @tc.require: issueI9NDED
 */
HWTEST_F(RSCPUOverdrawTest, RSCPUOverdrawCanvasShapeDrawerTest003, TestSize.Level1)
{
    Drawing::Canvas canvas;
    RSCPUOverdrawCanvasListener canvasListener(canvas);
 ...
 * @tc.require: issueI9NDED
 */
HWTEST_F(RSCPUOverdrawTest, RSCPUOverdrawCanvasRendererTest004, TestSize.Level1)
{
    Drawing::Canvas canvas;
    RSCPUOverdrawCanvasListener canvasListener(canvas);
 ...
 * @tc.require: issueI9NDED
 */
HWTEST_F(RSCPUOverdrawTest, DrawRegionWithSpecifiedRegionTest005, TestSize.Level1)
{
 ...
 * @tc.require: issueI9NDED
 */
HWTEST_F(RSCPUOverdrawTest, DrawImageRectanglesTest006, TestSize.Level1)
{
    Drawing::Canvas canvas;
    RSCPUOverdrawCanvasListener canvasListener(canvas);
