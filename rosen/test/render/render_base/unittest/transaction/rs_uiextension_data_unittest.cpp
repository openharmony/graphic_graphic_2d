...
class RSUIExtensionDataUnitTest : public testing::Test {
public:
...
void RSUIExtensionDataUnitTest::SetUpTestCase() {}
void RSUIExtensionDataUnitTest::TearDownTestCase() {}
void RSUIExtensionDataUnitTest::SetUp() {}
void RSUIExtensionDataUnitTest::TearDown() {}

/**
 * @tc.name: MarshallingMultipleNodesTest
 * @tc.desc: test marshalling and unmarshalling multiple nodes.
 * @tc.type:FUNC
 * @tc.require: issueIAAOIJ
 */
HWTEST_F(RSUIExtensionDataUnitTest, MarshallingMultipleNodesTest, TestSize.Level1)
{
    Parcel parcel;
 ...
 * @tc.require: issueIAAOIJ
 */
HWTEST_F(RSUIExtensionDataUnitTest, MarshallingOneNodeTest, TestSize.Level1)
{
    Parcel parcel;
    RSUIExtensionData uiExtensionData;
    auto& secData = uiExtensionData.secData_;
