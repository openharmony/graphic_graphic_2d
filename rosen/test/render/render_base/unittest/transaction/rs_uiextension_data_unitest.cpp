...
void RSUIExtensionDataTest::SetUpTestCase() {}
void RSUIExtensionDataTest::TearDownTestCase() {}
void RSUIExtensionDataTest::SetUp() {}
 ...
 */
HWTEST_F(RSUIExtensionDataTest, MarshallingOneNodeTest, TestSize.Level1)
{
    Parcel parcel;
 ...
 * @tc.require: issueIAAOIJ
 */
HWTEST_F(RSUIExtensionDataTest, MarshallingMultipleNodesTest, TestSize.Level1)
{
    Parcel parcel;
    RSUIExtensionData uiExtensionData;
    auto& secData = uiExtensionData.secData_;
