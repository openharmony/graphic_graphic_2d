...
namespace OHOS {
namespace Rosen {
class RenderScreenDataTest : public testing::Test {
public:
...
void RenderScreenDataTest::SetUpTestCase() {}
void RenderScreenDataTest::TearDownTestCase() {}
void RenderScreenDataTest::SetUp() {}
void RenderScreenDataTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RenderScreenDataTest, marshallingAndUnmarshallling001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RenderScreenDataTest, Marshalling001, TestSize.Level1)
{
