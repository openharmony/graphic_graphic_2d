...
namespace OHOS {
namespace Rosen {
class RenderScreenCapabilityTest : public testing::Test {
public:
...
void RenderScreenCapabilityTest::SetUpTestCase() {}
void RenderScreenCapabilityTest::TearDownTestCase() {}
void RenderScreenCapabilityTest::SetUp() {}
void RenderScreenCapabilityTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RenderScreenCapabilityTest, marshallingAndUnmarshallling001, TestSize.Level1)
{
    RSScreenProps rp1;
    RSScreenProps rp2;
 ...
 * @tc.require:
 */
HWTEST_F(RenderScreenCapabilityTest, Marshalling001, TestSize.Level1)
{
