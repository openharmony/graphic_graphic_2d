...
namespace OHOS {
namespace Rosen {
class RenderScreenHDRCapabilityTest : public testing::Test {
public:
...
void RenderScreenHDRCapabilityTest::SetUpTestCase() {}
void RenderScreenHDRCapabilityTest::TearDownTestCase() {}
void RenderScreenHDRCapabilityTest::SetUp() {}
void RenderScreenHDRCapabilityTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RenderScreenHDRCapabilityTest, Marshalling001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RenderScreenHDRCapabilityTest, marshallingAndUnmarshallling001, TestSize.Level1)
{
