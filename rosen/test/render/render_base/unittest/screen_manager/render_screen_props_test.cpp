...
namespace OHOS {
namespace Rosen {
class RenderScreenPropsTest : public testing::Test {
public:
...
void RenderScreenPropsTest::SetUpTestCase() {}
void RenderScreenPropsTest::TearDownTestCase() {}
void RenderScreenPropsTest::SetUp() {}
void RenderScreenPropsTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RenderScreenPropsTest, marshallingAndUnmarshallling001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RenderScreenPropsTest, Marshalling001, TestSize.Level1)
{
