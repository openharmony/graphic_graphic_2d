...
class RSTrackerTest : public testing::Test {
public:
...
void RSTrackerTest::TearDownTestCase() {}
void RSTrackerTest::SetUp() {}
void RSTrackerTest::SetUpTestCase() {}
void RSTrackerTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, RSTagTracker004, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, RSTagTracker005, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, RSTagTracker006, TestSize.Level1)
{
    Drawing::GPUContext* gpuContext = nullptr;
    NodeId nodeId = 1;
    RSTagTracker tagTracker(gpuContext, nodeId, RSTagTracker::TAGTYPE::TAG_FILTER, "RSTagTracker005");
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, RSTagTracker007, TestSize.Level1)
{
    Drawing::GPUContext* gpuContext = new Drawing::GPUContext;
    NodeId nodeId = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, TagType2String001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, RSTagTracker001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, RSTagTracker002, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, RSTagTracker003, TestSize.Level1)
{
    RSTagTracker::TAGTYPE tagType = RSTagTracker::TAGTYPE::TAG_DRAW_SURFACENODE;
    Drawing::GPUContext* gpuContext = new Drawing::GPUContext;
    RSTagTracker tagTracker(gpuContext, tagType);
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, RSTagTracker008, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, RSTagTracker009, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackerTest, RSTagTracker010, TestSize.Level1)
{
    RSTagTracker::TAGTYPE tagType = RSTagTracker::TAGTYPE::TAG_DRAW_SURFACENODE;
    Drawing::GPUContext* gpuContext = nullptr;
    RSTagTracker tagTracker(gpuContext, tagType);
 ...
 */
HWTEST_F(RSTrackerTest, UpdateReleaseResourceEnabled, TestSize.Level1)
{
