...
class RSTrackMemoryTest : public testing::Test {
public:
...
void RSTrackMemoryTest::SetUp() {}
void RSTrackMemoryTest::TearDown() {}
void RSTrackMemoryTest::SetUpTestCase() {}
void RSTrackMemoryTest::TearDownTestCase() {}
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, DumpMemoryStatisticsTest, testing::ext::TestSize.Level1)
{
    DfxString log;
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, AddPictureRecordTest, testing::ext::TestSize.Level1)
{
    const void* addr;
    MemoryInfo info;
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, RemovePictureRecordTest, testing::ext::TestSize.Level1)
{
    const void* addr;
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, RemoveNodeRecordTest, testing::ext::TestSize.Level1)
{
    NodeId id = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, CountRSMemoryTest001, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, CountRSMemoryTest002, testing::ext::TestSize.Level1)
{
    MemoryGraphic memoryGraphic;
    pid_t pid1 = 0;
    MemoryTrack::Instance().CountRSMemory(pid1);
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, UpdatePictureInfoTest, testing::ext::TestSize.Level1)
{
    const void* addr;
    NodeId nodeId = 1;
    pid_t pid = -1;
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, GetAppMemorySizeInMBTest, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, MemoryType2StringTest001, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, MemoryType2StringTest002, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, MemoryType2StringTest003, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, GenerateDumpTitleTest, testing::ext::TestSize.Level1)
{
    MemoryInfo info;
    // for test
    uint64_t windowId = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, DumpMemoryNodeStatisticsTest, testing::ext::TestSize.Level1)
{
    // for test
    DfxString log;
    std::function<std::tuple<uint64_t, std::string, RectI> (uint64_t)> func;
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, RemoveNodeFromMapTest001, testing::ext::TestSize.Level1)
{
    // fot test
    const NodeId id = 1;
    // fot test
 ...
 * @tc.require:
 */
HWTEST_F(RSTrackMemoryTest, RemoveNodeFromMapTest002, testing::ext::TestSize.Level1)
{
    // fot test
    const NodeId id = 0;
    // fot test
