...
/**
 * @tc.name: MockRSRenderAnimatablePropertyTest
 * @tc.desc: test MockRSRenderAnimatablePropertyTest
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderPropertyTest, MockRSRenderAnimatablePropertyTest, TestSize.Level1)
{
...
/**
 * @tc.name: PropertyIPCTest001
 * @tc.desc: test PropertyIPC
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderPropertyTest, PropertyIPCTest001, TestSize.Level1)
{
...
/**
 * @tc.name: PropertyIPCTest002
 * @tc.desc: test PropertyIPC
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderPropertyTest, PropertyIPCTest002, TestSize.Level1)
{
    std::vector<std::shared_ptr<RSRenderPropertyBase>> props;
...
/**
 * @tc.name: OnChangeTest
 * @tc.desc: test OnChange
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRenderPropertyTest, OnChangeTest, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderPropertyTest, MarshallingTest001, TestSize.Level1)
{
    std::shared_ptr<RSRenderPropertyBase> base = std::make_shared<RSRenderPropertyBase>();
    Parcel parcel;
    std::vector<std::shared_ptr<RSRenderPropertyBase>> props;
 ...
 * @tc.require:
 */
HWTEST_F(RSRenderPropertyTest, MarshallingTest002, TestSize.Level1)
{
    std::shared_ptr<RSRenderPropertyBase> base = std::make_shared<RSRenderPropertyBase>();
    Parcel parcel;
    std::vector<std::shared_ptr<RSRenderPropertyBase>> props;
...
/**
 * @tc.name: IsNearEqualTest001
 * @tc.desc: test IsNearEqual
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRenderPropertyTest, IsNearEqualTest001, TestSize.Level1)
{
...
/**
 * @tc.name: IsNearEqualTest002
 * @tc.desc: test IsNearEqual
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRenderPropertyTest, IsNearEqualTest002, TestSize.Level1)
{
...
/**
 * @tc.name: IsNearEqualTest003
 * @tc.desc: test IsNearEqual
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRenderPropertyTest, IsNearEqualTest003, TestSize.Level1)
{
    RSRenderAnimatableProperty<float> property1;
    Vector2f vector2f;
...
/**
 * @tc.name: PropertyInitTest
 * @tc.desc: test PropertyInit
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderPropertyTest, PropertyInitTest, TestSize.Level1)
{
...
/**
 * @tc.name: RSRenderAnimatablePropertyTest
 * @tc.desc: test RSRenderAnimatableProperty
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderPropertyTest, RSRenderAnimatablePropertyTest, TestSize.Level1)
{
