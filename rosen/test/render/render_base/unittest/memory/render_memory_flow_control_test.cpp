...
class RenderMemoryFlowControlTest : public testing::Test {
public:
...
void RenderMemoryFlowControlTest::SetUpTestCase() {}
void RenderMemoryFlowControlTest::TearDownTestCase() {}
void RenderMemoryFlowControlTest::SetUp() {}
void RenderMemoryFlowControlTest::TearDown() {}
 ...
 */
HWTEST_F(RenderMemoryFlowControlTest, CheckOverflowAndCreateInstanceTest001, testing::ext::TestSize.Level1)
{
    pid_t callingPid = 0;
 ...
 */
HWTEST_F(RenderMemoryFlowControlTest, AddAshmemStatisticTest001, testing::ext::TestSize.Level1)
{
 ...
 * @tc.require: issue#IBABHE
 */
HWTEST_F(RenderMemoryFlowControlTest, CheckOverflowAndCreateInstanceTest002, testing::ext::TestSize.Level1)
{
    pid_t callingPid = 1;
 ...
 * @tc.require: issue#IB97OM
 */
HWTEST_F(RenderMemoryFlowControlTest, RemoveAshmemStatisticTest001, testing::ext::TestSize.Level1)
{
    MemoryFlowControl& instance = MemoryFlowControl::Instance();
    pid_t callingPid = 0;
    uint32_t bufferSize = 0;
