...
class RenderTagTrackerTest : public testing::Test {
public:
...
void RenderTagTrackerTest::SetUpTestCase() {}
void RenderTagTrackerTest::TearDownTestCase() {}
void RenderTagTrackerTest::SetUp() {}
void RenderTagTrackerTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, RSTagTracker006, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, RSTagTracker007, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, TagType2String001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, RSTagTracker001, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, RSTagTracker003, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, RSTagTracker004, TestSize.Level1)
{
    Drawing::GPUContext* gpuContext = new Drawing::GPUContext;
    NodeId nodeId = 1;
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, RSTagTracker010, TestSize.Level1)
{
    RSTagTracker::TAGTYPE tagType = RSTagTracker::TAGTYPE::TAG_DRAW_SURFACENODE;
    Drawing::GPUContext* gpuContext = nullptr;
    RSTagTracker tagTracker(gpuContext, tagType);
 ...
 */
HWTEST_F(RenderTagTrackerTest, UpdateReleaseResourceEnabled, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, RSTagTracker002, TestSize.Level1)
{
    RSTagTracker::TAGTYPE tagType = RSTagTracker::TAGTYPE::TAG_DRAW_SURFACENODE;
    Drawing::GPUContext* gpuContext = new Drawing::GPUContext;
    RSTagTracker tagTracker(gpuContext, tagType);
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, RSTagTracker005, TestSize.Level1)
{
    Drawing::GPUContext* gpuContext = nullptr;
    NodeId nodeId = 1;
    RSTagTracker tagTracker(gpuContext, nodeId, RSTagTracker::TAGTYPE::TAG_FILTER, "RSTagTracker005");
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, RSTagTracker008, TestSize.Level1)
{
 ...
 * @tc.require:
 */
HWTEST_F(RenderTagTrackerTest, RSTagTracker009, TestSize.Level1)
{
