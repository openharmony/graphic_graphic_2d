...
class RSStepsInterpolatorUnitTest : public testing::Test {
public:
...
void RSStepsInterpolatorUnitTest::SetUpTestCase() {}
void RSStepsInterpolatorUnitTest::TearDownTestCase() {}
void RSStepsInterpolatorUnitTest::SetUp() {}
void RSStepsInterpolatorUnitTest::TearDown() {}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSStepsInterpolatorUnitTest, StepsCurveTest001, TestSize.Level1)
{
    int32_t steps = 4;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSStepsInterpolatorUnitTest, StepsCurveTest002, TestSize.Level1)
{
    int32_t steps = 4;
    float stepValue = 1.0f / steps;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSStepsInterpolatorUnitTest, StepsCurveTest003, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSStepsInterpolatorUnitTest, InterpolateImplTest, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSStepsInterpolatorUnitTest, MarshallingTest, TestSize.Level1)
{
    RSStepsInterpolator stepsCurveStart(0);
    Parcel parcel;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSStepsInterpolatorUnitTest, UnmarshallingTest, TestSize.Level1)
{
    RSStepsInterpolator stepsCurveStart(0);
    Parcel parcel;
