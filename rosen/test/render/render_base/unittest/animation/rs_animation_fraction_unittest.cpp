...
class RSAnimationFractionUnitTest : public testing::Test {
public:
...
void RSAnimationFractionUnitTest::SetUpTestCase() {}
void RSAnimationFractionUnitTest::TearDownTestCase() {}
void RSAnimationFractionUnitTest::SetUp() {}
void RSAnimationFractionUnitTest::TearDown() {}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, InitTest001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, GetAnimationScaleTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, SetAnimationScaleTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, OnAnimationScaleChangedCallbackTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, SetDirectionAfterStartTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, SetLastFrameTimeTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, GetLastFrameTimeTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    int64_t res = rsAnimationFraction.GetLastFrameTime();
    EXPECT_NE(res, 1);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, IsStartRunningTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    int64_t deltaTime = 1;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, GetAnimationFractionTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    int64_t time = 0;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, IsInRepeatTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, IsFinishedTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    rsAnimationFraction.SetDirectionAfterStart(ForwardDirection::NORMAL);
    rsAnimationFraction.SetRepeatCount(-1);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, GetStartFractionTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, GetEndFractionTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, UpdateReverseStateTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    bool finish = true;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, UpdateRemainTimeFractionTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    int64_t time = 0;
    float fraction = 0.f;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, UpdateRemainTimeFractionTest002, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    int64_t time = 0;
    float fraction = 1.f;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, ResetFractionTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, GetRemainingRepeatCountTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    rsAnimationFraction.SetRepeatCount(-1);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, GetCurrentIsReverseCycleTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    rsAnimationFraction.ResetFraction();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, SetRepeatCallbackEnableTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    bool isEnable = false;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSAnimationFractionUnitTest, GetRepeatCallbackEnableTest001, TestSize.Level1)
{
    RSAnimationFraction rsAnimationFraction;
    rsAnimationFraction.SetRepeatCallbackEnable(false);
