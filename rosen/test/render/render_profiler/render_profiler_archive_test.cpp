 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeVectorNonFlatTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeFloatTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeDoubleTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeInt8Test, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeSizeTTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeInt32Test, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeUInt8Test, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeUint32Test, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeStringTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeVectorCustomSerializerTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
 ...
 * @tc.require:
 */
HWTEST_F(RenderProfilerArchiveTest, SerializeCharTest, testing::ext::TestSize.Level1)
{
    std::vector<char> buf;
    DataWriter writer(buf);
    DataReader reader(buf);
