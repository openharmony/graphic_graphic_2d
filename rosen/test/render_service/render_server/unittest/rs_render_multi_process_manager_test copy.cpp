...
class RSRenderMultiProcessManagerTest : public testing::Test {
public:
...
void RSRenderMultiProcessManagerTest::SetUpTestCase()
{
    OHOS::system::SetParameter("bootevent.samgr.ready", false);
    renderservice.Init();
    RSUniRenderThread::Instance().uniRenderEngine_ = nullptr;
}
void RSRenderMultiProcessManagerTest::TearDownTestCase() {}
void RSRenderMultiProcessManagerTest::SetUp() {}
void RSRenderMultiProcessManagerTest::TearDown() {}
 ...
 */
HWTEST_F(RSRenderMultiProcessManagerTest, OnScreenConnectedTest, TestSize.Level1)
{
 ...
 * @tc.require: issueIBRN69
 */
HWTEST_F(RSRenderMultiProcessManagerTest, OnVirtualScreenConnectedTest, TestSize.Level1)
{
