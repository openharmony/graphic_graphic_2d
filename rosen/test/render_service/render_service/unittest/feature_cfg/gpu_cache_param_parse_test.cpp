...
class GpuCacheParamParseTest : public testing::Test {
public:
...
void GpuCacheParamParseTest::SetUpTestCase() {}
void GpuCacheParamParseTest::TearDownTestCase() {}
void GpuCacheParamParseTest::SetUp() {}
void GpuCacheParamParseTest::TearDown() {}
 ...
 */
HWTEST_F(GpuCacheParamParseTest, ParseFeatureParamTest, TestSize.Level1)
{
    GpuCacheParamParse paramParse;
    ...
    xmlSetProp(&nextNode, (const xmlChar*)("name"), (const xmlChar*)("GpuCacheConfigEnable"));
    ...
    xmlSetProp(&nextNode, (const xmlChar*)("name"), (const xmlChar*)("MaxGpuCacheSize"));
