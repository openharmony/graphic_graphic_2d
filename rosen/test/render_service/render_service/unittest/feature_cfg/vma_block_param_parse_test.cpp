...
class VMABlockParamParseTest : public testing::Test {
public:
...
void VMABlockParamParseTest::SetUpTestCase() {}
void VMABlockParamParseTest::TearDownTestCase() {}
void VMABlockParamParseTest::SetUp() {}
void VMABlockParamParseTest::TearDown() {}
 ...
 * @tc.require:
 */
HWTEST_F(VMABlockParamParseTest, ParseFeatureParamTest, TestSize.Level1)
{
    VMABlockParamParse paramParse;
    ...
    xmlSetProp(&nextNode, (const xmlChar*)("name"), (const xmlChar*)("IsVMABlockEnabled"));
