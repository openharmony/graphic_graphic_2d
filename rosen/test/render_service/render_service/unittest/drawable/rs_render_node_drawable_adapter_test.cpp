 ...
 * @tc.desc: Test AlignRectToDevicePixels with translate matrix
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableAdapterTest, AlignRectToDevicePixelsTest002, TestSize.Level1)
{
    ...
    Drawing::Matrix matrix;
    matrix.SetIdentity();
    matrix.Translate(10.5f, 20.5f);
    Drawing::Rect rect(0.0f, 0.0f, 100.0f, 200.0f);
 ...
 * @tc.desc: Test AlignRectToDevicePixels with scale matrix (0.8)
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
 ...
 * @tc.desc: Test AlignRectToDevicePixels with scale matrix (1.5)
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
 ...
 * @tc.desc: Test AlignRectToDevicePixels with composite transform (scale + translate)
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
 ...
 * @tc.desc: Test AlignRectToDevicePixels with non-invertible matrix (scale = 0)
 * @tc.type: FUNC
 * @tc.require: issueI9UTMA
 */
HWTEST(RSRenderNodeDrawableAdapterTest, AlignRectToDevicePixelsTest007, TestSize.Level1)
{
    ...
    Drawing::Matrix matrix;
    matrix.SetIdentity();
    matrix.Scale(0.0f, 0.0f);
    Drawing::Rect rect(10.0f, 20.0f, 100.0f, 200.0f);
    Drawing::Rect originalRect = rect;

    adapter->AlignRectToDevicePixels(matrix, rect);

    EXPECT_EQ(rect.GetLeft(), originalRect.GetLeft());
    EXPECT_EQ(rect.GetTop(), originalRect.GetTop());
    EXPECT_EQ(rect.GetRight(), originalRect.GetRight());
    EXPECT_EQ(rect.GetBottom(), originalRect.GetBottom());
}
