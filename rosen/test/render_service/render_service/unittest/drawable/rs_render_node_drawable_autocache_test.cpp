...
class RSRenderNodeDrawableAutoCacheTest : public testing::Test {
public:
...
void RSRenderNodeDrawableAutoCacheTest::SetUpTestCase() {}
void RSRenderNodeDrawableAutoCacheTest::TearDownTestCase() {}
void RSRenderNodeDrawableAutoCacheTest::SetUp() {}
void RSRenderNodeDrawableAutoCacheTest::TearDown() {}
 ...
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, OpincCalculateBeforeTest, TestSize.Level1)
{
    NodeId nodeId = 0;
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, OpincCalculateAfterTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, PreDrawableCacheStateTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, OpincCanvasUnionTranslateTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, ResumeOpincCanvasTranslateTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, NodeCacheStateDisableTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, BeforeDrawCacheProcessChildNodeTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, BeforeDrawCacheFindRootNodeTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, BeforeDrawCacheTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, AfterDrawCacheTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, DrawAutoCacheTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, DrawAutoCacheDfxTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
 ...
 * @tc.require: issueIAFM3H
 */
HWTEST(RSRenderNodeDrawableAutoCacheTest, GetNodeDebugInfoTest, TestSize.Level1)
{
    NodeId nodeId = 0;
    auto node = std::make_shared<RSRenderNode>(nodeId);
    auto drawable = std::make_shared<RSRenderNodeDrawable>(std::move(node));
