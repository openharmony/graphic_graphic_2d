...
/**
 * @tc.name: DrawSurfaceNodeWithParams003
 * @tc.desc: test DrawSurfaceNodeWithParams when useCPU is false (RegisterDeleteBufferListener path)
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderEngineTest, DrawSurfaceNodeWithParams003, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
    renderEngine->Init();
    auto drawingCanvas = std::make_unique<Drawing::Canvas>(DEFAULT_DRAWING_CANVAS_WIDTH, DEFAULT_DRAWING_CANVAS_HEIGHT);
...
/**
 * @tc.name: DrawLayers_ClientClearAndTunnel
 * @tc.desc: test DrawLayers with CLIENT_CLEAR and TUNNEL composition types
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderEngineTest, DrawLayers_ClientClearAndTunnel, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
    renderEngine->Init();
    auto drawingCanvas = std::make_unique<Drawing::Canvas>(DEFAULT_DRAWING_CANVAS_WIDTH, DEFAULT_DRAWING_CANVAS_HEIGHT);
    ...
    // Create a surface node and register it
    auto surfaceNode = RSTestUtil::CreateSurfaceNodeWithBuffer();
    RSRenderNodeMap& nodeMap = RSMainThread::Instance()->GetContext().GetMutableNodeMap();
    nodeMap.RegisterRenderNode(surfaceNode);

    std::vector<RSLayerPtr> layers;
    RSLayerPtr layerClear = std::make_shared<RSSurfaceLayer>();
    layerClear->SetCompositionType(GraphicCompositionType::GRAPHIC_COMPOSITION_CLIENT_CLEAR);
    layerClear->SetNodeId(surfaceNode->GetId());
    layers.emplace_back(layerClear);

    RSLayerPtr layerTunnel = std::make_shared<RSSurfaceLayer>();
    layerTunnel->SetCompositionType(GraphicCompositionType::GRAPHIC_COMPOSITION_TUNNEL);
    layerTunnel->SetNodeId(surfaceNode->GetId());
    layers.emplace_back(layerTunnel);
...
/**
 * @tc.name: DrawLayers_UnexpectedNodeType
 * @tc.desc: test DrawLayers hitting unexpected node type branch with screen node
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderEngineTest, DrawLayers_UnexpectedNodeType, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
    renderEngine->Init();
    auto drawingCanvas = std::make_unique<Drawing::Canvas>(DEFAULT_DRAWING_CANVAS_WIDTH, DEFAULT_DRAWING_CANVAS_HEIGHT);
    ...
    // Create and register a screen node (non-surface) to trigger error path
    auto rsContext = std::make_shared<RSContext>();
    constexpr NodeId nodeId = 2001;
    ...
    layer->SetNodeId(screenNode->GetId());
...
/**
 * @tc.name: DrawLayers_NodeNull
 * @tc.desc: test DrawLayers when layer's nodeId not registered (nodePtr nullptr)
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderEngineTest, DrawLayers_NodeNull, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
    renderEngine->Init();
    auto drawingCanvas = std::make_unique<Drawing::Canvas>(DEFAULT_DRAWING_CANVAS_WIDTH, DEFAULT_DRAWING_CANVAS_HEIGHT);
    ...
    RSLayerPtr layer = std::make_shared<RSSurfaceLayer>();
    layer->SetCompositionType(GraphicCompositionType::GRAPHIC_COMPOSITION_CLIENT);
    layer->SetNodeId(999999); // not registered
    layers.emplace_back(layer);
...
/**
 * @tc.name: DrawSurfaceNodeWithParams008
 * @tc.desc: test DrawSurfaceNodeWithParams when useCPU is false
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderEngineTest, DrawSurfaceNodeWithParams008, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
    renderEngine->Init();
    auto drawingCanvas = std::make_unique<Drawing::Canvas>(DEFAULT_DRAWING_CANVAS_WIDTH, DEFAULT_DRAWING_CANVAS_HEIGHT);
 ...
 * @tc.desc: test DrawLayers client clear branch executes clipping
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderEngineTest, DrawLayers002, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
    renderEngine->Init();
    auto drawingCanvas = std::make_unique<Drawing::Canvas>(DEFAULT_DRAWING_CANVAS_WIDTH, DEFAULT_DRAWING_CANVAS_HEIGHT);
...
/**
 * @tc.name: DrawLayers003
 * @tc.desc: test DrawLayers tunnel branch executes clipping
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderEngineTest, DrawLayers003, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
    renderEngine->Init();
    auto drawingCanvas = std::make_unique<Drawing::Canvas>(DEFAULT_DRAWING_CANVAS_WIDTH, DEFAULT_DRAWING_CANVAS_HEIGHT);
...
/**
 * @tc.name: DrawLayers004
 * @tc.desc: test DrawLayers when nodePtr is nullptr
 * @tc.type: FUNC
 */
HWTEST_F(RSRenderEngineTest, DrawLayers004, TestSize.Level1)
{
    auto renderEngine = std::make_shared<RSRenderEngine>();
    renderEngine->Init();
    auto drawingCanvas = std::make_unique<Drawing::Canvas>(DEFAULT_DRAWING_CANVAS_WIDTH, DEFAULT_DRAWING_CANVAS_HEIGHT);
    ...
    RSLayerPtr layer = std::make_shared<RSSurfaceLayer>();
    layer->SetCompositionType(GraphicCompositionType::GRAPHIC_COMPOSITION_CLIENT);
    // Do not register node id so nodePtr lookup returns nullptr
    layer->SetNodeId(0xDEADBEEF);
    layers.emplace_back(layer);
    renderEngine->DrawLayers(*canvas, layers, false);
    ASSERT_NE(canvas, nullptr);
}
