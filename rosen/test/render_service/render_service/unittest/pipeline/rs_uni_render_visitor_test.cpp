...
/**
 * @tc.name: UpdateHwcNodeInfoForAppNode_004
 * @tc.desc: UpdateHwcNodeInfoForAppNode Test, node.GetNeedCollectHwcNode() is true
 * node.IsHardwareEnabledType() is true
 * curSurfaceNode_ is not nullptr
 * reach hwc node
 ...
 *
 * (!node.GetForceHardware() && !IsHardwareComposerEnabled()) true
 *
 * @tc.type:FUNC
 * @tc.require:issuesIAJO0U
 */
HWTEST_F(RSUniRenderVisitorTest, UpdateHwcNodeInfoForAppNode_004, TestSize.Level2)
{
    auto rsUniRenderVisitor = std::make_shared<RSUniRenderVisitor>();
    ASSERT_NE(rsUniRenderVisitor, nullptr);
    ...
    // node.GetForceHardware() false and IsHardwareComposerEnabled() false
    node->isForceHardware_ = false;
    rsUniRenderVisitor->isHardwareForcedDisabled_ = true;
    ASSERT_TRUE((!node->GetForceHardware() && !rsUniRenderVisitor->IsHardwareComposerEnabled()));
    ASSERT_TRUE((!node->GetForceHardware() && !rsUniRenderVisitor->IsHardwareComposerEnabled()) ||
                rsUniRenderVisitor->curSurfaceNode_->GetVisibleRegion().IsEmpty() ||
                !node->GetRSSurfaceHandler()->GetBuffer());
    rsUniRenderVisitor->UpdateHwcNodeInfoForAppNode(*node);
}

/**
 * @tc.name: UpdateHwcNodeInfoForAppNode_005
 * @tc.desc: UpdateHwcNodeInfoForAppNode Test, node.GetNeedCollectHwcNode() is true
 * node.IsHardwareEnabledType() is true
 * curSurfaceNode_ is not nullptr
 * reach hwc node
 ...
 * node.GetHardWareDisabledByReverse() is false
 *
 * (!node.GetForceHardware() && !IsHardwareComposerEnabled()) false when node.GetForceHardware() true and
 * IsHardwareComposerEnabled() true
 * curSurfaceNode_->GetVisibleRegion().IsEmpty() is false
 * node.GetRSSurfaceHandler()->GetBuffer() not null
 *
 * @tc.type:FUNC
 * @tc.require:issuesIAJO0U
 */
HWTEST_F(RSUniRenderVisitorTest, UpdateHwcNodeInfoForAppNode_005, TestSize.Level2)
{
    auto rsUniRenderVisitor = std::make_shared<RSUniRenderVisitor>();
    ASSERT_NE(rsUniRenderVisitor, nullptr);
    ...
    // curSurfaceNode_->GetVisibleRegion().IsEmpty() is false
    rsUniRenderVisitor->curSurfaceNode_->visibleRegion_.rects_.resize(1);
    rsUniRenderVisitor->curSurfaceNode_->visibleRegion_.bound_ = OHOS::Rosen::Occlusion::Rect(1, 1, 2, 2);
    ASSERT_FALSE(rsUniRenderVisitor->curSurfaceNode_->GetVisibleRegion().IsEmpty());
    // node->GetRSSurfaceHandler()->GetBuffer() not null
    ASSERT_NE(node->GetRSSurfaceHandler()->GetBuffer(), nullptr);

    // node.GetForceHardware() true and IsHardwareComposerEnabled() true
    node->isForceHardware_ = true;
    rsUniRenderVisitor->isHardwareForcedDisabled_ = false;
    ASSERT_FALSE((!node->GetForceHardware() && !rsUniRenderVisitor->IsHardwareComposerEnabled()));
    ASSERT_FALSE((!node->GetForceHardware() && !rsUniRenderVisitor->IsHardwareComposerEnabled()) ||
                 rsUniRenderVisitor->curSurfaceNode_->GetVisibleRegion().IsEmpty() ||
                 !node->GetRSSurfaceHandler()->GetBuffer());
    rsUniRenderVisitor->UpdateHwcNodeInfoForAppNode(*node);
...
/**
 * @tc.name: UpdateHwcNodeInfoForAppNode_006
 * @tc.desc: UpdateHwcNodeInfoForAppNode Test, node.GetNeedCollectHwcNode() is true
 * node.IsHardwareEnabledType() is true
 * curSurfaceNode_ is not nullptr
 * reach hwc node
 ...
 *
 * (!node.GetForceHardware() && !IsHardwareComposerEnabled()) false when node.GetForceHardware() true and
 * IsHardwareComposerEnabled() false
 * curSurfaceNode_->GetVisibleRegion().IsEmpty() is false
 * node.GetRSSurfaceHandler()->GetBuffer() not null
 *
 * @tc.type:FUNC
 * @tc.require:issuesIAJO0U
 */
HWTEST_F(RSUniRenderVisitorTest, UpdateHwcNodeInfoForAppNode_006, TestSize.Level2)
{
    auto rsUniRenderVisitor = std::make_shared<RSUniRenderVisitor>();
    ASSERT_NE(rsUniRenderVisitor, nullptr);
    ...
    // node.GetForceHardware() true and IsHardwareComposerEnabled() false
    node->isForceHardware_ = true;
    rsUniRenderVisitor->isHardwareForcedDisabled_ = true;
    ASSERT_FALSE((!node->GetForceHardware() && !rsUniRenderVisitor->IsHardwareComposerEnabled()));
    ASSERT_FALSE((!node->GetForceHardware() && !rsUniRenderVisitor->IsHardwareComposerEnabled()) ||
...
/**
 * @tc.name: UpdateHwcNodeInfoForAppNode_007
 * @tc.desc: UpdateHwcNodeInfoForAppNode Test, node.GetNeedCollectHwcNode() is true
 * node.IsHardwareEnabledType() is true
 * curSurfaceNode_ is not nullptr
 * reach hwc node
 ...
 * node.GetHardWareDisabledByReverse() is false
 *
 * (!node.GetForceHardware() && !IsHardwareComposerEnabled()) false when node.GetForceHardware() false and
 * IsHardwareComposerEnabled() true
 * curSurfaceNode_->GetVisibleRegion().IsEmpty() is false
 * node.GetRSSurfaceHandler()->GetBuffer() not null
 *
 ...
 * @tc.require:issuesIAJO0U
 */
HWTEST_F(RSUniRenderVisitorTest, UpdateHwcNodeInfoForAppNode_007, TestSize.Level2)
{
    auto rsUniRenderVisitor = std::make_shared<RSUniRenderVisitor>();
    ASSERT_NE(rsUniRenderVisitor, nullptr);
    ...
    // node.GetForceHardware() false and IsHardwareComposerEnabled() true
    node->isForceHardware_ = false;
    rsUniRenderVisitor->isHardwareForcedDisabled_ = false;
    ASSERT_FALSE((!node->GetForceHardware() && !rsUniRenderVisitor->IsHardwareComposerEnabled()));
    ASSERT_FALSE((!node->GetForceHardware() && !rsUniRenderVisitor->IsHardwareComposerEnabled()) ||
...
/**
 * @tc.name: UpdateHwcNodeInfoForAppNode_008
 * @tc.desc: UpdateHwcNodeInfoForAppNode Test, node.GetNeedCollectHwcNode() is true
 * node.IsHardwareEnabledType() is true
 * curSurfaceNode_ is not nullptr
 * reach hwc node
 ...
 * node.GetHardWareDisabledByReverse() is false
 *
 * (!node.GetForceHardware() && !IsHardwareComposerEnabled()) false
 * curSurfaceNode_->GetVisibleRegion().IsEmpty() is true
 *
 * @tc.type:FUNC
 * @tc.require:issuesIAJO0U
 */
HWTEST_F(RSUniRenderVisitorTest, UpdateHwcNodeInfoForAppNode_008, TestSize.Level2)
{
    auto rsUniRenderVisitor = std::make_shared<RSUniRenderVisitor>();
    ASSERT_NE(rsUniRenderVisitor, nullptr);
    ...
    // curSurfaceNode_->GetVisibleRegion().IsEmpty() is true
    rsUniRenderVisitor->curSurfaceNode_->visibleRegion_.rects_.resize(0);
    rsUniRenderVisitor->curSurfaceNode_->visibleRegion_.bound_ = OHOS::Rosen::Occlusion::Rect();
    ASSERT_TRUE(rsUniRenderVisitor->curSurfaceNode_->GetVisibleRegion().IsEmpty());

    // 3 conditions of (!node.GetForceHardware() && !IsHardwareComposerEnabled()) == false
    // node.GetForceHardware() true and IsHardwareComposerEnabled() false
    node->isForceHardware_ = true;
    rsUniRenderVisitor->isHardwareForcedDisabled_ = true;
    ASSERT_FALSE((!node->GetForceHardware() && !rsUniRenderVisitor->IsHardwareComposerEnabled()));
...
/**
 * @tc.name: UpdateHwcNodeInfoForAppNode_009
 * @tc.desc: UpdateHwcNodeInfoForAppNode Test, node.GetNeedCollectHwcNode() is true
 * node.IsHardwareEnabledType() is true
 * curSurfaceNode_ is not nullptr
 * reach hwc node
 ...
 * @tc.require:issuesIAJO0U
 */
HWTEST_F(RSUniRenderVisitorTest, UpdateHwcNodeInfoForAppNode_009, TestSize.Level2)
{
    auto rsUniRenderVisitor = std::make_shared<RSUniRenderVisitor>();
    ASSERT_NE(rsUniRenderVisitor, nullptr);
    ...
    rsUniRenderVisitor->UpdateHwcNodeInfoForAppNode(*node);
    ASSERT_TRUE(node->isHardwareForcedDisabledByVisibility_);
}

/**
 * @tc.name: UpdateHwcNodeInfoForAppNode_010
 * @tc.desc: UpdateHwcNodeInfoForAppNode Test, node.GetNeedCollectHwcNode() is true
 * node.IsHardwareEnabledType() is true
 * curSurfaceNode_ is not nullptr
 * curSurfaceNode_->GetNeedCollectHwcNode() is true
 ...
 * (!node.GetForceHardware() && !IsHardwareComposerEnabled())  false
 * curSurfaceNode_->GetVisibleRegion().IsEmpty() is false
 * node.GetRSSurfaceHandler()->GetBuffer()  null
 * @tc.type:FUNC
 * @tc.require:issuesIAJO0U
 */
HWTEST_F(RSUniRenderVisitorTest, UpdateHwcNodeInfoForAppNode_010, TestSize.Level2)
{
    auto rsUniRenderVisitor = std::make_shared<RSUniRenderVisitor>();
    ASSERT_NE(rsUniRenderVisitor, nullptr);
    ...
    node->surfaceHandler_->buffer_.buffer = nullptr;
