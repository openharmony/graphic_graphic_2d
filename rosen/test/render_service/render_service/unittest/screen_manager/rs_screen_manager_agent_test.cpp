 ...
 * @tc.desc: Test AddVirtualScreenSurface with null screenManager returns SCREEN_NOT_FOUND
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSScreenManagerAgentTest, AddVirtualScreenSurface001, TestSize.Level1)
{
    auto screenManager = screenManagerAgent_->screenManager_;
    screenManagerAgent_->screenManager_ = nullptr;
    std::vector<SurfaceRegionConfig> configs;
    ScreenId screenId = GenerateScreenId();
    auto ret = screenManagerAgent_->AddVirtualScreenSurface(screenId, configs);
    EXPECT_EQ(ret, StatusCode::SCREEN_NOT_FOUND);
    screenManagerAgent_->screenManager_ = screenManager;
}
 ...
 * @tc.desc: Test AddVirtualScreenSurface with valid screenManager calls through
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSScreenManagerAgentTest, AddVirtualScreenSurface002, TestSize.Level1)
{
    auto csurface = IConsumerSurface::Create();
    ASSERT_NE(csurface, nullptr);
    auto producer = csurface->GetProducer();
    ...
    constexpr uint32_t defaultWidth = 720;
    constexpr uint32_t defaultHeight = 1280;
    ScreenId screenId = GenerateScreenId();
    GetGlobalPreprocessor();
    ASSERT_NE(screenManagerAgent_->screenManager_->preprocessor_, nullptr);
    ScreenId virtualScreenId = screenManagerAgent_->CreateVirtualScreen(
    ...
    cfg.region = RectI(0, 0, defaultWidth, defaultHeight);
 ...
 * @tc.desc: Test RemoveVirtualScreenSurface with null screenManager returns SCREEN_NOT_FOUND
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSScreenManagerAgentTest, RemoveVirtualScreenSurface001, TestSize.Level1)
{
    auto screenManager = screenManagerAgent_->screenManager_;
    screenManagerAgent_->screenManager_ = nullptr;
    std::vector<sptr<Surface>> surfaces;
    ScreenId screenId = GenerateScreenId();
    auto ret = screenManagerAgent_->RemoveVirtualScreenSurface(screenId, surfaces);
    EXPECT_EQ(ret, StatusCode::SCREEN_NOT_FOUND);
    screenManagerAgent_->screenManager_ = screenManager;
}
 ...
 * @tc.desc: Test RemoveVirtualScreenSurface with valid screenManager calls through
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSScreenManagerAgentTest, RemoveVirtualScreenSurface002, TestSize.Level1)
{
    auto csurface = IConsumerSurface::Create();
    ASSERT_NE(csurface, nullptr);
    auto producer = csurface->GetProducer();
