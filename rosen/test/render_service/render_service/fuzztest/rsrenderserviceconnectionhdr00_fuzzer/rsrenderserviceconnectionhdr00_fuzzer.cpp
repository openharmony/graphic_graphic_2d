...
void DoSetColorFollow(FuzzedDataProvider& fdp)
{
    ...
    g_serviceConnection->SetColorFollow(config.name, isColorFollow);
...
void DoSetLayerTop(FuzzedDataProvider& fdp)
{
    ...
    g_serviceConnection->SetLayerTop(config.name, isLayerTop);
...
void DoSetHdrForceHwcEnabled(FuzzedDataProvider& fdp)
{
    ...
    g_serviceConnection->SetHdrForceHwcEnabled(config.name, isHdrForceHwcEnabled);
...
void DoSetForceRefresh(FuzzedDataProvider& fdp)
{
    ...
    g_serviceConnection->SetForceRefresh(config.name, isForceRefresh);
