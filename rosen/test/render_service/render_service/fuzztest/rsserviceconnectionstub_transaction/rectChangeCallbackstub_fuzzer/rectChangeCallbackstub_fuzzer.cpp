...
#include "rectChangeCallbackstub_fuzzer.h"
...
void DoRegisterSelfDrawingNodeRectChangeCallback(FuzzedDataProvider& fdp)
{
    ...
    int32_t lowLimitWidth = fdp.ConsumeIntegral<int32_t>();
    int32_t lowLimitHeight = fdp.ConsumeIntegral<int32_t>();
    int32_t highLimitWidth = fdp.ConsumeIntegral<int32_t>();
    int32_t highLimitHeight = fdp.ConsumeIntegral<int32_t>();
    ...
    if (!dataP.WriteInt32(lowLimitWidth) || !dataP.WriteInt32(lowLimitHeight) || !dataP.WriteInt32(highLimitWidth) ||
        !dataP.WriteInt32(highLimitHeight)) {
        return;
    }
    if (!dataP.WriteRemoteObject(selfDrawingNodeRectChangeCallback_->AsObject())) {
        return;
    }
