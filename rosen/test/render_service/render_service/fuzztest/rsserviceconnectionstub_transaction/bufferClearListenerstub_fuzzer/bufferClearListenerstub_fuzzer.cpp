...
#include "bufferClearListenerstub_fuzzer.h"
...
public:
    ...
    ~CustomTestBufferClearCallback() override = default;
...
void DoSetBufferClearListener(FuzzedDataProvider& fdp)
{
    ...
    sptr<RSIBufferClearCallback> callback = new CustomTestBufferClearCallback();
