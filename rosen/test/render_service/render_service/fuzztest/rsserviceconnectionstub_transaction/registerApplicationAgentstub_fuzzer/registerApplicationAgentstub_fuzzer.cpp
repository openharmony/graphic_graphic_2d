...
#include "registerApplicationAgentstub_fuzzer.h"
...
namespace {
void DoRegisterApplicationAgent(FuzzedDataProvider& fdp)
{
    ...
    sptr<IApplicationAgent> app = RSApplicationAgentImpl::Instance();
    
    option.SetFlags(MessageOption::TF_ASYNC);
    if (!dataP.WriteRemoteObject(app->AsObject())) {
        return;
    }
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::Rosen::DoRegisterApplicationAgent(fdp);
    return 0;
}
