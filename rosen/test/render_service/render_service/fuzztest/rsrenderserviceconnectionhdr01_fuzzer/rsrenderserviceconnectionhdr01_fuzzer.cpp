...
void DoSetColorFollow(FuzzedDataProvider& fdp)
{
    ...
    g_serviceConnection->SetColorFollow(nodeId, isColorFollow);
}
...
void DoSetLayerTop(FuzzedDataProvider& fdp)
{
    ...
    g_serviceConnection->SetLayerTop(nodeId, isLayerTop);
}
...
void DoSetHdrForceHwcEnabled(FuzzedDataProvider& fdp)
{
    ...
    g_serviceConnection->SetHdrForceHwcEnabled(nodeId, isHdrForceHwcEnabled);
}
...
void DoSetForceRefresh(FuzzedDataProvider& fdp)
{
    ...
    g_serviceConnection->SetForceRefresh(nodeId, isForceRefresh);
}
} // namespace Rosen
} // namespace OHOS
