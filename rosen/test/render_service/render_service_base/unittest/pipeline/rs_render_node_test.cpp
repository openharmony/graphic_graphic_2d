...
/*
 * @tc.name: CalaCmdlistDrawRegionFromOpItem
 * @tc.desc: Test function CalaCmdlistDrawRegionFromOpItem
 * @tc.type: FUNC
 * @tc.require: issueICI6YB
 */
HWTEST_F(RSRenderNodeTest, CalaCmdlistDrawRegionFromOpItem, TestSize.Level1)
{
    auto node = std::make_shared<RSRenderNode>(1);
    ASSERT_NE(node, nullptr);
