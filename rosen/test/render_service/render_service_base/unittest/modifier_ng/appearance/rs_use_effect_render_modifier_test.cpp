...
class RSUseEffectRenderModifierNGTypeTest : public testing::Test {
public:
...
/**
 * @tc.name: RSUseEffectRenderModifierTest
 * @tc.desc: GetType & ResetProperties
 * @tc.type: FUNC
 */
HWTEST_F(RSUseEffectRenderModifierNGTypeTest, RSUseEffectRenderModifierTest, TestSize.Level1)
{
    ModifierNG::RSUseEffectRenderModifier modifier;
