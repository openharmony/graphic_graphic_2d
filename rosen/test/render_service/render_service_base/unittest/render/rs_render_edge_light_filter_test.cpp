...
HWTEST_F(RSRenderEdgeLightFilterTest, ParcelBoolTest001, TestSize.Level1)
{
    ...
    Parcel parcel1;
    EXPECT_TRUE(RSRenderPropertyBase::Marshalling(parcel1, boolProperty1));
    EXPECT_TRUE(RSRenderPropertyBase::Unmarshalling(parcel1, boolProperty1));
    ...
    Parcel parcel2;
    EXPECT_TRUE(RSRenderPropertyBase::Marshalling(parcel2, v4fProperty1));
    v4fProperty1->SetPropertyType(RSPropertyType::BOOL);
    EXPECT_TRUE(RSRenderPropertyBase::Unmarshalling(parcel2, v4fProperty1));
    ...
    Parcel parcel3;
    EXPECT_TRUE(RSRenderPropertyBase::Marshalling(parcel3, v4fProperty2));
    EXPECT_TRUE(RSRenderPropertyBase::Unmarshalling(parcel3, boolProperty2));
}
} // namespace OHOS::Rosen