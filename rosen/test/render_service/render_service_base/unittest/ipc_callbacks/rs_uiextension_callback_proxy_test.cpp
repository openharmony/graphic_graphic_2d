...
void RSUIExtensionCallbackProxyTest::SetUpTestCase() {}
void RSUIExtensionCallbackProxyTest::TearDownTestCase() {}
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUIExtensionCallbackProxyTest, OnUIExtension001, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUIExtensionCallbackProxyTest, OnUIExtension002, TestSize.Level1)
{
    auto remoteMocker = new MockIRemoteObject();
    ASSERT_NE(remoteMocker, nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSUIExtensionCallbackProxyTest, OnUIExtension003, TestSize.Level1)
{
