...
class RSScreenChangeCallbackProxyTest : public testing::Test {
public:
...
void RSScreenChangeCallbackProxyTest::SetUpTestCase() {}
void RSScreenChangeCallbackProxyTest::TearDownTestCase() {}
void RSScreenChangeCallbackProxyTest::SetUp() {}
void RSScreenChangeCallbackProxyTest::TearDown() {}
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSScreenChangeCallbackProxyTest, OnScreenChanged001, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSScreenChangeCallbackProxyTest, OnScreenChanged002, TestSize.Level1)
{
    sptr<MockIRemoteObject> remoteMocker = new MockIRemoteObject();
    ASSERT_TRUE(remoteMocker != nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSScreenChangeCallbackProxyTest, OnScreenChanged003, TestSize.Level1)
{
