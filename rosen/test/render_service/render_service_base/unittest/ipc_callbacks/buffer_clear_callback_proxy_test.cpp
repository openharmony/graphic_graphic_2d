...
class RSBufferClearCallbackProxyTest : public testing::Test {
public:
...
void RSBufferClearCallbackProxyTest::SetUpTestCase() {}
void RSBufferClearCallbackProxyTest::TearDownTestCase() {}
void RSBufferClearCallbackProxyTest::SetUp() {}
void RSBufferClearCallbackProxyTest::TearDown() {}
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSBufferClearCallbackProxyTest, OnBufferClear001, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSBufferClearCallbackProxyTest, OnBufferClear002, TestSize.Level1)
{
    sptr<MockIRemoteObject> remoteMocker = new MockIRemoteObject();
    ASSERT_TRUE(remoteMocker != nullptr);
...
* @tc.type:FUNC
*/
HWTEST_F(RSBufferClearCallbackProxyTest, OnBufferClear003, TestSize.Level1)
{
