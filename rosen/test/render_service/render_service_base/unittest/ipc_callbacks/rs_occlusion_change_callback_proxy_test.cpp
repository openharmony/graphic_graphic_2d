...
class RSOcclusionChangeCallbackProxyTest : public testing::Test {
public:
...
void RSOcclusionChangeCallbackProxyTest::SetUpTestCase() {}
void RSOcclusionChangeCallbackProxyTest::TearDownTestCase() {}
void RSOcclusionChangeCallbackProxyTest::SetUp() {}
void RSOcclusionChangeCallbackProxyTest::TearDown() {}
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSOcclusionChangeCallbackProxyTest, OnOcclusionVisibleChanged001, TestSize.Level1)
{
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSOcclusionChangeCallbackProxyTest, OnOcclusionVisibleChanged002, TestSize.Level1)
{
    sptr<MockIRemoteObject> remoteMocker = new MockIRemoteObject();
    ASSERT_TRUE(remoteMocker != nullptr);
 ...
 * @tc.type:FUNC
 */
HWTEST_F(RSOcclusionChangeCallbackProxyTest, OnOcclusionVisibleChanged003, TestSize.Level1)
{
