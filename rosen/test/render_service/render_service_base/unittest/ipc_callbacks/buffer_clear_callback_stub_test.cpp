...
class RSBufferClearCallbackStubTest : public testing::Test {
public:
...
void RSBufferClearCallbackStubTest::SetUpTestCase() {}
void RSBufferClearCallbackStubTest::TearDownTestCase() {}
void RSBufferClearCallbackStubTest::SetUp() {}
void RSBufferClearCallbackStubTest::TearDown() {}
 ...
 */
HWTEST_F(RSBufferClearCallbackStubTest, OnRemoteRequest001, TestSize.Level1)
{
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.require: issueIAKP5Y
 */
HWTEST_F(RSBufferClearCallbackStubTest, OnRemoteRequest002, TestSize.Level1)
{
    MessageParcel data;
    MessageParcel reply;
    MessageOption option;
