...
#include "rssurfaceocclusionchangecallbackstub_fuzzer.h"
...
bool DoSomethingInterestingWithMyAPI(const uint8_t* data, size_t size)
{
    ...
    MySurfaceOcclusionChangeCallbackStub mySurfaceOcclusionChangeCallbackStub;
    mySurfaceOcclusionChangeCallbackStub.OnRemoteRequest(code, messageParcel, reply, option);
    return true;
}
} // namespace Rosen
} // namespace OHOS
