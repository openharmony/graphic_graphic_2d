 ...
 * @tc.desc: test QueryMaxGpuBufferSize with null renderContext
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRenderThreadTest, QueryMaxGpuBufferSize001, TestSize.Level1)
{
    RSRenderThread::Instance().renderContext_ = nullptr;
    uint32_t maxWidth = 0;
    uint32_t maxHeight = 0;
    bool result = RSRenderThread::Instance().QueryMaxGpuBufferSize(maxWidth, maxHeight);
    EXPECT_FALSE(result);
 ...
 * @tc.desc: test QueryMaxGpuBufferSize with valid renderContext
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRenderThreadTest, QueryMaxGpuBufferSize002, TestSize.Level1)
{
    RSRenderThread::Instance().CreateAndInitRenderContextIfNeed();
    uint32_t maxWidth = 0;
    uint32_t maxHeight = 0;
 ...
 * @tc.desc: test QueryMaxGpuBufferSize with pre-set values
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRenderThreadTest, QueryMaxGpuBufferSize003, TestSize.Level1)
{
    RSRenderThread::Instance().CreateAndInitRenderContextIfNeed();
...
#else
    EXPECT_FALSE(result);
    EXPECT_EQ(maxWidth, 4096);
    EXPECT_EQ(maxHeight, 4096);
#endif
}

/**
 * @tc.name: QueryMaxGpuBufferSize004
 * @tc.desc: test QueryMaxGpuBufferSize multiple calls
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRenderThreadTest, QueryMaxGpuBufferSize004, TestSize.Level1)
{
    RSRenderThread::Instance().CreateAndInitRenderContextIfNeed();
    uint32_t maxWidth1 = 0;
    uint32_t maxHeight1 = 0;
    bool result1 = RSRenderThread::Instance().QueryMaxGpuBufferSize(maxWidth1, maxHeight1);

    uint32_t maxWidth2 = 0;
    uint32_t maxHeight2 = 0;
    bool result2 = RSRenderThread::Instance().QueryMaxGpuBufferSize(maxWidth2, maxHeight2);
...
/**
 * @tc.name: QueryMaxGpuBufferSize005
 * @tc.desc: test QueryMaxGpuBufferSize with UINT32_MAX initial values
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(RSRenderThreadTest, QueryMaxGpuBufferSize005, TestSize.Level1)
{
    RSRenderThread::Instance().CreateAndInitRenderContextIfNeed();
...
#else
    EXPECT_FALSE(result);
    EXPECT_EQ(maxWidth, UINT32_MAX);
    EXPECT_EQ(maxHeight, UINT32_MAX);
#endif
}
