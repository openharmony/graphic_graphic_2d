...
class RSBackgroundStyleModifierNGTypeTest : public testing::Test {
public:
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSBackgroundStyleModifierNGTypeTest, RSBackgroundStyleModifierTest, TestSize.Level1)
{
