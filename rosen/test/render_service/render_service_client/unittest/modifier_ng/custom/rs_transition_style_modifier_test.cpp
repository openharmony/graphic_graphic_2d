...
class RSTransitionStyleModifierNGTypeTest : public testing::Test {
public:
 ...
 * @tc.type: FUNC
 */
HWTEST_F(RSTransitionStyleModifierNGTypeTest, RSTransitionStyleModifierTest, TestSize.Level1)
{
