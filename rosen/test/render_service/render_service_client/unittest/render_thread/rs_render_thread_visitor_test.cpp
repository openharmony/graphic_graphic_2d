 ...
 */
HWTEST_F(RSRenderThreadVisitorTest, PrepareCanvasRenderNode007, TestSize.Level1)
{
...
HWTEST_F(RSRenderThreadVisitorTest, PrepareRootRenderNode002, TestSize.Level1)
{
    ...
    auto surfaceNode = RSSurfaceNode::Create(config, true, CreateRSUIDirector()->GetRSUIContext());
 ...
 * @tc.require: issueI9TXX3
 */
HWTEST_F(RSRenderThreadVisitorTest, ProcessCanvasRenderNode005, TestSize.Level1)
{
    RSCanvasRenderNode node(0);
    RSRenderThreadVisitor rsRenderThreadVisitor;
    node.shouldPaint_ = false;
...
HWTEST_F(RSRenderThreadVisitorTest, ProcessRootRenderNode007, TestSize.Level1)
{
    ...
    auto surfacenode = RSSurfaceNode::Create(surfaceNodeConfig, true, CreateRSUIDirector()->GetRSUIContext());
    constexpr NodeId nodeId = TestSrc::limitNumber::Uint64[4];
