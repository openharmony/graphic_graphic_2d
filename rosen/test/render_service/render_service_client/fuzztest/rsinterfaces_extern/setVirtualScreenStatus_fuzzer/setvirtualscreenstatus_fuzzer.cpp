...
#include "setvirtualscreenstatus_fuzzer.h"
...
namespace {
const uint8_t DO_SET_VIRTUAL_SCREEN_STATUS = 0;
...
void DoSetVirtualScreenStatus(FuzzedDataProvider& fdp)
{
    ...
    auto screenStatus = static_cast<VirtualScreenStatus>(fdp.ConsumeIntegral<uint32_t>());

    g_rsInterfaces->SetVirtualScreenStatus(id, screenStatus);
}
