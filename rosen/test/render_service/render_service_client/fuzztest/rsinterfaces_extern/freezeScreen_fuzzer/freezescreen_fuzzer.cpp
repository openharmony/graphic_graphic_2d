...
#include "freezescreen_fuzzer.h"

#include <fuzzer/FuzzedDataProvider.h>

#include "transaction/rs_interfaces.h"
#include "pipeline/rs_display_node.h"
...
namespace {
const uint8_t DO_FREEZE_SCREEN = 0;
const uint8_t TARGET_SIZE = 1;

void DoFreezeScreen(FuzzedDataProvider& fdp)
{
    ...
    g_rsInterfaces->FreezeScreen(displayNode, isFreeze);
}
