...
HWTEST_F(NativeDisplaySoloistTest, OH_DisplaySoloist_Start001, Function | MediumTest | Level2)
{
    ...
    OH_DisplaySoloist_Start(nullptr, callback, nullptr);
}
...
{
    OH_DisplaySoloist_FrameCallback callback = OnVSync;
    OH_DisplaySoloist_Start(nativeDisplaySoloist, callback, nullptr);
}
...
HWTEST_F(NativeDisplaySoloistTest, OH_DisplaySoloist_SetExpectedFrameRateRange001, Function | MediumTest | Level2)
{
    ...
    OH_DisplaySoloist_SetExpectedFrameRateRange(nullptr, &validRange);
    OH_DisplaySoloist_SetExpectedFrameRateRange(nativeDisplaySoloist, nullptr);
}
...
HWTEST_F(NativeDisplaySoloistTest, OH_DisplaySoloist_SetExpectedFrameRateRange002, Function | MediumTest | Level2)
{
    ...
    OH_DisplaySoloist_SetExpectedFrameRateRange(nullptr, &invalidRange);
}
...
{
    OH_DisplaySoloist_Stop(nullptr);
}
...
{
    OH_DisplaySoloist_Stop(nativeDisplaySoloist);
}
...
{
    OH_DisplaySoloist_Destroy(nullptr);
}
