...
#ifndef FRAMEWORKS_OPENGL_WRAPPER_EGL_WRAPPER_CUSTOM_H
#define FRAMEWORKS_OPENGL_WRAPPER_EGL_WRAPPER_CUSTOM_H
...
#endif // FRAMEWORKS_OPENGL_WRAPPER_EGL_WRAPPER_CUSTOM_H