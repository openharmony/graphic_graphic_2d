...
void SetTextStyle(OH_Drawing_TextStyle* txtStyle)
{
    ...
    OH_Drawing_SetTextStyleDecorationThicknessScale(txtStyle, GetObject<uint32_t>());
    OH_Drawing_SetTextStyleLetterSpacing(txtStyle, GetObject<uint32_t>());
    OH_Drawing_SetTextStyleWordSpacing(txtStyle, GetObject<uint32_t>());
    OH_Drawing_SetTextStyleHalfLeading(txtStyle, GetObject<uint32_t>());
