...
class NdkTypographyStyleAutoSpaceTest : public testing::Test {
public:
...
void NdkTypographyStyleAutoSpaceTest::PrepareWorkForTypographyStyleTest()
{
...
void NdkTypographyStyleAutoSpaceTest::PrepareWorkForAutoSpaceTest(std::string& text, double layoutWidth)
{
...
void NdkTypographyStyleAutoSpaceTest::TearDown()
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(NdkTypographyStyleAutoSpaceTest, SetTypographyTextAutoSpaceSingleRun, TestSize.Level0)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(NdkTypographyStyleAutoSpaceTest, SetTypographyTextAutoSpaceSingleRunBoundaryWidth, TestSize.Level0)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(NdkTypographyStyleAutoSpaceTest, SetTypographyTextAutoSpaceMultiLine, TestSize.Level0)
{
    // Prepare Paragraph 1 and Paragraph 2, and turn on autospace and turn off autospace respectively.
 ...
 * @tc.type: FUNC
 */
HWTEST_F(NdkTypographyStyleAutoSpaceTest, SetTypographyTextAutoSpaceMultiLineBoundaryWidth, TestSize.Level0)
{
    // test boundary value：Use longestline without autospace as layout width when autospace enabled, line count + 1
    // Prepare Paragraph 1 and Paragraph 2, and turn on autospace and turn off autospace respectively.
    std::string text = "嫌疑者X的牺牲\n版权所有©2002-2001华为技术有限公司保留一切权利\n卸载USB设备";
 ...
 * @tc.type: FUNC
 */
HWTEST_F(NdkTypographyStyleAutoSpaceTest, SetTypographyTextAutoSpaceTextLineImageBounds, TestSize.Level0)
{
    // Prepare Paragraph 1 and Paragraph 2, and turn on autospace and turn off autospace respectively.
    std::string text = "嫌疑者X的牺牲";
    PrepareWorkForAutoSpaceTest(text, DEFAULT_LAYOUT_WIDTH);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(NdkTypographyStyleAutoSpaceTest, SetTypographyTextAutoSpaceTextLineOffsetForStringIndex, TestSize.Level0)
{
    // Prepare Paragraph 1 and Paragraph 2, and turn on autospace and turn off autospace respectively.
    std::string text = "嫌疑者X的牺牲";
    PrepareWorkForAutoSpaceTest(text, DEFAULT_LAYOUT_WIDTH);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(NdkTypographyStyleAutoSpaceTest, SetTypographyTextAutoSpaceRunTypographicBounds, TestSize.Level0)
{
    // Prepare Paragraph 1 and Paragraph 2, and turn on autospace and turn off autospace respectively.
    std::string text = "嫌疑者X的牺牲";
    PrepareWorkForAutoSpaceTest(text, DEFAULT_LAYOUT_WIDTH);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(NdkTypographyStyleAutoSpaceTest, SetTypographyTextAutoSpaceRunImageBounds, TestSize.Level0)
{
    // Prepare Paragraph 1 and Paragraph 2, and turn on autospace and turn off autospace respectively.
    std::string text = "嫌疑者X的牺牲";
    PrepareWorkForAutoSpaceTest(text, DEFAULT_LAYOUT_WIDTH);
