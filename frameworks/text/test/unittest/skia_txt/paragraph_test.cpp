...
/*
 * @tc.name: ParagraphTestgetTextPathByClusterRange001
 * @tc.desc: test for get text path by glyph range
 * @tc.type: FUNC
 */
HWTEST_F(ParagraphTest, ParagraphTestgetTextPathByClusterRange001, TestSize.Level0)
{
    ParagraphStyle paragraphStyle;
    auto fontCollection = std::make_shared<FontCollection>();
    ASSERT_NE(fontCollection, nullptr);
    ...
    EXPECT_EQ(paths[0].styleBlock.fStyle.getFontSize(), 15.0);
    EXPECT_EQ(paths[2].styleBlock.fStyle.getFontSize(), 15.0);
    EXPECT_EQ(paths[3].styleBlock.fStyle.getFontSize(), 20.0);
    EXPECT_EQ(paths[8].styleBlock.fStyle.getFontSize(), 21.5);
}

/*
 * @tc.name: ParagraphTestgetTextPathByClusterRange002
 * @tc.desc: test for get text path by glyph range
 * @tc.type: FUNC
 */
HWTEST_F(ParagraphTest, ParagraphTestgetTextPathByClusterRange002, TestSize.Level0)
{
    ParagraphStyle paragraphStyle;
    auto fontCollection = std::make_shared<FontCollection>();
    ASSERT_NE(fontCollection, nullptr);
    ...
    EXPECT_EQ(paths[0].styleBlock.fStyle.getFontSize(), 15.0);
    EXPECT_EQ(paths[3].styleBlock.fStyle.getFontSize(), 15.0);
    EXPECT_EQ(paths[4].styleBlock.fStyle.getFontSize(), 20.0);
    EXPECT_EQ(paths[10].styleBlock.fStyle.getFontSize(), 21.5);
}
} // namespace txt