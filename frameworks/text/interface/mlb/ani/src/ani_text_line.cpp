...
ani_object AniTextLine::CreateTextLine(ani_env* env, Rosen::TextLineBase* textLine)
{
    ...
    ani_object textLineObj = AniTextUtils::CreateAniObject(
        env, ANI_FIND_CLASS(env, ANI_CLASS_TEXT_LINE), ANI_CLASS_FIND_METHOD(env, TEXT_LINE_KEY));
    ani_status ret =
...
{
    AniTextLine* aniTextline =
        AniTextUtils::GetNativeFromObj<AniTextLine>(env, object, ANI_CLASS_FIND_METHOD(env, TEXT_LINE_GET_NATIVE_KEY));
