...
{
    AniLineTypeset* aniLineTypeSet = AniTextUtils::GetNativeFromObj<AniLineTypeset>(env, object, ANI_CLASS_FIND_METHOD(env, ANI_CLASS_LINE_TYPESET, "<get>nativeObj", ":l"));
