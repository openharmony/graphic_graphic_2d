    ...
    NapiAsyncExecute execute, NapiAsyncComplete complete)
{
    ...
    NAPI_CHECK_ARGS(contextBase, stat == napi_ok, stat, TextErrorCode::ERROR,
        return NapiTextResult::Error(MLB::ERROR_INVALID_PARAM, "Failed to create string,", promise),
    ...
    NAPI_CHECK_ARGS(contextBase, stat == napi_ok, stat, TextErrorCode::ERROR,
        return NapiTextResult::Error(MLB::ERROR_INVALID_PARAM, "Failed to create async work", promise),
    ...
    NAPI_CHECK_ARGS(contextBase, stat == napi_ok, stat, TextErrorCode::ERROR,
        return NapiTextResult::Error(MLB::ERROR_INVALID_PARAM, "Failed to queue async work", promise),
