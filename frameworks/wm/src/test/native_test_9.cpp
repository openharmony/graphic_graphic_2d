...
namespace {
class NativeTest9 : public NativeTest1 {
public:
    std::string GetDescription() const override
    {
        constexpr const char *desc = "resize";
        return desc;
    }

    int32_t GetID() const override
    {
        constexpr int32_t id = 9;
        return id;
    }
    ...
    void AfterRun()
    {
        ...
        PostTask(std::bind(&NativeTest9::AfterRun, this), delayTime);
    }
