...
#include "wmclient_native_test_15.h"
...
namespace {
class WMClientNativeTest15 : public INativeTest {
public:
    ...
    void AfterRunWindow() const
    {
        ...
        PostTask(std::bind(&WMClientNativeTest15::AfterRunWindow, this), delayTime);
    }
    ...
    void AfterRunSubwindow() const
    {
        ...
        constexpr uint32_t delayTime = 2000;
        PostTask(std::bind(&WMClientNativeTest15::AfterRunSubwindow, this), delayTime);
    }
