...
static const std::vector<struct JsEnumInt> g_textHighContrast = {
    {"TEXT_FOLLOW_SYSTEM_HIGH_CONTRAST", static_cast<size_t>(TextHighContrast::TEXT_FOLLOW_SYSTEM_HIGH_CONTRAST)},
    {"TEXT_APP_DISABLE_HIGH_CONTRAST", static_cast<size_t>(TextHighContrast::TEXT_APP_DISABLE_HIGH_CONTRAST)},
