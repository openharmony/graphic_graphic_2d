...
private:
    ...
    static napi_value CreateColorfulBrightnessBlender(napi_env env, napi_callback_info info);
    static bool ParseColorfulBrightnessBlender(napi_env env, napi_value paramObj,
