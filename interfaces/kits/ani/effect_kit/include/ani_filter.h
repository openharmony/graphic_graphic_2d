...
public:
    ...
    static ani_object GetEffectPixelMap(ani_env* env, ani_object obj, ani_boolean useCpuRender);
    static ani_object GetPixelMapAsync(ani_env* env, ani_object obj);
    static ani_object GetEffectPixelMapSync(ani_env* env, ani_object obj, ani_boolean useCpuRender);
