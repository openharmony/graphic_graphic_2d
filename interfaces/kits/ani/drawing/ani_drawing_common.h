...
constexpr const char* ANI_BOOLEAN_STRING = "std.core.Boolean";
constexpr const char* ANI_BUSINESS_ERROR_STRING = "@ohos.base.BusinessError";
constexpr const char* ANI_ARRAY_STRING = "std.core.Array";
...
constexpr const char* ANI_CLASS_COLOR_SPACE_MANAGER_NAME =
...
constexpr const char* ANI_ENUM_PATH_FILL_TYPE = "@ohos.graphics.drawing.drawing.PathFillType";
...
constexpr const char* ANI_CLASS_COLOR4F_NAME = "@ohos.graphics.common2D.common2D.Color4fInternal";
...
constexpr const char* ANI_CLASS_FONTFEATURE_NAME = "@ohos.graphics.text.text.FontFeatureInternal";
...
constexpr const char* ANI_INTERFACE_COLOR4F_NAME = "@ohos.graphics.common2D.common2D.Color4f";
