...
namespace OHOS {
namespace Rosen {
TaiheWindowAnimationFinishedCallback::TaiheWindowAnimationFinishedCallback(
...
void TaiheWindowAnimationFinishedCallback::OnAnimationFinished()
{
    TWA_LOGD("TaiheWindowAnimationFinishedCallback::OnAnimationFinished");
