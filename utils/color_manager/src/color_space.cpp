...
const ColorSpacePrimaries CSP_BT601_625 = {0.640f, 0.330f, 0.290f, 0.600f, 0.150f, 0.060f, 0.3127f, 0.3290f};
const ColorSpacePrimaries CSP_BT601_525 = {0.630f, 0.340f, 0.310f, 0.595f, 0.155f, 0.070f, 0.3127f, 0.3290f};
...
const ColorSpace CS_BT2020_SRGB = {CSP_BT2020, TF_SRGB};
const ColorSpace CS_BT2020_LINEAR = {CSP_BT2020, TF_LINEAR};
const ColorSpace CS_DISPLAY_P3 = {CSP_DISPLAY_P3, TF_SRGB};
const ColorSpace CS_DISPLAY_P3_LINEAR = {CSP_DISPLAY_P3, TF_LINEAR};
