...
#define ANIMATION_ASYNC_TRACE_BEGIN(name, value) StartAsyncTrace(HITRACE_TAG_ANIMATION, name, value)
#define RS_ASYNC_TRACE_BEGIN(name, value) StartAsyncTrace(HITRACE_TAG_GRAPHIC_AGP, name, value)
#define ANIMATION_ASYNC_TRACE_END(name, value) FinishAsyncTrace(HITRACE_TAG_ANIMATION, name, value)
...
#define ANIMATION_ASYNC_TRACE_BEGIN(name, value)
#define RS_ASYNC_TRACE_BEGIN(name, value)
#define ANIMATION_ASYNC_TRACE_END(name, value)
