...
/* SetPositionZ: -50 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PositionZ_Test_1)
{
...
/* SetPositionZ: 0 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PositionZ_Test_2)
{
...
/* SetPositionZ: 50 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PositionZ_Test_3)
{
...
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PositionZApplicableCamera3D_Test_1)
{
...
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PositionZApplicableCamera3D_Test_2)
{
...
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, PivotZ_Alpha_Rotation_Test_1)
{
...
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, PivotZ_Alpha_Rotation_Test_2)
{
    int row = 5;
    int col = 3;
...
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, PivotZ_Alpha_Rotation_Test_3)
{
    int row = 5;
    int col = 3;
    int nodeSize[2] = {screenWidth / col, screenHeight / row};
...
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_Pivot_Test_1)
{
...
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_Pivot_Test_2)
{
...
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_Pivot_Test_3)
{
...
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_Pivot_Test_4)
{
    vector<Vector2f> vecs = {{0.5, -1.25}, {-1.25, 0.75}, {0.5, 0.5}, {0.5, 0.25}, {-0.5, -0.5}, {1.25, 1.25}};
    for (int i = 0; i < vecs.size(); i++) {
        auto testNode = SetUpNodeBgImage("/data/local/tmp/geom_test.jpg", {380, i * 350 + 20, 300, 300});
...
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_Pivot_Test_5)
{
    vector<Vector2f> vecs = {{0.5, -1.25}, {-1.25, 0.75}, {0.5, 0.5}, {0.5, 0.25}, {-0.5, -0.5}, {1.25, 1.25}};
    for (int i = 0; i < vecs.size(); i++) {
        auto testNode = SetUpNodeBgImage("/data/local/tmp/geom_test.jpg", {380, i * 350 + 20, 300, 300});
...
/* SetPivotX: = 0 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PivotX_Test_1)
{
...
/* SetPivotX: = 1 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PivotX_Test_2)
{
...
/* SetPivotY: = 0 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PivotY_Test_1)
{
...
/* SetPivotY: = 1 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PivotY_Test_2)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/geom_test.jpg", { 380, 350, 300, 300 });
    testNode->SetAlpha(0.5f);
...
/* SetPivotXY: = 0,0 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PivotXY_Test_1)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/geom_test.jpg", { 380, 350, 300, 300 });
    testNode->SetAlpha(0.5f);
...
/* SetPivot: = 0,1 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PivotXY_Test_2)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/geom_test.jpg", { 380, 350, 300, 300 });
    testNode->SetAlpha(0.5f);
...
/* SetPivotXY: = 1,0 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PivotXY_Test_3)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/geom_test.jpg", { 380, 350, 300, 300 });
    testNode->SetAlpha(0.5f);
...
/* SetPivot: = 1,1 */
GRAPHIC_TEST(GeometryTest01, CONTENT_DISPLAY_TEST, Geometry_Alpha_PivotXY_Test_4)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/geom_test.jpg", { 380, 350, 300, 300 });
    testNode->SetAlpha(0.5f);
