...
class AppearanceTest05 : public RSGraphicTest {
private:
...
// color
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Color_Test_1)
{
...
// width
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Width_Test_1)
{
    ...
    for (int i = 0; i < nodeCount; i++) {
        ...
        testNodeWidth->SetAlpha(0.25f * i);
    ...
    testNodeFourWidth->SetAlpha(0.1f);
...
// 2 -- Dot
// 3 -- None
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_1)
{
    const int nodeCount = 4;
    const int columnCount = 2;
    const int nodeSize = 500;
    ...
    testNodeFourStyle->SetAlpha(0.2f);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_2)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
    ...
    auto testNodeFourStyle = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    testNodeFourStyle->SetAlpha(0.3f);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_3)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
    ...
    auto testNodeFourStyle = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    testNodeFourStyle->SetAlpha(0.4f);
    testNodeFourStyle->SetBounds({ posX, posY, nodeSize, nodeSize });
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_4)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
    ...
    auto testNodeFourStyle = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    testNodeFourStyle->SetAlpha(0.5f);
    testNodeFourStyle->SetBounds({ posX, posY, nodeSize, nodeSize });
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_5)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
    ...
    auto testNodeFourStyle = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    testNodeFourStyle->SetAlpha(0.6f);
    testNodeFourStyle->SetBounds({ posX, posY, nodeSize, nodeSize });
    testNodeFourStyle->SetBorderStyle(0, 2, 0, 0);
    testNodeFourStyle->SetBorderWidth(borderWidth, borderWidth, borderWidth, borderWidth);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_6)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
    ...
    auto testNodeFourStyle = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    testNodeFourStyle->SetAlpha(0.7f);
    testNodeFourStyle->SetBounds({ posX, posY, nodeSize, nodeSize });
    testNodeFourStyle->SetBorderStyle(0, 2, 0, 0);
    testNodeFourStyle->SetBorderWidth(borderWidth, borderWidth, borderWidth, borderWidth);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_7)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_8)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
    ...
    auto testNodeFourStyle = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    testNodeFourStyle->SetAlpha(0.9f);
    testNodeFourStyle->SetBounds({ posX, posY, nodeSize, nodeSize });
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_9)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
    ...
    auto testNodeFourStyle = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    testNodeFourStyle->SetAlpha(0.1f);
    testNodeFourStyle->SetBounds({ posX, posY, nodeSize, nodeSize });
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_10)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_11)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Style_Test_12)
{
    const int nodeSize = 500;
    const int borderWidth = 5;
    int posX = 0, posY = 0;
...
// Dash Width
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_DashWidth_Test_1)
{
    ...
    for (int i = 0; i < nodeCount; i++) {
        ...
        testNodeDashWidth->SetAlpha(0.25f * i);
...
// Dash Gap
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_DashGap_Test_1)
{
    ...
    for (int i = 0; i < nodeCount; i++) {
        ...
        testNodeDashGap->SetAlpha(0.25f * i);
    ...
    testNodeFourDashGap->SetAlpha(0.7f);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Touch_Test_1)
{
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bounds_Test)
{
    int columnCount = 2;
    int rowCount = 4;
    ...
    for (int i = 0; i < rowCount; i++) {
        ...
        RSGraphicTestDirector::Instance().GetRSUIContext());
        testNodeBackGround2->SetAlpha(0.333f * i);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_OuterBorder_Style_Test_1)
{
    const int nodeCount = 4;
    const int columnCount = 2;
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_BorderWidth_OutlineWidth_Test_1)
{
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_BackgroundColor_Test_1)
{
    int columnCount = 2;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test01)
{
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test02)
{
    vector<vector<float>> vecs = {
        {0, 0, 500, 500}, // rect of bound
        {0x8F00001F, 0x8F00002F, 0x8F00003F, 0x8F00004F}, // color of border
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test03)
{
    vector<vector<float>> vecs = {
        {0, 0, 500, 500}, // rect of bound
        {0x8F00001F, 0x8F00002F, 0x8F00003F, 0x8F00004F}, // color of border
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test04)
{
    vector<vector<float>> vecs = {
        {0, 0, 500, 500}, // rect of bound
        {0x8F00001F, 0x8F00002F, 0x8F00003F, 0x8F00004F}, // color of border
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test05)
{
    vector<vector<float>> vecs = {
        {0, 0, 500, 500}, // rect of bound
        {0x8F00001F, 0x8F00002F, 0x8F00003F, 0x8F00004F}, // color of border
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test06)
{
    vector<vector<float>> vecs = {
        {0, 0, 500, 500}, // rect of bound
        {0x8F00001F, 0x8F00002F, 0x8F00003F, 0x8F00004F}, // color of border
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test07)
{
    vector<vector<float>> vecs = {
        {0, 0, 500, 500}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test08)
{
    vector<vector<float>> vecs = {
        {0, 0, 500, 500}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test09)
{
    vector<vector<float>> vecs = {
        {0, 0, 500, 500}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test010)
{
    vector<vector<float>> vecs = {
        {0, 0, 500, 500}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test011)
{
    vector<vector<float>> vecs = {
        {0, 0, 500, 500}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test012)
{
    vector<vector<float>> vecs = {
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test013)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test014)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test015)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test016)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test017)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test018)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test019)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test020)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test021)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test022)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test023)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test024)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test025)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test026)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test027)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test028)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test029)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test030)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test031)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test032)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test033)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test034)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test035)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test036)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test037)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test038)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Test039)
{
    vector<vector<float>> vecs = {
        {0, 500, 400, 400}, // rect of bound
        {0xff000000, 0x8F38002F, 0x8F39003F, 0x8F40004F}, // color of border
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test001)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test002)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test003)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test004)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50,  -100, -400, 400 }, {0, 0, 0, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test005)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50,  -100, -400, -400 }, {0, 0, 0, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test006)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test007)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, -400, -400 }, {0, 0, 0, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test008)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, 400, -400 }, {0, 0, 0, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test009)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, 400, 400 }, {0, 0, 0, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test010)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test011)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test012)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test013)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50,  -100, -400, 400 }, {100, 100, 100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test014)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50,  -100, -400, -400 }, {100, 100, 100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test015)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test016)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, -400, -400 }, {100, 100, 100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test017)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, 400, -400 }, {100, 100, 100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test018)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, 400, 400 }, {100, 100, 100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test019)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 0, 0, 400, 400 }, {100, 100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test020)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50, 0, 400, 400 }, {100, 100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test021)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50,  -100, 400, 400 }, {100, 100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test022)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50,  -100, -400, 400 }, {100, 100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test023)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50,  -100, -400, -400 }, {100, 100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test024)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  -100, -400, -400 }, {100, 100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test025)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, -400, -400 }, {100, 100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test026)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, 400, -400 }, {100, 100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test027)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, 400, 400 }, {100, 100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test028)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 0, 0, 400, 400 }, {-100, -100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test029)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50, 0, 400, 400 }, {-100, -100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test030)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50,  -100, 400, 400 }, {-100, -100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test031)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50,  -100, -400, 400 }, {-100, -100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test032)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { -50,  -100, -400, -400 }, {-100, -100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test033)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  -100, -400, -400 }, {-100, -100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test034)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, -400, -400 }, {-100, -100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test035)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, 400, -400 }, {-100, -100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
...
GRAPHIC_TEST(AppearanceTest05, CONTENT_DISPLAY_TEST, Appearance_Alpha_Bound_Test036)
{
    auto testNodeParent = RSCanvasNode::Create(false, false, RSGraphicTestDirector::Instance().GetRSUIContext());
    setNode(testNodeParent, { 100,  100, 400, 400 }, {-100, -100, -100, 0});
    GetRootNode()->AddChild(testNodeParent);
