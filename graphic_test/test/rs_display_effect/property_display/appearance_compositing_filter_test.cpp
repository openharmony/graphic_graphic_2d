...
/* CompositingFilter: with background image */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_CompositingFilter_Test_2)
{
...
/* CompositingFilter: clip */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_CompositingFilter_Test_6)
{
...
/* CompositingFilter: extreme bounds */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_CompositingFilter_Extreme_Bounds)
{
...
/* CompositingFilter: zero/negative dimensions */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_CompositingFilter_Zero_Dimensions)
{
