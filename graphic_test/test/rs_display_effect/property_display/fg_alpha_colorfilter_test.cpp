...
class ForegroundTest04 : public RSGraphicTest {
private:
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, GrayScale_Alpha_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Brightness_Alpha_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Contrast_Alpha_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Saturate_Alpha_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Sepia_Alpha_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Color_Alpha_Invert_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, HueRotate_Alpha_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, ColorBlend_Alpha_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Color_Alpha_AiInvert_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Foreground_Alpha_Filter_Test_1)
{
    int columnCount = 2;
    int rowCount = 2;
