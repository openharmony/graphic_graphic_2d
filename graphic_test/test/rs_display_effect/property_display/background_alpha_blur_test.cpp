...
class BackgroundTest04 : public RSGraphicTest {
private:
...
GRAPHIC_TEST(BackgroundTest04, CONTENT_DISPLAY_TEST, Background_Alpha_Blur_Radius_Test)
{
    int columnCount = 3;
    int rowCount = 3;
...
GRAPHIC_TEST(BackgroundTest04, CONTENT_DISPLAY_TEST, Background_Alpha_Blur_Radius_XY_Test)
{
    int columnCount = 4;
    int rowCount = 4;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest04, CONTENT_DISPLAY_TEST, Background_Alpha_Blur_Saturation_Test)
{
    int columnCount = 2;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
    ...
    for (int i = 0; i < saturationList.size(); i++) {
        ...
        auto testNodeBackGround =
            SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { x, y, sizeX - 10, sizeY - 10 });
        testNodeBackGround->SetAlpha(0.25f * i);
        testNodeBackGround->SetBorderStyle(0, 0, 0, 0);
        testNodeBackGround->SetBorderWidth(5, 5, 5, 5);
        testNodeBackGround->SetBorderColor(Vector4<Color>(RgbPalette::Red()));
...
GRAPHIC_TEST(BackgroundTest04, CONTENT_DISPLAY_TEST, Background_Alpha_Blur_Brightness_Test)
{
    int columnCount = 2;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest04, CONTENT_DISPLAY_TEST, Background_Alpha_Blur_Mask_Color_Test)
{
    int columnCount = 3;
    int rowCount = 4;
    auto sizeX = screenWidth / columnCount;
    ...
    for (int i = 0; i < colorList.size(); i++) {
        ...
        auto testNodeBackGround =
            SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { x, y, sizeX - 10, sizeY - 10 });
        testNodeBackGround->SetAlpha(0.09f * i);
        testNodeBackGround->SetBorderStyle(0, 0, 0, 0);
        testNodeBackGround->SetBorderWidth(5, 5, 5, 5);
        testNodeBackGround->SetBorderColor(Vector4<Color>(RgbPalette::Red()));
        testNodeBackGround->SetBackgroundBlurRadius(radiusList[i]);
...
GRAPHIC_TEST(BackgroundTest04, CONTENT_DISPLAY_TEST, Background_Alpha_Blur_Mask_Color_Alpha_Test)
{
    int columnCount = 3;
    int rowCount = 4;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest04, CONTENT_DISPLAY_TEST, Background_Alpha_Blur_Color_Mode_Test)
{
    int columnCount = 3;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
    ...
    for (int i = 0; i < colorModeList.size(); i++) {
        ...
        auto testNodeBackGround =
            SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { x, y, sizeX - 10, sizeY - 10 });
        testNodeBackGround->SetAlpha(0.12f * i);
        testNodeBackGround->SetBorderStyle(0, 0, 0, 0);
        testNodeBackGround->SetBorderWidth(5, 5, 5, 5);
        testNodeBackGround->SetBorderColor(Vector4<Color>(RgbPalette::Red()));
...
GRAPHIC_TEST(BackgroundTest04, CONTENT_DISPLAY_TEST, SystemBar_Alpha_Effect_Test)
{
    int columnCount = 1;
    int rowCount = 2;
    auto sizeX = screenWidth / columnCount;
    ...
    auto testNodeBackGround2 =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { x, y, sizeX - 10, sizeY - 10 });
    testNodeBackGround2->SetAlpha(0.8f);
    GetRootNode()->AddChild(testNodeBackGround2);
    RegisterNode(testNodeBackGround2);
}

GRAPHIC_TEST(BackgroundTest04, CONTENT_DISPLAY_TEST, Background_Alpha_MESA_Blur_Test)
{
    ...
    for (int i = 0; i < radiusList.size(); i++) {
        ...
        auto testNodeNormalBlur =
            SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { x, y, sizeX - 10, sizeY - 10 });
        testNodeNormalBlur->SetAlpha(0.333f * i);
        ...
        testNodeMesaBlur->SetAlpha(0.333f * i);
...
GRAPHIC_TEST(BackgroundTest04, CONTENT_DISPLAY_TEST, Background_Alpha_Filter_Test)
{
    int columnCount = 2;
    int rowCount = 2;
    auto sizeX = screenWidth / columnCount;
    ...
    auto testNodeBackGround2 =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { x, y, sizeX - 10, sizeY - 10 });
    testNodeBackGround2->SetAlpha(0.6f);
    ...
    auto testNodeBackGround3 =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { x, y, sizeX - 10, sizeY - 10 });
    testNodeBackGround3->SetAlpha(0.5f);
