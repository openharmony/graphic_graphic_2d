...
class BackgroundTest02 : public RSGraphicTest {
private:
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Pure_Color_Alpha_Image_Test1)
{
    auto testNodeBackGround = SetUpNodeBgImage("/data/local/tmp/Images/AllBlack.jpg", { 500, 500, 300, 300 });
    testNodeBackGround->SetAlpha(0.1f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Pure_Color_Alpha_Image_Test2)
{
...
/* SetBgImage：Images1 */
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Test1)
{
...
/* SetBgImage：Images2 */
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Test2)
{
...
/* SetBgImage：Images3 */
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Test3)
{
...
/* SetBgImage：Images4 */
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Test4)
{
    auto testNodeBackGround = SetUpNodeBgImage("/data/local/tmp/Images/3200x2000.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.6f);
    testNodeBackGround->SetBorderStyle(0, 0, 0, 0);
    testNodeBackGround->SetBorderWidth(5, 5, 5, 5);
    testNodeBackGround->SetBorderColor(Vector4<Color>(RgbPalette::Red()));
    GetRootNode()->AddChild(testNodeBackGround);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_InnerRect_Test1)
{
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_InnerRect_Test2)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_InnerRect_Test3)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_InnerRect_Test4)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.8f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_InnerRect_Test5)
{
    int columnCount = 2;
    int rowCount = 3;
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Width_Test1)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.7f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Width_Test2)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.6f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Width_Test3)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.5f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Width_Test4)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.4f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Width_Test5)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.3f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Height_Test1)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.2f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Height_Test2)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.1f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Height_Test3)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.2f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Height_Test4)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.3f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Height_Test5)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.4f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Size_Test1)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.5f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Size_Test2)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.6f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_PositionX_Test1)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.7f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_PositionX_Test2)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.8f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_PositionY_Test1)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.9f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_PositionY_Test2)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.8f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Position_Test1)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.7f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Position_Test2)
{
    auto testNodeBackGround =
        SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 100, 100, 500, 500 });
    testNodeBackGround->SetAlpha(0.6f);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Comp_Test1)
{
    int columnCount = 2;
    int rowCount = 2;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Comp_Test2)
{
    int columnCount = 2;
    int rowCount = 2;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Test)
{
    int columnCount = 2;
    int rowCount = 2;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_InnerRect_Test)
{
    int columnCount = 2;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Size_Test)
{
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Position_Test)
{
    std::vector<float> factorList = { -0.5, 0, 0.233, 0.5, 2 };
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Corner_Radius_Test)
{
    int columnCount = 2;
    int rowCount = 2;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_Alpha_Test)
{
    int columnCount = 2;
    int rowCount = 2;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Pure_Color_Alpha_Image_Test)
{
    int columnCount = 1;
    int rowCount = 2;
    auto sizeX = screenWidth / columnCount;
    ...
    for (int i = 0; i < pathList.size(); i++) {
        ...
        int y = (i / columnCount) * sizeY;
        auto testNodeBackGround = SetUpNodeBgImage(pathList[i], { x, y, sizeX - 10, sizeY - 10 });
        testNodeBackGround->SetAlpha(0.5f * i);
        testNodeBackGround->SetBorderStyle(0, 0, 0, 0);
        testNodeBackGround->SetBorderWidth(5, 5, 5, 5);
        testNodeBackGround->SetBorderColor(Vector4<Color>(RgbPalette::Red()));
        GetRootNode()->AddChild(testNodeBackGround);
...
GRAPHIC_TEST(BackgroundTest02, CONTENT_DISPLAY_TEST, Background_Alpha_Image_InnerRect_Test_1)
{
    int columnCount = 2;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
