...
class AppearanceTest11 : public RSGraphicTest {
private:
...
// color
GRAPHIC_TEST(AppearanceTest11, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Radius_Color_Test_1)
{
...
// width
GRAPHIC_TEST(AppearanceTest11, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Radius_Width_Test_1)
{
...
// 2 -- Dot
// 3 -- None
GRAPHIC_TEST(AppearanceTest11, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Radius_Style_Test_1)
{
    const int nodeCount = 4;
    const int columnCount = 2;
    const int nodeSize = 500;
...
// Dash Width
GRAPHIC_TEST(AppearanceTest11, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Radius_DashWidth_Test_1)
{
...
// Dash Gap
GRAPHIC_TEST(AppearanceTest11, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Radius_DashGap_Test_1)
{
...
GRAPHIC_TEST(AppearanceTest11, CONTENT_DISPLAY_TEST, Appearance_Alpha_Border_Radius_Touch_Test_1)
{
