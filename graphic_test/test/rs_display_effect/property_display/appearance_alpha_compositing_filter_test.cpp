...
/* CompositingFilter + Alpha: alpha = 0.5 */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_CompositingFilter_Test_1)
{
...
/* CompositingFilter + Alpha: different alpha */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_CompositingFilter_Test_2)
{
...
/* CompositingFilter + Alpha: with border */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_CompositingFilter_Test_3)
{
    auto testNode = RSCanvasNode::Create();
...
/* CompositingFilter + Alpha: update alpha */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_CompositingFilter_Test_4)
{
...
/* CompositingFilter + Alpha: boundary and abnormal values */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_CompositingFilter_Extremes)
{
...
/* CompositingFilter + Alpha: matrix test - alpha x border (3x3) */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_CompositingFilter_Matrix_3x3)
{
