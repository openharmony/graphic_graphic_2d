...
class AppearanceTest12 : public RSGraphicTest {
private:
...
GRAPHIC_TEST(AppearanceTest12, CONTENT_DISPLAY_TEST, Appearance__Alpha_Visible_Test)
{
    int columnCount = 1;
    int rowCount = 2;
...
GRAPHIC_TEST(AppearanceTest12, CONTENT_DISPLAY_TEST, Appearance__Alpha_PixelStretch_Test)
{
    int columnCount = 2;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(AppearanceTest12, CONTENT_DISPLAY_TEST, Appearance__Alpha_PixelStretchPercent_Test)
{
    int columnCount = 2;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(AppearanceTest12, CONTENT_DISPLAY_TEST, Appearance__Alpha_MotionBlur_Test)
{
    int columnCount = 2;
    int rowCount = 2;
    auto sizeX = screenWidth / columnCount;
