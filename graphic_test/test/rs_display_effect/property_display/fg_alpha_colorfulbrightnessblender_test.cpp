...
class ColorfulBrightnessBlenderAlphaTest : public RSGraphicTest {
private:
...
GRAPHIC_TEST(ColorfulBrightnessBlenderAlphaTest, CONTENT_DISPLAY_TEST,
    Foreground_Alpha_SetColorfulBrightnessBlender_Test_1)
{
...
GRAPHIC_TEST(ColorfulBrightnessBlenderAlphaTest, CONTENT_DISPLAY_TEST,
    Foreground_Alpha_SetColorfulBrightnessBlender_Test_2)
{
    float rateList[] = { -0.05, 0.0, 1.0, 20.0 };
    float saturationList[] = { 0.0, 5.0, 10.0, 20.0 };
...
GRAPHIC_TEST(ColorfulBrightnessBlenderAlphaTest, CONTENT_DISPLAY_TEST,
    Foreground_Alpha_SetColorfulBrightnessBlender_Test_3)
{
    float rateList[] = { -0.05, 0.0, 1.0, 20.0 };
    float saturationList[] = { 0.0, 5.0, 10.0, 20.0 };
