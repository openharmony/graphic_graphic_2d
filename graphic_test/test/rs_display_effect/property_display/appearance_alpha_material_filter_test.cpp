...
/* MaterialFilter + Alpha: alpha = 0.5 */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_MaterialFilter_Test_1)
{
...
/* MaterialFilter + Alpha: different alpha */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_MaterialFilter_Test_2)
{
...
/* MaterialFilter + Alpha: with border */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_MaterialFilter_Test_3)
{
    auto testNode = RSCanvasNode::Create();
...
/* MaterialFilter + Alpha: update alpha */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_MaterialFilter_Test_4)
{
...
/* MaterialFilter + Alpha: boundary and abnormal values */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_MaterialFilter_Extremes)
{
...
/* MaterialFilter + Alpha: matrix test - alpha x border (3x3) */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_Alpha_MaterialFilter_Matrix_3x3)
{
