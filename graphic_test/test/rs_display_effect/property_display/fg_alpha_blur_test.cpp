...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Blur_Alpha_ForegroundEffectRadius_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Blur_Alpha_Saturation_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Blur_Alpha_Brightness_Test_1)
{
    float radiusList[] = { 10.0, 0.0, 10.0, 10.0 };
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Blur_Alpha_Color_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Blur_Alpha_ColorMode_Test_1)
{
    for (int i = 0; i < THREE_; i++) {
        int x = (i % TWO_) * FIVE_HUNDRED_TEN_;
        int y = (i / TWO_) * FIVE_HUNDRED_TEN_;
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Blur_Alpha_RadiusXY_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Blur_Alpha_LinearGradientBlur_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest04, CONTENT_DISPLAY_TEST, Foreground_Alpha_Filter_Test)
{
    int columnCount = 2;
    int rowCount = 2;
