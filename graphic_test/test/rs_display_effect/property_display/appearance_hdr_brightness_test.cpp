...
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_HdrBrightness_Test_1)
{
    ...
    // This tests the HDR brightness rendering capability
    GetRootNode()->AddChild(testNode);
    RegisterNode(testNode);
}

/* HdrBrightness: with background image */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_HdrBrightness_Test_2)
{
...
/* HdrBrightness: clip */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_HdrBrightness_Test_6)
{
...
/* HdrBrightness: extreme bounds */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_HdrBrightness_Extreme_Bounds)
{
...
/* HdrBrightness: zero/negative dimensions */
GRAPHIC_TEST(AppearanceTest, CONTENT_DISPLAY_TEST, Appearance_HdrBrightness_Zero_Dimensions)
{
