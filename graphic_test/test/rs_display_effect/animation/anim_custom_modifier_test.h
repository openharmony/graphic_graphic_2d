...
public:
    ...
    void RecordCurrentPosition() const;

private:
    void RegisterAnimationFrameCallback();
    void DrawEmpty(DrawingContext& context) const;
    void DrawPositionCurve(DrawingContext& context) const;
    ...
    uint64_t animationFrameCallbackId_ = 0;
};
} // namespace Rosen
} // namespace OHOS
#endif
