...
const std::vector<std::array<float, REEDED_GLASS_PARAMS_COUNT>> reededGlassParams = {
    ...
    {0.5f, 0.3f, 0.2f, 0.5f, 10.0f, 1.0f, 0.5f, 0.5f, 1.0f, 1.0f,
      1.0f, 1.0f, 0.3f, 0.7f, 0.5f, 0.5f, 0.5f, 0.5f, 0.4f, 0.6f,
      0.3f, 0.7f, 0.2f, 0.8f, 0.4f, 0.6f, 0.5f, 0.5f, 0.3f, 0.7f,
      0.4f, 0.6f, 0.5f, 0.5f},
    {0.1f, 0.1f, 0.1f, 0.2f, 5.0f, 1.0f, 0.3f, 0.3f, 1.0f, 1.0f,
      1.0f, 1.0f, 0.2f, 0.8f, 0.3f, 0.3f, 0.7f, 0.3f, 0.2f, 0.4f,
      0.15f, 0.35f, 0.1f, 0.3f, 0.25f, 0.35f, 0.2f, 0.3f, 0.15f, 0.25f,
      0.2f, 0.3f, 0.1f, 0.2f},
    {0.9f, 0.8f, 0.5f, 0.8f, 20.0f, 1.5f, 0.8f, 0.8f, 1.0f, 1.0f,
      1.0f, 1.0f, 0.3f, 0.7f, 0.8f, 0.8f, 0.2f, 0.8f, 0.7f, 0.9f,
      0.6f, 1.0f, 0.5f, 0.9f, 0.7f, 0.9f, 0.6f, 0.8f, 0.7f, 0.9f,
      0.6f, 0.8f, 0.7f, 0.9f},
