...
std::vector<FilterTestData> CreateTestDataInvalidMin()
{
    return {
        ...
        { FilterPara::ParaType::DIRECTION_LIGHT,
            DirectionLightParams { { -1, -1, -1 }, { -1, -1, -1, -1 }, -1, -1, nullptr } },
...
std::vector<FilterTestData> CreateTestDataValidData1(const SharedMaskParams& maskParams)
{
    return {
        ...
        { FilterPara::ParaType::DIRECTION_LIGHT,
            DirectionLightParams { { 0.0f, 0.0f, 1.0f }, { 0.3f, 10.3f, 0.3f, 0.3f }, 0.3f, 0.3f, nullptr } },
...
std::vector<FilterTestData> CreateTestDataValidData3(const SharedMaskParams& maskParams)
{
    return {
        ...
        { FilterPara::ParaType::DIRECTION_LIGHT,
            DirectionLightParams { { 0.0f, 0.0f, -1.0f }, { 10.6f, 0.6f, 0.6f, 0.6f },
            0.7f, 0.7f, maskParams.pixelMapMaskPara } },
        { FilterPara::ParaType::DISPERSION,
...
std::vector<FilterTestData> CreateTestDataValidData4(const SharedMaskParams& maskParams)
{
    return {
        ...
        { FilterPara::ParaType::DIRECTION_LIGHT,
            DirectionLightParams { { 0.0f, 0.0f, -1.0f }, { 0.9f, 0.9f, 100.f, 10.0f },
            1.0f, 1.0f, maskParams.pixelMapMaskPara } },
        { FilterPara::ParaType::DISPERSION,
...
std::vector<FilterTestData> CreateTestDataInvalidMax()
{
    return {
        ...
        { FilterPara::ParaType::DIRECTION_LIGHT,
            DirectionLightParams { { 0.0f, 0.0f, 999.0f },
                { 999.0f, 999.0f, 999.0f, 999.0f },
                999.0f, 999.0f, nullptr } },
        { FilterPara::ParaType::DISPERSION,
