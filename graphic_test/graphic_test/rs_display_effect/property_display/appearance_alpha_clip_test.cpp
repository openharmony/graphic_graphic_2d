...
class AppearanceTest06 : public RSGraphicTest {
private:
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipRRect_Test_2)
{
    const Vector4f rect[] = {
        { 0.0, 0.0, 250.0, 250.0 },
        { 100.0, 100.0, 450.0, 450.0 },
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_CustomClipToFrame_Test_1)
{
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_SetClipBounds_RSPath_Test_1)
{
    int columnCount = 2;
    int rowCount = 4;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_001)
{
    Drawing::Path path;
    path.AddRect(0, 0, 200, 450, Drawing::PathDirection::CCW_DIRECTION);
    auto testNode1 = RSCanvasNode::Create();
    testNode1->SetAlpha(0.9f);
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_002)
{
    Drawing::Path path;
    path.AddRect(0, 0, 200, 450, Drawing::PathDirection::CCW_DIRECTION);
    auto testNode1 = RSCanvasNode::Create();
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_003)
{
    Drawing::Path path;
    path.AddRect(-50, 50, 200, 200, Drawing::PathDirection::CW_DIRECTION);
    auto testNode1 = RSCanvasNode::Create();
    testNode1->SetAlpha(0.7f);
    testNode1->SetBounds({ 0, 0, 500, 500 });
    testNode1->SetBackgroundColor(0xff00ff00);
    testNode1->SetBorderStyle(0, 0, 0, 0);
    testNode1->SetBorderWidth(5, 5, 5, 5);
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_004)
{
    Drawing::Path path;
    path.AddRect(50, -50, 200, 200, Drawing::PathDirection::CW_DIRECTION);
    auto testNode1 = RSCanvasNode::Create();
    testNode1->SetAlpha(0.6f);
    testNode1->SetBounds({ 0, 0, 500, 500 });
    testNode1->SetBackgroundColor(0xff00ff00);
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_005)
{
    Drawing::Path path;
    path.AddRect(-50, -50, 200, 200, Drawing::PathDirection::CW_DIRECTION);
    auto testNode1 = RSCanvasNode::Create();
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_006)
{
    Drawing::Path path;
    path.AddRect(50, 50, 200, -200, Drawing::PathDirection::CW_DIRECTION);
    auto testNode1 = RSCanvasNode::Create();
    testNode1->SetAlpha(0.4f);
    testNode1->SetBounds({ 0, 0, 500, 500 });
    testNode1->SetBackgroundColor(0xff00ff00);
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_007)
{
    Drawing::Path path;
    path.AddRect(50, 50, -200, -200, Drawing::PathDirection::CW_DIRECTION);
    auto testNode1 = RSCanvasNode::Create();
    testNode1->SetAlpha(0.3f);
    testNode1->SetBounds({ 0, 0, 500, 500 });
    testNode1->SetBackgroundColor(0xff00ff00);
    testNode1->SetBorderStyle(2, 2, 2, 2);
    testNode1->SetBorderWidth(5, 5, 5, 5);
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_008)
{
    Drawing::Path path;
    path.AddCircle(100, 100, 60, Drawing::PathDirection::CW_DIRECTION);
    auto testNode1 = RSCanvasNode::Create();
    testNode1->SetAlpha(0.2f);
    testNode1->SetBounds({ 0, 0, 500, 500 });
    testNode1->SetBackgroundColor(0xff00ff00);
    testNode1->SetBorderStyle(0, 0, 0, 0);
    testNode1->SetBorderWidth(5, 5, 5, 5);
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_009)
{
    Drawing::Path path;
    path.AddCircle(100, 100, 0, Drawing::PathDirection::CCW_DIRECTION);
    auto testNode1 = RSCanvasNode::Create();
    testNode1->SetAlpha(0.1f);
    testNode1->SetBounds({ 0, 0, 500, 500 });
    testNode1->SetBackgroundColor(0xff00ff00);
    testNode1->SetBorderStyle(1, 1, 1, 1);
    testNode1->SetBorderWidth(5, 5, 5, 5);
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_010)
{
    Drawing::Path path;
    path.AddCircle(100, 100, 0, Drawing::PathDirection::CCW_DIRECTION);
    auto testNode1 = RSCanvasNode::Create();
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_011)
{
    Drawing::Path path;
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_012)
{
    Drawing::Path path;
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToBounds_Test_013)
{
    Drawing::Path path;
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToFrame_Test_001)
{
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToFrame_Test_002)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 0, 0, 500, 500 });
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToFrame_Test_003)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 0, 0, 500, 500 });
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToFrame_Test_004)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 0, 0, 500, 500 });
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToFrame_Test_005)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 0, 0, 500, 500 });
    testNode->SetAlpha(0.8f);
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToFrame_Test_006)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 0, 0, 500, 500 });
    testNode->SetAlpha(0.7f);
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToFrame_Test_007)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 0, 0, 500, 500 });
    testNode->SetAlpha(0.6f);
    testNode->SetBorderStyle(0, 0, 0, 0);
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToFrame_Test_008)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 0, 0, 500, 500 });
...
GRAPHIC_TEST(AppearanceTest06, CONTENT_DISPLAY_TEST, Alpha_ClipToFrame_Test_009)
{
    auto testNode = SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { 0, 0, 500, 500 });
