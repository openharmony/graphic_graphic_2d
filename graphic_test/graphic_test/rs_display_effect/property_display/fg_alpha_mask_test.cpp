...
GRAPHIC_TEST(ForegroundTest05, CONTENT_DISPLAY_TEST, GradientMask_Alpha_Test_1)
{
...
GRAPHIC_TEST(ForegroundTest05, CONTENT_DISPLAY_TEST, PixelMapMask_Alpha_Test_1)
{
    auto testFaNode = SetUpNodeBgImage("/data/local/tmp/fg_test.jpg", { 10, 10, 1000, 1000 });
    testFaNode->SetAlpha(0.5f);
...
GRAPHIC_TEST(ForegroundTest05, CONTENT_DISPLAY_TEST, PathMask_Alpha_Test_1)
{
    auto testFaNode = SetUpNodeBgImage("/data/local/tmp/fg_test.jpg", { 10, 10, 1000, 1000 });
    testFaNode->SetAlpha(0.5f);
...
GRAPHIC_TEST(ForegroundTest05, CONTENT_DISPLAY_TEST, PathMask_Alpha_Test_2)
{
