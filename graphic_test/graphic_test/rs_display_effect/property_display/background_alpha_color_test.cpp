...
class BackgroundTest03 : public RSGraphicTest {
private:
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test)
{
    int columnCount = 3;
    int rowCount = 3;
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Brightness_Parameter_Test_1)
{
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Brightness_Parameter_Test_2)
{
    float rateList[] = { -0.05, 0.0, 1.0, 20.0 };
    float saturationList[] = { 0.0, 5.0, 10.0, 20.0 };
    std::array<float, 3> RGB[] = { { 2.3, 4.5, 2 }, { 0.5, 2, 0.5 } };
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Brightness_Parameter_Test_3)
{
    float rateList[] = { -0.05, 0.0, 1.0, 20.0 };
    float saturationList[] = { 0.0, 5.0, 10.0, 20.0 };
    std::array<float, 3> RGB[] = { { 2.3, 4.5, 2 }, { 0.5, 2, 0.5 } };
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Brightness_Parameter_Test_4)
{
    float rateList[] = { -0.05, 0.0, 1.0, 20.0 };
    float saturationList[] = { 0.0, 5.0, 10.0, 20.0 };
    std::array<float, 3> RGB[] = { { 2.3, 4.5, 2 }, { 0.5, 2, 0.5 } };
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_VisualEffect_Test)
{
    float rateList[] = { -0.05, 0.0, 1.0, 20.0 };
    float saturationList[] = { 0.0, 5.0, 10.0, 20.0 };
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Brightness_Fract_Test)
{
    int columnCount = 2;
    int rowCount = 2;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Grey_Alpha_Coef_Test)
{
    int columnCount = 2;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
    ...
    for (int i = 0; i < static_cast<int>(greyCoefList.size()); i++) {
        ...
        auto testNodeBackGround =
            SetUpNodeBgImage("/data/local/tmp/Images/backGroundImage.jpg", { x, y, sizeX - 10, sizeY - 10 });
        testNodeBackGround->SetAlpha(0.2f * i);
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test001)
{
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test002)
{
    auto testNode1 = RSCanvasNode::Create();
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test003)
{
    auto testNode1 = RSCanvasNode::Create();
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test004)
{
    auto testNode1 = RSCanvasNode::Create();
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test005)
{
    auto testNode1 = RSCanvasNode::Create();
    testNode1->SetAlpha(0.2f);
    testNode1->SetBounds({ 0, 0, 500, -500 });
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test006)
{
    auto testNode1 = RSCanvasNode::Create();
    testNode1->SetAlpha(0.3f);
    testNode1->SetBounds({ 0, 0, -500, -500 });
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test007)
{
    auto testNode1 = RSCanvasNode::Create();
    testNode1->SetAlpha(0.4f);
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test008)
{
    auto testNode1 = RSCanvasNode::Create();
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test009)
{
    auto testNode1 = RSCanvasNode::Create();
...
GRAPHIC_TEST(BackgroundTest03, CONTENT_DISPLAY_TEST, Background_Alpha_Color_Test010)
{
    auto testNode1 = RSCanvasNode::Create();
