...
class BackgroundTest06 : public RSGraphicTest {
private:
...
GRAPHIC_TEST(BackgroundTest06, CONTENT_DISPLAY_TEST, Alpha_Water_Ripple_Test)
{
    int columnCount = 3;
    int rowCount = 3;
    ...
    for (int i = 0; i < progressList.size(); i++) {
        ...
        testNodeBackGround->SetAlpha(0.125f * i);
...
GRAPHIC_TEST(BackgroundTest06, CONTENT_DISPLAY_TEST, Alpha_Fly_In_Test)
{
    int columnCount = 3;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
...
GRAPHIC_TEST(BackgroundTest06, CONTENT_DISPLAY_TEST, Alpha_Distort_Test)
{
    int columnCount = 3;
    int rowCount = 3;
    auto sizeX = screenWidth / columnCount;
