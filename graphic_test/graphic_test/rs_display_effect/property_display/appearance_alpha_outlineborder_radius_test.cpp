...
class AppearanceTest08 : public RSGraphicTest {
private:
...
// color
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_OutlineBorder_Radius_Color_Test_1)
{
...
// width
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_OutlineBorder_Radius_Width_Test_1)
{
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_OutlineBorder_Radius_Width_Test_2)
{
    ...
    // four different width
    auto testNodeFourWidth = RSCanvasNode::Create();
    testNodeFourWidth->SetAlpha(0.8f);
    testNodeFourWidth->SetBounds({ 0, nodePos * 2, nodeSize, nodeSize });
    testNodeFourWidth->SetTranslate(offsetVal, offsetVal2, 0);
    testNodeFourWidth->SetOutlineStyle(style);
    testNodeFourWidth->SetOutlineWidth({ widthList[1] * 0, widthList[1] * 2, widthList[1] * 4, widthList[1] * 8 });
...
// 2 -- Dot
// 3 -- None
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_OutlineBorder_Radius_Style_Test_1)
{
    Color color(0, 0, 0);
    Vector4<Color> outLineColor = { color, color, color, color };
...
// Dash Width
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_OutlineBorder_Radius_DashWidth_Test_1)
{
    ...
    testNodeFourDashWidth->SetAlpha(0.6f);
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_OutlineBorder_Radius_OutlineDashWidth_Test_1)
{
    ...
    // four different dash width
    auto testNodeFourDashWidth = RSCanvasNode::Create();
    testNodeFourDashWidth->SetAlpha(0.4f);
...
// Dash Gap
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_OutlineBorder_Radius_DashGap_Test_1)
{
    ...
    testNodeFourDashGap->SetAlpha(0.2f);
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_OutlineBorder_Radius_OutlineDashGap_Test_1)
{
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_OutlineBorder_Radius_Touch_Test_1)
{
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_Outline_Radius_Test_1)
{
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_Outline_Radius_Test_2)
{
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_Outline_BackgroundColor_Test_1)
{
    int columnCount = 2;
    int rowCount = 3;
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_CornerRadius_Test_1)
{
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_CornerRadius_Test_2)
{
    vector<Vector4f> vecs = {{0, 20, 50, 80}, {50, 100, 50, 80}};
    for (int i = 0; i < vecs.size(); i++) {
        auto testNode = RSCanvasNode::Create();
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_CornerRadius_OutlineRadius_Test_1)
{
    vector<float> vecs1 = {20, 150, 500};
    vector<float> vecs2 = {20, 500, 150};
    for (int i = 0; i < vecs1.size(); i++) {
        auto testNode = RSCanvasNode::Create();
        testNode->SetAlpha(0.4f * i);
        testNode->SetBounds({380, i * 350 + 20, 400, 300});
...
GRAPHIC_TEST(AppearanceTest08, CONTENT_DISPLAY_TEST, Appearance_Alpha_CornerRadius_OutlineRadius_Test_2)
{
