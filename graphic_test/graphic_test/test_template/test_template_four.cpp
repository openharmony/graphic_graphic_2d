...
class TestTemplateFourTest : public RSGraphicTest {
public:
...
GRAPHIC_TEST(TestTemplateFourTest, CONTENT_DISPLAY_TEST, test1)
{
...
GRAPHIC_TEST(TestTemplateFourTest, CONTENT_DISPLAY_TEST, test2)
{
    auto testNode = RSCanvasNode::Create();
    testNode->SetBounds({0, 0, screenWidth, screenHeight});
    testNode->SetFrame({0, 0, screenWidth, screenHeight});
...
GRAPHIC_TEST(TestTemplateFourTest, CONTENT_DISPLAY_TEST, test3)
{
    auto testNode = RSCanvasNode::Create();
    testNode->SetBounds({0, 0, screenWidth, screenHeight});
    testNode->SetFrame({0, 0, screenWidth, screenHeight});
...
GRAPHIC_TEST(TestTemplateFourTest, CONTENT_DISPLAY_TEST, test4)
{
    auto testNode = RSCanvasNode::Create();
    testNode->SetBounds({0, 0, screenWidth, screenHeight});
    testNode->SetFrame({0, 0, screenWidth, screenHeight});
