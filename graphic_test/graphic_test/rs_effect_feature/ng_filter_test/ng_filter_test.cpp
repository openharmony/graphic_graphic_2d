...
const float defaultCornerRadius = 100.0f;
const float defaultBorderWidth = 2.9f;
const float defaultOffset = 1.88f;
const float defaultDownSampleFactor = 1.0f;
const float defaultBgFactor = 0.9f;
const Vector3f defaultInnerShadowParams = Vector3f{-0.02f, 2.0f, 4.62f};
const Vector3f defaultSdParams = Vector3f{0.9f, 0.0f, 1.0f};
const float defaultRefractOutPx = 20.0f;
...
GRAPHIC_TEST(NGFilterTest, EFFECT_TEST, Set_NG_Filter_Frosted_Glass_Test)
{
    ...
    for (int i = 0; i < rowCount; i++) {
        ...
        frostedGlassFilter->Setter<FrostedGlassCornerRadiusTag>(defaultCornerRadius);
        frostedGlassFilter->Setter<FrostedGlassBorderWidthTag>(defaultBorderWidth);
        frostedGlassFilter->Setter<FrostedGlassOffsetTag>(defaultOffset);
        frostedGlassFilter->Setter<FrostedGlassDownSampleFactorTag>(defaultDownSampleFactor);
        frostedGlassFilter->Setter<FrostedGlassBgFactorTag>(defaultBgFactor);
        ...
        frostedGlassFilter->Setter<FrostedGlassRefractOutPxTag>(defaultRefractOutPx);
